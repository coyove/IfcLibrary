...
/**
 * This is a default implementation of the entity IfcCurtainWallType<br><br>
 *<br><br>
 ...
 */
public class IfcCurtainWallType extends IfcBuildingElementType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcCurtainWallTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,11091};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	* @param PredefinedType DEMANDED parameter of type IfcCurtainWallTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcCurtainWallType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcCurtainWallTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcCurtainWallType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCCURTAINWALLTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcCurtainWallTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcCurtainWallType ifcCurtainWallType = new IfcCurtainWallType();
		if(this.GlobalId != null)
			ifcCurtainWallType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcCurtainWallType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcCurtainWallType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcCurtainWallType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcCurtainWallType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcCurtainWallType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcCurtainWallType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcCurtainWallType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcCurtainWallType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcCurtainWallType.setPredefinedType((IfcCurtainWallTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcCurtainWallType ifcCurtainWallType = new IfcCurtainWallType();
		if(this.GlobalId != null)
			ifcCurtainWallType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcCurtainWallType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcCurtainWallType.setName(this.Name);
		if(this.Description != null)
			ifcCurtainWallType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcCurtainWallType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcCurtainWallType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcCurtainWallType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcCurtainWallType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcCurtainWallType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcCurtainWallType.setPredefinedType(this.PredefinedType);
		return ifcCurtainWallType;
	}
