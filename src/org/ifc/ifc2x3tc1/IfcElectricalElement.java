...
/**
 * This is a default implementation of the entity IfcElectricalElement<br><br>
 *<br><br>
 ...
 */
public class IfcElectricalElement extends IfcElement implements ClassInterface
{
	...
	**/
	public IfcElectricalElement(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag)
	{
	...
	**/
	...
	{
		return IfcElectricalElement.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCELECTRICALELEMENT(");
	...
	**/
	public Object clone()
	{
		IfcElectricalElement ifcElectricalElement = new IfcElectricalElement();
		if(this.GlobalId != null)
			ifcElectricalElement.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcElectricalElement.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcElectricalElement.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcElectricalElement.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcElectricalElement.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcElectricalElement.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcElectricalElement.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcElectricalElement.setTag((IfcIdentifier)this.Tag.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcElectricalElement ifcElectricalElement = new IfcElectricalElement();
		if(this.GlobalId != null)
			ifcElectricalElement.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcElectricalElement.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcElectricalElement.setName(this.Name);
		if(this.Description != null)
			ifcElectricalElement.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcElectricalElement.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcElectricalElement.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcElectricalElement.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcElectricalElement.setTag(this.Tag);
		return ifcElectricalElement;
	}
