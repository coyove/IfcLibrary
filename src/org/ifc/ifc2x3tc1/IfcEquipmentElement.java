...
/**
 * This is a default implementation of the entity IfcEquipmentElement<br><br>
 *<br><br>
 ...
 */
public class IfcEquipmentElement extends IfcElement implements ClassInterface
{
...
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,268435456,37475,44139};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	public IfcEquipmentElement(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag)
	{
	...
	**/
	...
	{
		return IfcEquipmentElement.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCEQUIPMENTELEMENT(");
	...
	**/
	public Object clone()
	{
		IfcEquipmentElement ifcEquipmentElement = new IfcEquipmentElement();
		if(this.GlobalId != null)
			ifcEquipmentElement.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcEquipmentElement.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcEquipmentElement.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcEquipmentElement.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcEquipmentElement.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcEquipmentElement.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcEquipmentElement.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcEquipmentElement.setTag((IfcIdentifier)this.Tag.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcEquipmentElement ifcEquipmentElement = new IfcEquipmentElement();
		if(this.GlobalId != null)
			ifcEquipmentElement.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcEquipmentElement.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcEquipmentElement.setName(this.Name);
		if(this.Description != null)
			ifcEquipmentElement.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcEquipmentElement.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcEquipmentElement.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcEquipmentElement.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcEquipmentElement.setTag(this.Tag);
		return ifcEquipmentElement;
	}
