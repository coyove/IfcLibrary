...
/**
 * This is a default implementation of the entity IfcValveType<br><br>
 *<br><br>
 ...
 */
public class IfcValveType extends IfcFlowControllerType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcValveTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,8187};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	...
	/**
	* Constructs a new IfcValveType object using the given parameters.
	*
	...
	* @param PredefinedType DEMANDED parameter of type IfcValveTypeEnum - may not be null.
	**/
	public IfcValveType(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ApplicableOccurrence, SET<IfcPropertySetDefinition> HasPropertySets, LIST<IfcRepresentationMap> RepresentationMaps, IfcLabel Tag, IfcLabel ElementType, IfcValveTypeEnum PredefinedType)
	{
	...
	/**
	 * This method initializes the IfcValveType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcValveTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcValveType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCVALVETYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcValveTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcValveType ifcValveType = new IfcValveType();
		if(this.GlobalId != null)
			ifcValveType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcValveType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcValveType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcValveType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcValveType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcValveType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcValveType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcValveType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcValveType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcValveType.setPredefinedType((IfcValveTypeEnum)this.PredefinedType.clone());
		return ifcValveType;
	}
	...
	**/
	public Object shallowCopy()
	{
		IfcValveType ifcValveType = new IfcValveType();
		if(this.GlobalId != null)
			ifcValveType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcValveType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcValveType.setName(this.Name);
		if(this.Description != null)
			ifcValveType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcValveType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcValveType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcValveType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcValveType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcValveType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcValveType.setPredefinedType(this.PredefinedType);
		return ifcValveType;
	}
