...
/**
 * This is a default implementation of the entity IfcFlowMeterType<br><br>
 *<br><br>
 ...
 */
public class IfcFlowMeterType extends IfcFlowControllerType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcFlowMeterTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,25997};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	* @param PredefinedType DEMANDED parameter of type IfcFlowMeterTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcFlowMeterType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcFlowMeterTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcFlowMeterType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCFLOWMETERTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcFlowMeterTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcFlowMeterType ifcFlowMeterType = new IfcFlowMeterType();
		if(this.GlobalId != null)
			ifcFlowMeterType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcFlowMeterType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcFlowMeterType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcFlowMeterType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcFlowMeterType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcFlowMeterType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcFlowMeterType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcFlowMeterType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcFlowMeterType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcFlowMeterType.setPredefinedType((IfcFlowMeterTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcFlowMeterType ifcFlowMeterType = new IfcFlowMeterType();
		if(this.GlobalId != null)
			ifcFlowMeterType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcFlowMeterType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcFlowMeterType.setName(this.Name);
		if(this.Description != null)
			ifcFlowMeterType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcFlowMeterType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcFlowMeterType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcFlowMeterType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcFlowMeterType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcFlowMeterType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcFlowMeterType.setPredefinedType(this.PredefinedType);
		return ifcFlowMeterType;
	}
