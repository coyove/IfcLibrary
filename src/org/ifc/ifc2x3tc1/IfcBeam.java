...
/**
 * This is a default implementation of the entity IfcBeam<br><br>
 *<br><br>
 ...
 */
public class IfcBeam extends IfcBuildingElement implements ClassInterface
{
	...
	**/
	public IfcBeam(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag)
	{
	...
	**/
	...
	{
		return IfcBeam.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCBEAM(");
	...
	**/
	public Object clone()
	{
		IfcBeam ifcBeam = new IfcBeam();
		if(this.GlobalId != null)
			ifcBeam.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcBeam.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcBeam.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcBeam.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcBeam.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcBeam.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcBeam.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcBeam.setTag((IfcIdentifier)this.Tag.clone());
		return ifcBeam;
	}
	...
	**/
	public Object shallowCopy()
	{
		IfcBeam ifcBeam = new IfcBeam();
		if(this.GlobalId != null)
			ifcBeam.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcBeam.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcBeam.setName(this.Name);
		if(this.Description != null)
			ifcBeam.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcBeam.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcBeam.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcBeam.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcBeam.setTag(this.Tag);
		return ifcBeam;
	}
