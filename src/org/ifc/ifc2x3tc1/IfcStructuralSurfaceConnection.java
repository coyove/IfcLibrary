...
/**
 * This is a default implementation of the entity IfcStructuralSurfaceConnection<br><br>
 *<br><br>
 ...
 */
public class IfcStructuralSurfaceConnection extends IfcStructuralConnection implements ClassInterface
{
...
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,268435456,37475,268435456};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	...
	{
		return IfcStructuralSurfaceConnection.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCSTRUCTURALSURFACECONNECTION(");
	...
	**/
	public Object clone()
	{
		IfcStructuralSurfaceConnection ifcStructuralSurfaceConnection = new IfcStructuralSurfaceConnection();
		if(this.GlobalId != null)
			ifcStructuralSurfaceConnection.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcStructuralSurfaceConnection.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcStructuralSurfaceConnection.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcStructuralSurfaceConnection.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcStructuralSurfaceConnection.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcStructuralSurfaceConnection.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcStructuralSurfaceConnection.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.AppliedCondition != null)
			ifcStructuralSurfaceConnection.setAppliedCondition((IfcBoundaryCondition)this.AppliedCondition.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcStructuralSurfaceConnection ifcStructuralSurfaceConnection = new IfcStructuralSurfaceConnection();
		if(this.GlobalId != null)
			ifcStructuralSurfaceConnection.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcStructuralSurfaceConnection.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcStructuralSurfaceConnection.setName(this.Name);
		if(this.Description != null)
			ifcStructuralSurfaceConnection.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcStructuralSurfaceConnection.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcStructuralSurfaceConnection.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcStructuralSurfaceConnection.setRepresentation(this.Representation);
		if(this.AppliedCondition != null)
			ifcStructuralSurfaceConnection.setAppliedCondition(this.AppliedCondition);
		return ifcStructuralSurfaceConnection;
	}
