...
/**
 * This is a default implementation of the entity IfcCooledBeamType<br><br>
 *<br><br>
 ...
 */
public class IfcCooledBeamType extends IfcEnergyConversionDeviceType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcCooledBeamTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,12405};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	* @param PredefinedType DEMANDED parameter of type IfcCooledBeamTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcCooledBeamType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcCooledBeamTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcCooledBeamType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCCOOLEDBEAMTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcCooledBeamTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcCooledBeamType ifcCooledBeamType = new IfcCooledBeamType();
		if(this.GlobalId != null)
			ifcCooledBeamType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcCooledBeamType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcCooledBeamType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcCooledBeamType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcCooledBeamType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcCooledBeamType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcCooledBeamType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcCooledBeamType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcCooledBeamType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcCooledBeamType.setPredefinedType((IfcCooledBeamTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcCooledBeamType ifcCooledBeamType = new IfcCooledBeamType();
		if(this.GlobalId != null)
			ifcCooledBeamType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcCooledBeamType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcCooledBeamType.setName(this.Name);
		if(this.Description != null)
			ifcCooledBeamType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcCooledBeamType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcCooledBeamType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcCooledBeamType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcCooledBeamType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcCooledBeamType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcCooledBeamType.setPredefinedType(this.PredefinedType);
		return ifcCooledBeamType;
	}
