...
/**
 * This is a default implementation of the entity IfcFastener<br><br>
 *<br><br>
 ...
 */
public class IfcFastener extends IfcElementComponent implements ClassInterface
{
	...
	**/
	public IfcFastener(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag)
	{
	...
	**/
	...
	{
		return IfcFastener.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCFASTENER(");
	...
	**/
	public Object clone()
	{
		IfcFastener ifcFastener = new IfcFastener();
		if(this.GlobalId != null)
			ifcFastener.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcFastener.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcFastener.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcFastener.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcFastener.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcFastener.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcFastener.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcFastener.setTag((IfcIdentifier)this.Tag.clone());
		return ifcFastener;
	}
	...
	**/
	public Object shallowCopy()
	{
		IfcFastener ifcFastener = new IfcFastener();
		if(this.GlobalId != null)
			ifcFastener.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcFastener.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcFastener.setName(this.Name);
		if(this.Description != null)
			ifcFastener.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcFastener.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcFastener.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcFastener.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcFastener.setTag(this.Tag);
		return ifcFastener;
	}
