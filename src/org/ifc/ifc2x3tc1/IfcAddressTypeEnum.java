...
/**
 * This is a default implementation of the enumeration type IfcAddressTypeEnum<br><br>
 *<br><br>
 ...
 */
public class IfcAddressTypeEnum extends ENUM implements TypeInterface
{
	/**
 ...
 * Constructs a new IfcAddressTypeEnum enumeration object using the given parameter.
	...
	* The value has to be of type IfcAddressTypeEnum_internal.
	...
	* The String must be one of: "OFFICE", "SITE", "HOME", "DISTRIBUTIONPOINT", "USERDEFINED".
	*
	* @param value the value to set
	*/
	...
	**/
	...
	public static enum IfcAddressTypeEnum_internal
	{
		OFFICE,
		SITE,
		HOME,
	...
	**/
	...
	{
		if(isSelectType) return new String("IFCADDRESSTYPEENUM("+super.getStepParameter(false)+")");
