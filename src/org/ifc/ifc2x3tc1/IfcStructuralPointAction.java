...
/**
 * This is a default implementation of the entity IfcStructuralPointAction<br><br>
 *<br><br>
 ...
 */
public class IfcStructuralPointAction extends IfcStructuralAction implements ClassInterface
{
...
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,268435456,37475,268435456,21554,47261,268435456};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	...
	{
		return IfcStructuralPointAction.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCSTRUCTURALPOINTACTION(");
	...
	**/
	public Object clone()
	{
		IfcStructuralPointAction ifcStructuralPointAction = new IfcStructuralPointAction();
		if(this.GlobalId != null)
			ifcStructuralPointAction.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcStructuralPointAction.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcStructuralPointAction.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcStructuralPointAction.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcStructuralPointAction.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcStructuralPointAction.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcStructuralPointAction.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.AppliedLoad != null)
			ifcStructuralPointAction.setAppliedLoad((IfcStructuralLoad)this.AppliedLoad.clone());
		if(this.GlobalOrLocal != null)
			ifcStructuralPointAction.setGlobalOrLocal((IfcGlobalOrLocalEnum)this.GlobalOrLocal.clone());
		if(this.DestabilizingLoad != null)
			ifcStructuralPointAction.setDestabilizingLoad((BOOLEAN)this.DestabilizingLoad.clone());
		if(this.CausedBy != null)
			ifcStructuralPointAction.setCausedBy((IfcStructuralReaction)this.CausedBy.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcStructuralPointAction ifcStructuralPointAction = new IfcStructuralPointAction();
		if(this.GlobalId != null)
			ifcStructuralPointAction.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcStructuralPointAction.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcStructuralPointAction.setName(this.Name);
		if(this.Description != null)
			ifcStructuralPointAction.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcStructuralPointAction.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcStructuralPointAction.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcStructuralPointAction.setRepresentation(this.Representation);
		if(this.AppliedLoad != null)
			ifcStructuralPointAction.setAppliedLoad(this.AppliedLoad);
		if(this.GlobalOrLocal != null)
			ifcStructuralPointAction.setGlobalOrLocal(this.GlobalOrLocal);
		if(this.DestabilizingLoad != null)
			ifcStructuralPointAction.setDestabilizingLoad(this.DestabilizingLoad);
		if(this.CausedBy != null)
			ifcStructuralPointAction.setCausedBy(this.CausedBy);
		return ifcStructuralPointAction;
	}
