...
/**
 * This is a default implementation of the entity IfcSwitchingDeviceType<br><br>
 *<br><br>
 ...
 */
public class IfcSwitchingDeviceType extends IfcFlowControllerType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcSwitchingDeviceTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,1702};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	* @param PredefinedType DEMANDED parameter of type IfcSwitchingDeviceTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcSwitchingDeviceType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcSwitchingDeviceTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcSwitchingDeviceType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCSWITCHINGDEVICETYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcSwitchingDeviceTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcSwitchingDeviceType ifcSwitchingDeviceType = new IfcSwitchingDeviceType();
		if(this.GlobalId != null)
			ifcSwitchingDeviceType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcSwitchingDeviceType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcSwitchingDeviceType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcSwitchingDeviceType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcSwitchingDeviceType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcSwitchingDeviceType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcSwitchingDeviceType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcSwitchingDeviceType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcSwitchingDeviceType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcSwitchingDeviceType.setPredefinedType((IfcSwitchingDeviceTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcSwitchingDeviceType ifcSwitchingDeviceType = new IfcSwitchingDeviceType();
		if(this.GlobalId != null)
			ifcSwitchingDeviceType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcSwitchingDeviceType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcSwitchingDeviceType.setName(this.Name);
		if(this.Description != null)
			ifcSwitchingDeviceType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcSwitchingDeviceType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcSwitchingDeviceType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcSwitchingDeviceType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcSwitchingDeviceType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcSwitchingDeviceType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcSwitchingDeviceType.setPredefinedType(this.PredefinedType);
		return ifcSwitchingDeviceType;
	}
