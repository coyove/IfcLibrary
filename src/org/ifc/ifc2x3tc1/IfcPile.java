...
/**
 * This is a default implementation of the entity IfcPile<br><br>
 *<br><br>
 ...
 */
public class IfcPile extends IfcBuildingElement implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcPileTypeEnum","IfcPileConstructionEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,268435456,37475,44139,45658,38979};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	/** ConstructionType is an OPTIONAL attribute**/
	...
	* @param PredefinedType DEMANDED parameter of type IfcPileTypeEnum - may not be null.
	* @param ConstructionType OPTIONAL parameter of type IfcPileConstructionEnum
	**/
	...
	/**
	 * This method initializes the IfcPile object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcPileTypeEnum) parameters.get(8);
		this.ConstructionType = (IfcPileConstructionEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcPile.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCPILE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcPileTypeEnum.class.isInterface())+",");
		else		stepString = stepString.concat("$,");
		}
		if(getRedefinedDerivedAttributeTypes().contains("ConstructionType")) stepString = stepString.concat("*);");
		else{
		if(this.ConstructionType != null)		stepString = stepString.concat(((RootInterface)this.ConstructionType).getStepParameter(IfcPileConstructionEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	*
	* @param ConstructionType DEMANDED value to set - may not be null
	**/
	...
	**/
	public Object clone()
	{
		IfcPile ifcPile = new IfcPile();
		if(this.GlobalId != null)
			ifcPile.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcPile.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcPile.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcPile.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcPile.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcPile.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcPile.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcPile.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcPile.setPredefinedType((IfcPileTypeEnum)this.PredefinedType.clone());
		if(this.ConstructionType != null)
			ifcPile.setConstructionType((IfcPileConstructionEnum)this.ConstructionType.clone());
		return ifcPile;
	}
	...
	**/
	public Object shallowCopy()
	{
		IfcPile ifcPile = new IfcPile();
		if(this.GlobalId != null)
			ifcPile.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcPile.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcPile.setName(this.Name);
		if(this.Description != null)
			ifcPile.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcPile.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcPile.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcPile.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcPile.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcPile.setPredefinedType(this.PredefinedType);
		if(this.ConstructionType != null)
			ifcPile.setConstructionType(this.ConstructionType);
		return ifcPile;
	}
