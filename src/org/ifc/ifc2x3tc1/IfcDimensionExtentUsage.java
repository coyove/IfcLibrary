...
/**
 * This is a default implementation of the enumeration type IfcDimensionExtentUsage<br><br>
 *<br><br>
 ...
 */
public class IfcDimensionExtentUsage extends ENUM implements TypeInterface
{
	/**
 ...
 * Constructs a new IfcDimensionExtentUsage enumeration object using the given parameter.
	...
	* The value has to be of type IfcDimensionExtentUsage_internal.
	...
	* The String must be one of: "ORIGIN", "TARGET".
	*
	* @param value the value to set
	*/
	...
	**/
	...
	public static enum IfcDimensionExtentUsage_internal
	{
		ORIGIN,
		TARGET
	}	/**
	...
	**/
	...
	{
		if(isSelectType) return new String("IFCDIMENSIONEXTENTUSAGE("+super.getStepParameter(false)+")");
