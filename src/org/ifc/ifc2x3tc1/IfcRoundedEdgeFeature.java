...
/**
 * This is a default implementation of the entity IfcRoundedEdgeFeature<br><br>
 *<br><br>
 ...
 */
public class IfcRoundedEdgeFeature extends IfcEdgeFeature implements ClassInterface
{
...
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,268435456,37475,44139,35714,35714};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	...
	/**
	 * This method initializes the IfcRoundedEdgeFeature object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.Radius = (IfcPositiveLengthMeasure) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcRoundedEdgeFeature.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCROUNDEDEDGEFEATURE(");
	...
	**/
	public Object clone()
	{
		IfcRoundedEdgeFeature ifcRoundedEdgeFeature = new IfcRoundedEdgeFeature();
		if(this.GlobalId != null)
			ifcRoundedEdgeFeature.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcRoundedEdgeFeature.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcRoundedEdgeFeature.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcRoundedEdgeFeature.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcRoundedEdgeFeature.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcRoundedEdgeFeature.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcRoundedEdgeFeature.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcRoundedEdgeFeature.setTag((IfcIdentifier)this.Tag.clone());
		if(this.FeatureLength != null)
			ifcRoundedEdgeFeature.setFeatureLength((IfcPositiveLengthMeasure)this.FeatureLength.clone());
		if(this.Radius != null)
			ifcRoundedEdgeFeature.setRadius((IfcPositiveLengthMeasure)this.Radius.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcRoundedEdgeFeature ifcRoundedEdgeFeature = new IfcRoundedEdgeFeature();
		if(this.GlobalId != null)
			ifcRoundedEdgeFeature.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcRoundedEdgeFeature.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcRoundedEdgeFeature.setName(this.Name);
		if(this.Description != null)
			ifcRoundedEdgeFeature.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcRoundedEdgeFeature.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcRoundedEdgeFeature.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcRoundedEdgeFeature.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcRoundedEdgeFeature.setTag(this.Tag);
		if(this.FeatureLength != null)
			ifcRoundedEdgeFeature.setFeatureLength(this.FeatureLength);
		if(this.Radius != null)
			ifcRoundedEdgeFeature.setRadius(this.Radius);
		return ifcRoundedEdgeFeature;
	}
