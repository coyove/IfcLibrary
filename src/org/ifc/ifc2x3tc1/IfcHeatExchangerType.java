...
/**
 * This is a default implementation of the entity IfcHeatExchangerType<br><br>
 *<br><br>
 ...
 */
public class IfcHeatExchangerType extends IfcEnergyConversionDeviceType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcHeatExchangerTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,21584};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	* @param PredefinedType DEMANDED parameter of type IfcHeatExchangerTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcHeatExchangerType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcHeatExchangerTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcHeatExchangerType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCHEATEXCHANGERTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcHeatExchangerTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcHeatExchangerType ifcHeatExchangerType = new IfcHeatExchangerType();
		if(this.GlobalId != null)
			ifcHeatExchangerType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcHeatExchangerType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcHeatExchangerType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcHeatExchangerType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcHeatExchangerType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcHeatExchangerType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcHeatExchangerType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcHeatExchangerType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcHeatExchangerType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcHeatExchangerType.setPredefinedType((IfcHeatExchangerTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcHeatExchangerType ifcHeatExchangerType = new IfcHeatExchangerType();
		if(this.GlobalId != null)
			ifcHeatExchangerType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcHeatExchangerType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcHeatExchangerType.setName(this.Name);
		if(this.Description != null)
			ifcHeatExchangerType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcHeatExchangerType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcHeatExchangerType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcHeatExchangerType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcHeatExchangerType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcHeatExchangerType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcHeatExchangerType.setPredefinedType(this.PredefinedType);
		return ifcHeatExchangerType;
	}
