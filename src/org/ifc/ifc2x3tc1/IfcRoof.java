...
/**
 * This is a default implementation of the entity IfcRoof<br><br>
 *<br><br>
 ...
 */
public class IfcRoof extends IfcBuildingElement implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcRoofTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,268435456,37475,44139,43318};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	private java.util.ArrayList<CloneableObject> stepParameter = null;
	private java.util.HashSet<ObjectChangeListener> listenerList = null;
	protected int stepLineNumber;
	/** ShapeType is an DEMANDED attribute - may not be null**/
	protected IfcRoofTypeEnum ShapeType;
	/**
	...
	* @param ShapeType DEMANDED parameter of type IfcRoofTypeEnum - may not be null.
	**/
	...
	**/
	...
	{
		return IfcRoof.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		if(this.ShapeType != null)		stepString = stepString.concat(((RootInterface)this.ShapeType).getStepParameter(IfcRoofTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	public Object clone()
	{
		...
		if(this.GlobalId != null)
			ifcRoof.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcRoof.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcRoof.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcRoof.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcRoof.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcRoof.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcRoof.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcRoof.setTag((IfcIdentifier)this.Tag.clone());
		if(this.ShapeType != null)
			ifcRoof.setShapeType((IfcRoofTypeEnum)this.ShapeType.clone());
		return ifcRoof;
	}
	...
	**/
	public Object shallowCopy()
	{
		IfcRoof ifcRoof = new IfcRoof();
		if(this.GlobalId != null)
			ifcRoof.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcRoof.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcRoof.setName(this.Name);
		if(this.Description != null)
			ifcRoof.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcRoof.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcRoof.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcRoof.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcRoof.setTag(this.Tag);
		if(this.ShapeType != null)
			ifcRoof.setShapeType(this.ShapeType);
		return ifcRoof;
	}
