...
/**
 * This is a default implementation of the entity IfcProjectionElement<br><br>
 *<br><br>
 ...
 */
public class IfcProjectionElement extends IfcFeatureElementAddition implements ClassInterface
{
	...
	**/
	public IfcProjectionElement(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag)
	{
	...
	**/
	...
	{
		return IfcProjectionElement.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCPROJECTIONELEMENT(");
	...
	**/
	public Object clone()
	{
		IfcProjectionElement ifcProjectionElement = new IfcProjectionElement();
		if(this.GlobalId != null)
			ifcProjectionElement.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcProjectionElement.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcProjectionElement.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcProjectionElement.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcProjectionElement.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcProjectionElement.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcProjectionElement.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcProjectionElement.setTag((IfcIdentifier)this.Tag.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcProjectionElement ifcProjectionElement = new IfcProjectionElement();
		if(this.GlobalId != null)
			ifcProjectionElement.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcProjectionElement.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcProjectionElement.setName(this.Name);
		if(this.Description != null)
			ifcProjectionElement.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcProjectionElement.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcProjectionElement.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcProjectionElement.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcProjectionElement.setTag(this.Tag);
		return ifcProjectionElement;
	}
