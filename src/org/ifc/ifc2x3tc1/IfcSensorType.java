...
/**
 * This is a default implementation of the entity IfcSensorType<br><br>
 *<br><br>
 ...
 */
public class IfcSensorType extends IfcDistributionControlElementType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcSensorTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,38086};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	...
	/**
	* Constructs a new IfcSensorType object using the given parameters.
	*
	...
	* @param PredefinedType DEMANDED parameter of type IfcSensorTypeEnum - may not be null.
	**/
	public IfcSensorType(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ApplicableOccurrence, SET<IfcPropertySetDefinition> HasPropertySets, LIST<IfcRepresentationMap> RepresentationMaps, IfcLabel Tag, IfcLabel ElementType, IfcSensorTypeEnum PredefinedType)
	{
	...
	/**
	 * This method initializes the IfcSensorType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcSensorTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcSensorType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCSENSORTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcSensorTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcSensorType ifcSensorType = new IfcSensorType();
		if(this.GlobalId != null)
			ifcSensorType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcSensorType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcSensorType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcSensorType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcSensorType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcSensorType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcSensorType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcSensorType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcSensorType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcSensorType.setPredefinedType((IfcSensorTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcSensorType ifcSensorType = new IfcSensorType();
		if(this.GlobalId != null)
			ifcSensorType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcSensorType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcSensorType.setName(this.Name);
		if(this.Description != null)
			ifcSensorType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcSensorType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcSensorType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcSensorType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcSensorType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcSensorType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcSensorType.setPredefinedType(this.PredefinedType);
		return ifcSensorType;
	}
