...
/**
 * This is a default implementation of the entity IfcElectricGeneratorType<br><br>
 *<br><br>
 ...
 */
public class IfcElectricGeneratorType extends IfcEnergyConversionDeviceType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcElectricGeneratorTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,37403};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	* @param PredefinedType DEMANDED parameter of type IfcElectricGeneratorTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcElectricGeneratorType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcElectricGeneratorTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcElectricGeneratorType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCELECTRICGENERATORTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcElectricGeneratorTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcElectricGeneratorType ifcElectricGeneratorType = new IfcElectricGeneratorType();
		if(this.GlobalId != null)
			ifcElectricGeneratorType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcElectricGeneratorType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcElectricGeneratorType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcElectricGeneratorType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcElectricGeneratorType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcElectricGeneratorType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcElectricGeneratorType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcElectricGeneratorType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcElectricGeneratorType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcElectricGeneratorType.setPredefinedType((IfcElectricGeneratorTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcElectricGeneratorType ifcElectricGeneratorType = new IfcElectricGeneratorType();
		if(this.GlobalId != null)
			ifcElectricGeneratorType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcElectricGeneratorType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcElectricGeneratorType.setName(this.Name);
		if(this.Description != null)
			ifcElectricGeneratorType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcElectricGeneratorType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcElectricGeneratorType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcElectricGeneratorType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcElectricGeneratorType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcElectricGeneratorType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcElectricGeneratorType.setPredefinedType(this.PredefinedType);
		return ifcElectricGeneratorType;
	}
