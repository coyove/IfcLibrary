...
/**
 * This is a default implementation of the entity IfcStructuralMember<br><br>
 *<br><br>
 ...
 */
public abstract class IfcStructuralMember extends IfcStructuralItem implements ClassInterface
{
...
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,268435456,37475};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	private java.util.ArrayList<CloneableObject> stepParameter = null;
	private java.util.HashSet<ObjectChangeListener> listenerList = null;
	protected int stepLineNumber;
	protected SET<IfcRelConnectsStructuralElement> ReferencesElement_Inverse;
	protected SET<IfcRelConnectsStructuralMember> ConnectedBy_Inverse;
	/**
	...
	**/
	void destruct()
	{
		 super.destruct();
		listenerList = null;
		ReferencesElement_Inverse = null;
		ConnectedBy_Inverse = null;
	}
	...
	**/
	...
	{
		return IfcStructuralMember.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCSTRUCTURALMEMBER(");
	...
	**/
	...
	/**
	* This method returns a copy of the set of the ReferencesElement_Inverse attribute.
	*
	* @return a copy of the ReferencesElement_Inverse set
	**/
	public SET<IfcRelConnectsStructuralElement> getReferencesElement_Inverse()
	{
		if(this.ReferencesElement_Inverse != null)
			return new SET<IfcRelConnectsStructuralElement>(this.ReferencesElement_Inverse);
		return null;
	}

	/**
	* This method returns a copy of the set of the ConnectedBy_Inverse attribute.
	*
	* @return a copy of the ConnectedBy_Inverse set
	**/
	public SET<IfcRelConnectsStructuralMember> getConnectedBy_Inverse()
	{
		if(this.ConnectedBy_Inverse != null)
			return new SET<IfcRelConnectsStructuralMember>(this.ConnectedBy_Inverse);
		return null;
	}
