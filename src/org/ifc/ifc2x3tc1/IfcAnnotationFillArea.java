...
/**
 * This is a default implementation of the entity IfcAnnotationFillArea<br><br>
 *<br><br>
 ...
 */
public class IfcAnnotationFillArea extends IfcGeometricRepresentationItem implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcCurve","SET<IfcCurve>"};
private static final int[] nonInverseHashAttributes = new int[]{268435456,1073745811};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	private java.util.ArrayList<CloneableObject> stepParameter = null;
	private java.util.HashSet<ObjectChangeListener> listenerList = null;
	protected int stepLineNumber;
	/** OuterBoundary is an DEMANDED attribute - may not be null**/
	protected IfcCurve OuterBoundary;
	/** InnerBoundaries is an OPTIONAL attribute**/
	...
	* @param InnerBoundaries OPTIONAL parameter of type SET<IfcCurve>
	**/
	...
	/**
	 * This method initializes the IfcAnnotationFillArea object using the given parameters.
	*
	* @param OuterBoundary DEMANDED parameter of type IfcCurve - may not be null.
	* @param InnerBoundaries OPTIONAL parameter of type SET<IfcCurve>
	**/
	public void setParameters(IfcCurve OuterBoundary, SET<IfcCurve> InnerBoundaries)
	{
		this.OuterBoundary = OuterBoundary;
		this.InnerBoundaries = InnerBoundaries;
		resolveInverses();
	...
	**/
	...
	{
		this.OuterBoundary = (IfcCurve) parameters.get(0);
		this.InnerBoundaries = (SET<IfcCurve>) parameters.get(1);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcAnnotationFillArea.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCANNOTATIONFILLAREA(");
	...
	*
	* @param InnerBoundaries DEMANDED value to set - may not be null
	**/
	...
	**/
	...
	public Object clone()
	{
		IfcAnnotationFillArea ifcAnnotationFillArea = new IfcAnnotationFillArea();
		if(this.OuterBoundary != null)
			ifcAnnotationFillArea.setOuterBoundary((IfcCurve)this.OuterBoundary.clone());
		if(this.InnerBoundaries != null)
			ifcAnnotationFillArea.setInnerBoundaries((SET<IfcCurve>)this.InnerBoundaries.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcAnnotationFillArea ifcAnnotationFillArea = new IfcAnnotationFillArea();
		if(this.OuterBoundary != null)
			ifcAnnotationFillArea.setOuterBoundary(this.OuterBoundary);
		if(this.InnerBoundaries != null)
			ifcAnnotationFillArea.setInnerBoundaries(this.InnerBoundaries);
		return ifcAnnotationFillArea;
	}
