 ...
 */
public class IfcClassification extends InternalAccessClass implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcLabel","IfcLabel","IfcCalendarDate","IfcLabel"};
private static final int[] nonInverseHashAttributes = new int[]{3773,3773,42580,3773};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	private java.util.ArrayList<CloneableObject> stepParameter = null;
	private java.util.HashSet<ObjectChangeListener> listenerList = null;
	protected int stepLineNumber;
	/** Source is an DEMANDED attribute - may not be null**/
	protected IfcLabel Source;
	/** Edition is an DEMANDED attribute - may not be null**/
	...
	protected SET<IfcClassificationItem> Contains_Inverse;
	/**
	...
	*
	* @param Source DEMANDED parameter of type IfcLabel - may not be null.
	* @param Edition DEMANDED parameter of type IfcLabel - may not be null.
	* @param EditionDate OPTIONAL parameter of type IfcCalendarDate
	* @param Name DEMANDED parameter of type IfcLabel - may not be null.
	**/
	public IfcClassification(IfcLabel Source, IfcLabel Edition, IfcCalendarDate EditionDate, IfcLabel Name)
	{
		this.Source = Source;
	...
	* @param Name DEMANDED parameter of type IfcLabel - may not be null.
	**/
	public void setParameters(IfcLabel Source, IfcLabel Edition, IfcCalendarDate EditionDate, IfcLabel Name)
	{
		this.Source = Source;
		this.Edition = Edition;
		this.EditionDate = EditionDate;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.EditionDate = (IfcCalendarDate) parameters.get(2);
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		if(this.EditionDate != null)		stepString = stepString.concat(((RootInterface)this.EditionDate).getStepParameter(IfcCalendarDate.class.isInterface())+",");
		else		stepString = stepString.concat("$,");
		}
	...
	**/
	...
	/**
	* This method returns a copy of the set of the Contains_Inverse attribute.
	*
	* @return a copy of the Contains_Inverse set
	**/
	public SET<IfcClassificationItem> getContains_Inverse()
	{
		if(this.Contains_Inverse != null)
			return new SET<IfcClassificationItem>(this.Contains_Inverse);
		return null;
	}
	...
	*
	* @param Source OPTIONAL value to set
	**/
	...
	*
	* @param Edition OPTIONAL value to set
	**/
	...
	**/
	public Object clone()
	{
		...
		if(this.EditionDate != null)
			ifcClassification.setEditionDate((IfcCalendarDate)this.EditionDate.clone());
		if(this.Name != null)
