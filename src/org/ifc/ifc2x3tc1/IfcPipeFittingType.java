...
/**
 * This is a default implementation of the entity IfcPipeFittingType<br><br>
 *<br><br>
 ...
 */
public class IfcPipeFittingType extends IfcFlowFittingType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcPipeFittingTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,256};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	...
	/**
	* Constructs a new IfcPipeFittingType object using the given parameters.
	*
	...
	* @param PredefinedType DEMANDED parameter of type IfcPipeFittingTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcPipeFittingType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcPipeFittingTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcPipeFittingType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCPIPEFITTINGTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcPipeFittingTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcPipeFittingType ifcPipeFittingType = new IfcPipeFittingType();
		if(this.GlobalId != null)
			ifcPipeFittingType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcPipeFittingType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcPipeFittingType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcPipeFittingType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcPipeFittingType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcPipeFittingType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcPipeFittingType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcPipeFittingType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcPipeFittingType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcPipeFittingType.setPredefinedType((IfcPipeFittingTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcPipeFittingType ifcPipeFittingType = new IfcPipeFittingType();
		if(this.GlobalId != null)
			ifcPipeFittingType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcPipeFittingType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcPipeFittingType.setName(this.Name);
		if(this.Description != null)
			ifcPipeFittingType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcPipeFittingType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcPipeFittingType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcPipeFittingType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcPipeFittingType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcPipeFittingType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcPipeFittingType.setPredefinedType(this.PredefinedType);
		return ifcPipeFittingType;
	}
