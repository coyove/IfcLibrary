...
/**
 * This is a default implementation of the entity IfcCableCarrierSegmentType<br><br>
 *<br><br>
 ...
 */
public class IfcCableCarrierSegmentType extends IfcFlowSegmentType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcCableCarrierSegmentTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,11829};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	...
	/**
	* Constructs a new IfcCableCarrierSegmentType object using the given parameters.
	*
	...
	* @param PredefinedType DEMANDED parameter of type IfcCableCarrierSegmentTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcCableCarrierSegmentType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcCableCarrierSegmentTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcCableCarrierSegmentType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCCABLECARRIERSEGMENTTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcCableCarrierSegmentTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcCableCarrierSegmentType ifcCableCarrierSegmentType = new IfcCableCarrierSegmentType();
		if(this.GlobalId != null)
			ifcCableCarrierSegmentType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcCableCarrierSegmentType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcCableCarrierSegmentType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcCableCarrierSegmentType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcCableCarrierSegmentType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcCableCarrierSegmentType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcCableCarrierSegmentType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcCableCarrierSegmentType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcCableCarrierSegmentType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcCableCarrierSegmentType.setPredefinedType((IfcCableCarrierSegmentTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcCableCarrierSegmentType ifcCableCarrierSegmentType = new IfcCableCarrierSegmentType();
		if(this.GlobalId != null)
			ifcCableCarrierSegmentType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcCableCarrierSegmentType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcCableCarrierSegmentType.setName(this.Name);
		if(this.Description != null)
			ifcCableCarrierSegmentType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcCableCarrierSegmentType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcCableCarrierSegmentType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcCableCarrierSegmentType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcCableCarrierSegmentType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcCableCarrierSegmentType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcCableCarrierSegmentType.setPredefinedType(this.PredefinedType);
		return ifcCableCarrierSegmentType;
	}
