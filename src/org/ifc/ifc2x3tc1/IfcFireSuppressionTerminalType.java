...
/**
 * This is a default implementation of the entity IfcFireSuppressionTerminalType<br><br>
 *<br><br>
 ...
 */
public class IfcFireSuppressionTerminalType extends IfcFlowTerminalType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcFireSuppressionTerminalTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,22183};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	* @param PredefinedType DEMANDED parameter of type IfcFireSuppressionTerminalTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcFireSuppressionTerminalType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcFireSuppressionTerminalTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcFireSuppressionTerminalType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCFIRESUPPRESSIONTERMINALTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcFireSuppressionTerminalTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcFireSuppressionTerminalType ifcFireSuppressionTerminalType = new IfcFireSuppressionTerminalType();
		if(this.GlobalId != null)
			ifcFireSuppressionTerminalType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcFireSuppressionTerminalType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcFireSuppressionTerminalType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcFireSuppressionTerminalType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcFireSuppressionTerminalType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcFireSuppressionTerminalType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcFireSuppressionTerminalType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcFireSuppressionTerminalType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcFireSuppressionTerminalType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcFireSuppressionTerminalType.setPredefinedType((IfcFireSuppressionTerminalTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcFireSuppressionTerminalType ifcFireSuppressionTerminalType = new IfcFireSuppressionTerminalType();
		if(this.GlobalId != null)
			ifcFireSuppressionTerminalType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcFireSuppressionTerminalType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcFireSuppressionTerminalType.setName(this.Name);
		if(this.Description != null)
			ifcFireSuppressionTerminalType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcFireSuppressionTerminalType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcFireSuppressionTerminalType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcFireSuppressionTerminalType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcFireSuppressionTerminalType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcFireSuppressionTerminalType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcFireSuppressionTerminalType.setPredefinedType(this.PredefinedType);
		return ifcFireSuppressionTerminalType;
	}
