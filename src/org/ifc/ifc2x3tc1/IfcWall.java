...
/**
 * This is a default implementation of the entity IfcWall<br><br>
 *<br><br>
 ...
 */
public class IfcWall extends IfcBuildingElement implements ClassInterface
{
...
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,268435456,37475,44139};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	public IfcWall(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag)
	{
	...
	**/
	...
	{
		return IfcWall.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCWALL(");
	...
	**/
	public Object clone()
	{
		...
		if(this.GlobalId != null)
			ifcWall.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcWall.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcWall.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcWall.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcWall.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcWall.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcWall.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcWall.setTag((IfcIdentifier)this.Tag.clone());
		return ifcWall;
	}
	...
	**/
	public Object shallowCopy()
	{
		IfcWall ifcWall = new IfcWall();
		if(this.GlobalId != null)
			ifcWall.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcWall.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcWall.setName(this.Name);
		if(this.Description != null)
			ifcWall.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcWall.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcWall.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcWall.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcWall.setTag(this.Tag);
		return ifcWall;
	}
