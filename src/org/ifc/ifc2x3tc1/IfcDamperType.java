...
/**
 * This is a default implementation of the entity IfcDamperType<br><br>
 *<br><br>
 ...
 */
public class IfcDamperType extends IfcFlowControllerType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcDamperTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,51354};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	* @param PredefinedType DEMANDED parameter of type IfcDamperTypeEnum - may not be null.
	**/
	public IfcDamperType(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ApplicableOccurrence, SET<IfcPropertySetDefinition> HasPropertySets, LIST<IfcRepresentationMap> RepresentationMaps, IfcLabel Tag, IfcLabel ElementType, IfcDamperTypeEnum PredefinedType)
	{
	...
	/**
	 * This method initializes the IfcDamperType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcDamperTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcDamperType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCDAMPERTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcDamperTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcDamperType ifcDamperType = new IfcDamperType();
		if(this.GlobalId != null)
			ifcDamperType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcDamperType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcDamperType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcDamperType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcDamperType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcDamperType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcDamperType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcDamperType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcDamperType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcDamperType.setPredefinedType((IfcDamperTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcDamperType ifcDamperType = new IfcDamperType();
		if(this.GlobalId != null)
			ifcDamperType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcDamperType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcDamperType.setName(this.Name);
		if(this.Description != null)
			ifcDamperType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcDamperType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcDamperType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcDamperType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcDamperType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcDamperType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcDamperType.setPredefinedType(this.PredefinedType);
		return ifcDamperType;
	}
