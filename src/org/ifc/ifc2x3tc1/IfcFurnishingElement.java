...
/**
 * This is a default implementation of the entity IfcFurnishingElement<br><br>
 *<br><br>
 ...
 */
public class IfcFurnishingElement extends IfcElement implements ClassInterface
{
...
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,268435456,37475,44139};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	...
	{
		return IfcFurnishingElement.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCFURNISHINGELEMENT(");
	...
	**/
	public Object clone()
	{
		IfcFurnishingElement ifcFurnishingElement = new IfcFurnishingElement();
		if(this.GlobalId != null)
			ifcFurnishingElement.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcFurnishingElement.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcFurnishingElement.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcFurnishingElement.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcFurnishingElement.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcFurnishingElement.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcFurnishingElement.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcFurnishingElement.setTag((IfcIdentifier)this.Tag.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcFurnishingElement ifcFurnishingElement = new IfcFurnishingElement();
		if(this.GlobalId != null)
			ifcFurnishingElement.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcFurnishingElement.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcFurnishingElement.setName(this.Name);
		if(this.Description != null)
			ifcFurnishingElement.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcFurnishingElement.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcFurnishingElement.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcFurnishingElement.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcFurnishingElement.setTag(this.Tag);
		return ifcFurnishingElement;
	}
