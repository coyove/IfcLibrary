...
/**
 * This is a default implementation of the entity IfcBuildingElementPart<br><br>
 *<br><br>
 ...
 */
public class IfcBuildingElementPart extends IfcBuildingElementComponent implements ClassInterface
{
	...
	**/
	...
	/**
	* Constructs a new IfcBuildingElementPart object using the given parameters.
	*
	...
	**/
	public IfcBuildingElementPart(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag)
	{
	...
	**/
	...
	{
		return IfcBuildingElementPart.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCBUILDINGELEMENTPART(");
	...
	**/
	public Object clone()
	{
		IfcBuildingElementPart ifcBuildingElementPart = new IfcBuildingElementPart();
		if(this.GlobalId != null)
			ifcBuildingElementPart.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcBuildingElementPart.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcBuildingElementPart.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcBuildingElementPart.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcBuildingElementPart.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcBuildingElementPart.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcBuildingElementPart.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcBuildingElementPart.setTag((IfcIdentifier)this.Tag.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcBuildingElementPart ifcBuildingElementPart = new IfcBuildingElementPart();
		if(this.GlobalId != null)
			ifcBuildingElementPart.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcBuildingElementPart.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcBuildingElementPart.setName(this.Name);
		if(this.Description != null)
			ifcBuildingElementPart.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcBuildingElementPart.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcBuildingElementPart.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcBuildingElementPart.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcBuildingElementPart.setTag(this.Tag);
		return ifcBuildingElementPart;
	}
