...
/**
 * This is a default implementation of the entity IfcProxy<br><br>
 *<br><br>
 ...
 */
public class IfcProxy extends IfcProduct implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcObjectTypeEnum","IfcLabel"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,268435456,37475,52215,3773};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	private java.util.ArrayList<CloneableObject> stepParameter = null;
	private java.util.HashSet<ObjectChangeListener> listenerList = null;
	protected int stepLineNumber;
	/** ProxyType is an DEMANDED attribute - may not be null**/
	...
	* @param ProxyType DEMANDED parameter of type IfcObjectTypeEnum - may not be null.
	...
	**/
	...
	/**
	 * This method initializes the IfcProxy object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param Tag OPTIONAL parameter of type IfcLabel
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcObjectTypeEnum ProxyType, IfcLabel Tag)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.ProxyType = (IfcObjectTypeEnum) parameters.get(7);
		this.Tag = (IfcLabel) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcProxy.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCPROXY(");
		...
		if(getRedefinedDerivedAttributeTypes().contains("ProxyType")) stepString = stepString.concat("*,");
		else{
		if(this.ProxyType != null)		stepString = stepString.concat(((RootInterface)this.ProxyType).getStepParameter(IfcObjectTypeEnum.class.isInterface())+",");
		else		stepString = stepString.concat("$,");
		}
	...
	**/
	...
	/**
	* This method sets the ProxyType attribute to the given value.
	*
	* @param ProxyType OPTIONAL value to set
	**/
	...
	/**
	* This method returns the value of the ProxyType attribute.
	*
	* @return the value of ProxyType
	/**/
	...
	**/
	public Object clone()
	{
		IfcProxy ifcProxy = new IfcProxy();
		if(this.GlobalId != null)
			ifcProxy.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcProxy.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcProxy.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcProxy.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcProxy.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcProxy.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcProxy.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.ProxyType != null)
			ifcProxy.setProxyType((IfcObjectTypeEnum)this.ProxyType.clone());
		if(this.Tag != null)
			ifcProxy.setTag((IfcLabel)this.Tag.clone());
		return ifcProxy;
	}
	...
	**/
	public Object shallowCopy()
	{
		IfcProxy ifcProxy = new IfcProxy();
		if(this.GlobalId != null)
			ifcProxy.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcProxy.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcProxy.setName(this.Name);
		if(this.Description != null)
			ifcProxy.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcProxy.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcProxy.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcProxy.setRepresentation(this.Representation);
		if(this.ProxyType != null)
			ifcProxy.setProxyType(this.ProxyType);
		if(this.Tag != null)
			ifcProxy.setTag(this.Tag);
		return ifcProxy;
	}
