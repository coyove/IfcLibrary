...
/**
 * This is a default implementation of the entity IfcFlowController<br><br>
 *<br><br>
 ...
 */
public class IfcFlowController extends IfcDistributionFlowElement implements ClassInterface
{
...
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,268435456,37475,44139};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	...
	{
		return IfcFlowController.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCFLOWCONTROLLER(");
	...
	**/
	public Object clone()
	{
		IfcFlowController ifcFlowController = new IfcFlowController();
		if(this.GlobalId != null)
			ifcFlowController.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcFlowController.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcFlowController.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcFlowController.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcFlowController.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcFlowController.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcFlowController.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcFlowController.setTag((IfcIdentifier)this.Tag.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcFlowController ifcFlowController = new IfcFlowController();
		if(this.GlobalId != null)
			ifcFlowController.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcFlowController.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcFlowController.setName(this.Name);
		if(this.Description != null)
			ifcFlowController.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcFlowController.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcFlowController.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcFlowController.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcFlowController.setTag(this.Tag);
		return ifcFlowController;
	}
