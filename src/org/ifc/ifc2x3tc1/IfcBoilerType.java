...
/**
 * This is a default implementation of the entity IfcBoilerType<br><br>
 *<br><br>
 ...
 */
public class IfcBoilerType extends IfcEnergyConversionDeviceType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcBoilerTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,38194};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	* @param PredefinedType DEMANDED parameter of type IfcBoilerTypeEnum - may not be null.
	**/
	public IfcBoilerType(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ApplicableOccurrence, SET<IfcPropertySetDefinition> HasPropertySets, LIST<IfcRepresentationMap> RepresentationMaps, IfcLabel Tag, IfcLabel ElementType, IfcBoilerTypeEnum PredefinedType)
	{
	...
	/**
	 * This method initializes the IfcBoilerType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcBoilerTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcBoilerType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCBOILERTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcBoilerTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcBoilerType ifcBoilerType = new IfcBoilerType();
		if(this.GlobalId != null)
			ifcBoilerType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcBoilerType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcBoilerType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcBoilerType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcBoilerType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcBoilerType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcBoilerType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcBoilerType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcBoilerType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcBoilerType.setPredefinedType((IfcBoilerTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcBoilerType ifcBoilerType = new IfcBoilerType();
		if(this.GlobalId != null)
			ifcBoilerType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcBoilerType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcBoilerType.setName(this.Name);
		if(this.Description != null)
			ifcBoilerType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcBoilerType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcBoilerType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcBoilerType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcBoilerType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcBoilerType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcBoilerType.setPredefinedType(this.PredefinedType);
		return ifcBoilerType;
	}
