...
/**
 * This is a default implementation of the entity IfcCableCarrierFittingType<br><br>
 *<br><br>
 ...
 */
public class IfcCableCarrierFittingType extends IfcFlowFittingType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcCableCarrierFittingTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,32018};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	* @param PredefinedType DEMANDED parameter of type IfcCableCarrierFittingTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcCableCarrierFittingType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcCableCarrierFittingTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcCableCarrierFittingType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCCABLECARRIERFITTINGTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcCableCarrierFittingTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcCableCarrierFittingType ifcCableCarrierFittingType = new IfcCableCarrierFittingType();
		if(this.GlobalId != null)
			ifcCableCarrierFittingType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcCableCarrierFittingType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcCableCarrierFittingType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcCableCarrierFittingType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcCableCarrierFittingType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcCableCarrierFittingType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcCableCarrierFittingType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcCableCarrierFittingType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcCableCarrierFittingType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcCableCarrierFittingType.setPredefinedType((IfcCableCarrierFittingTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcCableCarrierFittingType ifcCableCarrierFittingType = new IfcCableCarrierFittingType();
		if(this.GlobalId != null)
			ifcCableCarrierFittingType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcCableCarrierFittingType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcCableCarrierFittingType.setName(this.Name);
		if(this.Description != null)
			ifcCableCarrierFittingType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcCableCarrierFittingType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcCableCarrierFittingType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcCableCarrierFittingType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcCableCarrierFittingType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcCableCarrierFittingType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcCableCarrierFittingType.setPredefinedType(this.PredefinedType);
		return ifcCableCarrierFittingType;
	}
