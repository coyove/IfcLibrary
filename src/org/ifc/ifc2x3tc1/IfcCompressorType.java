...
/**
 * This is a default implementation of the entity IfcCompressorType<br><br>
 *<br><br>
 ...
 */
public class IfcCompressorType extends IfcFlowMovingDeviceType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcCompressorTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,38222};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	...
	/**
	* Constructs a new IfcCompressorType object using the given parameters.
	*
	...
	* @param PredefinedType DEMANDED parameter of type IfcCompressorTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcCompressorType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcCompressorTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcCompressorType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCCOMPRESSORTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcCompressorTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcCompressorType ifcCompressorType = new IfcCompressorType();
		if(this.GlobalId != null)
			ifcCompressorType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcCompressorType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcCompressorType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcCompressorType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcCompressorType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcCompressorType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcCompressorType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcCompressorType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcCompressorType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcCompressorType.setPredefinedType((IfcCompressorTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcCompressorType ifcCompressorType = new IfcCompressorType();
		if(this.GlobalId != null)
			ifcCompressorType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcCompressorType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcCompressorType.setName(this.Name);
		if(this.Description != null)
			ifcCompressorType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcCompressorType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcCompressorType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcCompressorType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcCompressorType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcCompressorType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcCompressorType.setPredefinedType(this.PredefinedType);
		return ifcCompressorType;
	}
