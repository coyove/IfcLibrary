...
/**
 * This is a default implementation of the entity IfcFlowFitting<br><br>
 *<br><br>
 ...
 */
public class IfcFlowFitting extends IfcDistributionFlowElement implements ClassInterface
{
	...
	**/
	...
	{
		return IfcFlowFitting.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCFLOWFITTING(");
	...
	**/
	public Object clone()
	{
		IfcFlowFitting ifcFlowFitting = new IfcFlowFitting();
		if(this.GlobalId != null)
			ifcFlowFitting.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcFlowFitting.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcFlowFitting.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcFlowFitting.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcFlowFitting.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcFlowFitting.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcFlowFitting.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcFlowFitting.setTag((IfcIdentifier)this.Tag.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcFlowFitting ifcFlowFitting = new IfcFlowFitting();
		if(this.GlobalId != null)
			ifcFlowFitting.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcFlowFitting.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcFlowFitting.setName(this.Name);
		if(this.Description != null)
			ifcFlowFitting.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcFlowFitting.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcFlowFitting.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcFlowFitting.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcFlowFitting.setTag(this.Tag);
		return ifcFlowFitting;
	}
