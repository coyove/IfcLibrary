...
/**
 * This is a default implementation of the entity IfcFooting<br><br>
 *<br><br>
 ...
 */
public class IfcFooting extends IfcBuildingElement implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcFootingTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,268435456,37475,44139,9201};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	* @param PredefinedType DEMANDED parameter of type IfcFootingTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcFooting object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType DEMANDED parameter of type IfcFootingTypeEnum - may not be null.
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcFootingTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcFootingTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcFooting.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCFOOTING(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcFootingTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	public Object clone()
	{
		IfcFooting ifcFooting = new IfcFooting();
		if(this.GlobalId != null)
			ifcFooting.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcFooting.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcFooting.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcFooting.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcFooting.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcFooting.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcFooting.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcFooting.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcFooting.setPredefinedType((IfcFootingTypeEnum)this.PredefinedType.clone());
		return ifcFooting;
	}
	...
	**/
	public Object shallowCopy()
	{
		IfcFooting ifcFooting = new IfcFooting();
		if(this.GlobalId != null)
			ifcFooting.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcFooting.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcFooting.setName(this.Name);
		if(this.Description != null)
			ifcFooting.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcFooting.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcFooting.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcFooting.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcFooting.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcFooting.setPredefinedType(this.PredefinedType);
		return ifcFooting;
	}
