...
/**
 * This is a default implementation of the entity IfcCoolingTowerType<br><br>
 *<br><br>
 ...
 */
public class IfcCoolingTowerType extends IfcEnergyConversionDeviceType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcCoolingTowerTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,57055};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	* @param PredefinedType DEMANDED parameter of type IfcCoolingTowerTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcCoolingTowerType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcCoolingTowerTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcCoolingTowerType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCCOOLINGTOWERTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcCoolingTowerTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcCoolingTowerType ifcCoolingTowerType = new IfcCoolingTowerType();
		if(this.GlobalId != null)
			ifcCoolingTowerType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcCoolingTowerType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcCoolingTowerType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcCoolingTowerType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcCoolingTowerType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcCoolingTowerType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcCoolingTowerType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcCoolingTowerType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcCoolingTowerType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcCoolingTowerType.setPredefinedType((IfcCoolingTowerTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcCoolingTowerType ifcCoolingTowerType = new IfcCoolingTowerType();
		if(this.GlobalId != null)
			ifcCoolingTowerType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcCoolingTowerType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcCoolingTowerType.setName(this.Name);
		if(this.Description != null)
			ifcCoolingTowerType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcCoolingTowerType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcCoolingTowerType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcCoolingTowerType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcCoolingTowerType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcCoolingTowerType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcCoolingTowerType.setPredefinedType(this.PredefinedType);
		return ifcCoolingTowerType;
	}
