...
/**
 * This is a default implementation of the entity IfcElementAssembly<br><br>
 *<br><br>
 ...
 */
public class IfcElementAssembly extends IfcElement implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcAssemblyPlaceEnum","IfcElementAssemblyTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,268435456,37475,44139,27646,26883};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	private java.util.ArrayList<CloneableObject> stepParameter = null;
	private java.util.HashSet<ObjectChangeListener> listenerList = null;
	protected int stepLineNumber;
	/** AssemblyPlace is an OPTIONAL attribute**/
	...
	* @param AssemblyPlace OPTIONAL parameter of type IfcAssemblyPlaceEnum
	* @param PredefinedType DEMANDED parameter of type IfcElementAssemblyTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcElementAssembly object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.AssemblyPlace = (IfcAssemblyPlaceEnum) parameters.get(8);
		this.PredefinedType = (IfcElementAssemblyTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcElementAssembly.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCELEMENTASSEMBLY(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcElementAssemblyTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	*
	* @param AssemblyPlace DEMANDED value to set - may not be null
	**/
	...
	**/
	public Object clone()
	{
		IfcElementAssembly ifcElementAssembly = new IfcElementAssembly();
		if(this.GlobalId != null)
			ifcElementAssembly.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcElementAssembly.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcElementAssembly.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcElementAssembly.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcElementAssembly.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcElementAssembly.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcElementAssembly.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcElementAssembly.setTag((IfcIdentifier)this.Tag.clone());
		if(this.AssemblyPlace != null)
			ifcElementAssembly.setAssemblyPlace((IfcAssemblyPlaceEnum)this.AssemblyPlace.clone());
		if(this.PredefinedType != null)
			ifcElementAssembly.setPredefinedType((IfcElementAssemblyTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcElementAssembly ifcElementAssembly = new IfcElementAssembly();
		if(this.GlobalId != null)
			ifcElementAssembly.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcElementAssembly.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcElementAssembly.setName(this.Name);
		if(this.Description != null)
			ifcElementAssembly.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcElementAssembly.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcElementAssembly.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcElementAssembly.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcElementAssembly.setTag(this.Tag);
		if(this.AssemblyPlace != null)
			ifcElementAssembly.setAssemblyPlace(this.AssemblyPlace);
		if(this.PredefinedType != null)
			ifcElementAssembly.setPredefinedType(this.PredefinedType);
		return ifcElementAssembly;
	}
