...
/**
 * This is a default implementation of the entity IfcWallType<br><br>
 *<br><br>
 ...
 */
public class IfcWallType extends IfcBuildingElementType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcWallTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,43341};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	...
	/**
	* Constructs a new IfcWallType object using the given parameters.
	*
	...
	* @param PredefinedType DEMANDED parameter of type IfcWallTypeEnum - may not be null.
	**/
	public IfcWallType(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ApplicableOccurrence, SET<IfcPropertySetDefinition> HasPropertySets, LIST<IfcRepresentationMap> RepresentationMaps, IfcLabel Tag, IfcLabel ElementType, IfcWallTypeEnum PredefinedType)
	{
	...
	/**
	 * This method initializes the IfcWallType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcWallTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcWallType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCWALLTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcWallTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcWallType ifcWallType = new IfcWallType();
		if(this.GlobalId != null)
			ifcWallType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcWallType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcWallType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcWallType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcWallType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcWallType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcWallType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcWallType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcWallType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcWallType.setPredefinedType((IfcWallTypeEnum)this.PredefinedType.clone());
		return ifcWallType;
	}
	...
	**/
	public Object shallowCopy()
	{
		IfcWallType ifcWallType = new IfcWallType();
		if(this.GlobalId != null)
			ifcWallType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcWallType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcWallType.setName(this.Name);
		if(this.Description != null)
			ifcWallType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcWallType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcWallType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcWallType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcWallType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcWallType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcWallType.setPredefinedType(this.PredefinedType);
		return ifcWallType;
	}
