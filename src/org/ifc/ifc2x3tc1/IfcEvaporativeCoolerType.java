...
/**
 * This is a default implementation of the entity IfcEvaporativeCoolerType<br><br>
 *<br><br>
 ...
 */
public class IfcEvaporativeCoolerType extends IfcEnergyConversionDeviceType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcEvaporativeCoolerTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,25647};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	* @param PredefinedType DEMANDED parameter of type IfcEvaporativeCoolerTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcEvaporativeCoolerType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcEvaporativeCoolerTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcEvaporativeCoolerType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCEVAPORATIVECOOLERTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcEvaporativeCoolerTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcEvaporativeCoolerType ifcEvaporativeCoolerType = new IfcEvaporativeCoolerType();
		if(this.GlobalId != null)
			ifcEvaporativeCoolerType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcEvaporativeCoolerType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcEvaporativeCoolerType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcEvaporativeCoolerType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcEvaporativeCoolerType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcEvaporativeCoolerType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcEvaporativeCoolerType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcEvaporativeCoolerType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcEvaporativeCoolerType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcEvaporativeCoolerType.setPredefinedType((IfcEvaporativeCoolerTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcEvaporativeCoolerType ifcEvaporativeCoolerType = new IfcEvaporativeCoolerType();
		if(this.GlobalId != null)
			ifcEvaporativeCoolerType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcEvaporativeCoolerType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcEvaporativeCoolerType.setName(this.Name);
		if(this.Description != null)
			ifcEvaporativeCoolerType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcEvaporativeCoolerType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcEvaporativeCoolerType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcEvaporativeCoolerType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcEvaporativeCoolerType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcEvaporativeCoolerType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcEvaporativeCoolerType.setPredefinedType(this.PredefinedType);
		return ifcEvaporativeCoolerType;
	}
