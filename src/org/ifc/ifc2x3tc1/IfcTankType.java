...
/**
 * This is a default implementation of the entity IfcTankType<br><br>
 *<br><br>
 ...
 */
public class IfcTankType extends IfcFlowStorageDeviceType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcTankTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,44954};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	* @param PredefinedType DEMANDED parameter of type IfcTankTypeEnum - may not be null.
	**/
	public IfcTankType(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ApplicableOccurrence, SET<IfcPropertySetDefinition> HasPropertySets, LIST<IfcRepresentationMap> RepresentationMaps, IfcLabel Tag, IfcLabel ElementType, IfcTankTypeEnum PredefinedType)
	{
	...
	/**
	 * This method initializes the IfcTankType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcTankTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcTankType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCTANKTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcTankTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcTankType ifcTankType = new IfcTankType();
		if(this.GlobalId != null)
			ifcTankType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcTankType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcTankType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcTankType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcTankType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcTankType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcTankType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcTankType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcTankType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcTankType.setPredefinedType((IfcTankTypeEnum)this.PredefinedType.clone());
		return ifcTankType;
	}
	...
	**/
	public Object shallowCopy()
	{
		IfcTankType ifcTankType = new IfcTankType();
		if(this.GlobalId != null)
			ifcTankType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcTankType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcTankType.setName(this.Name);
		if(this.Description != null)
			ifcTankType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcTankType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcTankType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcTankType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcTankType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcTankType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcTankType.setPredefinedType(this.PredefinedType);
		return ifcTankType;
	}
