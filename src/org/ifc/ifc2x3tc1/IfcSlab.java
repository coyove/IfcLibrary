...
/**
 * This is a default implementation of the entity IfcSlab<br><br>
 *<br><br>
 ...
 */
public class IfcSlab extends IfcBuildingElement implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcSlabTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,268435456,37475,44139,43278};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	...
	/**
	* Constructs a new IfcSlab object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcSlabTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcSlab object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcSlabTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcSlabTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcSlabTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcSlab.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCSLAB(");
	...
	**/
	public Object clone()
	{
		...
		if(this.GlobalId != null)
			ifcSlab.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcSlab.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcSlab.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcSlab.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcSlab.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcSlab.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcSlab.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcSlab.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcSlab.setPredefinedType((IfcSlabTypeEnum)this.PredefinedType.clone());
		return ifcSlab;
	}
	...
	**/
	public Object shallowCopy()
	{
		IfcSlab ifcSlab = new IfcSlab();
		if(this.GlobalId != null)
			ifcSlab.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcSlab.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcSlab.setName(this.Name);
		if(this.Description != null)
			ifcSlab.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcSlab.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcSlab.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcSlab.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcSlab.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcSlab.setPredefinedType(this.PredefinedType);
		return ifcSlab;
	}
