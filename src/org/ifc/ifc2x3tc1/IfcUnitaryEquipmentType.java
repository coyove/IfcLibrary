...
/**
 * This is a default implementation of the entity IfcUnitaryEquipmentType<br><br>
 *<br><br>
 ...
 */
public class IfcUnitaryEquipmentType extends IfcEnergyConversionDeviceType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcUnitaryEquipmentTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,32871};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	* @param PredefinedType DEMANDED parameter of type IfcUnitaryEquipmentTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcUnitaryEquipmentType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcUnitaryEquipmentTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcUnitaryEquipmentType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCUNITARYEQUIPMENTTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcUnitaryEquipmentTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcUnitaryEquipmentType ifcUnitaryEquipmentType = new IfcUnitaryEquipmentType();
		if(this.GlobalId != null)
			ifcUnitaryEquipmentType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcUnitaryEquipmentType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcUnitaryEquipmentType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcUnitaryEquipmentType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcUnitaryEquipmentType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcUnitaryEquipmentType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcUnitaryEquipmentType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcUnitaryEquipmentType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcUnitaryEquipmentType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcUnitaryEquipmentType.setPredefinedType((IfcUnitaryEquipmentTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcUnitaryEquipmentType ifcUnitaryEquipmentType = new IfcUnitaryEquipmentType();
		if(this.GlobalId != null)
			ifcUnitaryEquipmentType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcUnitaryEquipmentType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcUnitaryEquipmentType.setName(this.Name);
		if(this.Description != null)
			ifcUnitaryEquipmentType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcUnitaryEquipmentType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcUnitaryEquipmentType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcUnitaryEquipmentType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcUnitaryEquipmentType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcUnitaryEquipmentType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcUnitaryEquipmentType.setPredefinedType(this.PredefinedType);
		return ifcUnitaryEquipmentType;
	}
