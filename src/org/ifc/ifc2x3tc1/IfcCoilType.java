...
/**
 * This is a default implementation of the entity IfcCoilType<br><br>
 *<br><br>
 ...
 */
public class IfcCoilType extends IfcEnergyConversionDeviceType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcCoilTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,43379};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	* @param PredefinedType DEMANDED parameter of type IfcCoilTypeEnum - may not be null.
	**/
	public IfcCoilType(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ApplicableOccurrence, SET<IfcPropertySetDefinition> HasPropertySets, LIST<IfcRepresentationMap> RepresentationMaps, IfcLabel Tag, IfcLabel ElementType, IfcCoilTypeEnum PredefinedType)
	{
	...
	/**
	 * This method initializes the IfcCoilType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcCoilTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcCoilType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCCOILTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcCoilTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcCoilType ifcCoilType = new IfcCoilType();
		if(this.GlobalId != null)
			ifcCoilType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcCoilType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcCoilType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcCoilType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcCoilType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcCoilType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcCoilType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcCoilType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcCoilType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcCoilType.setPredefinedType((IfcCoilTypeEnum)this.PredefinedType.clone());
		return ifcCoilType;
	}
	...
	**/
	public Object shallowCopy()
	{
		IfcCoilType ifcCoilType = new IfcCoilType();
		if(this.GlobalId != null)
			ifcCoilType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcCoilType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcCoilType.setName(this.Name);
		if(this.Description != null)
			ifcCoilType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcCoilType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcCoilType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcCoilType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcCoilType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcCoilType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcCoilType.setPredefinedType(this.PredefinedType);
		return ifcCoilType;
	}
