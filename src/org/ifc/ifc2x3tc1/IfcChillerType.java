...
/**
 * This is a default implementation of the entity IfcChillerType<br><br>
 *<br><br>
 ...
 */
public class IfcChillerType extends IfcEnergyConversionDeviceType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcChillerTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,31216};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	* @param PredefinedType DEMANDED parameter of type IfcChillerTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcChillerType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcChillerTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcChillerType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCCHILLERTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcChillerTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcChillerType ifcChillerType = new IfcChillerType();
		if(this.GlobalId != null)
			ifcChillerType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcChillerType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcChillerType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcChillerType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcChillerType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcChillerType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcChillerType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcChillerType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcChillerType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcChillerType.setPredefinedType((IfcChillerTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcChillerType ifcChillerType = new IfcChillerType();
		if(this.GlobalId != null)
			ifcChillerType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcChillerType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcChillerType.setName(this.Name);
		if(this.Description != null)
			ifcChillerType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcChillerType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcChillerType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcChillerType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcChillerType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcChillerType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcChillerType.setPredefinedType(this.PredefinedType);
		return ifcChillerType;
	}
