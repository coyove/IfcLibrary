...
/**
 * This is a default implementation of the entity IfcElectricTimeControlType<br><br>
 *<br><br>
 ...
 */
public class IfcElectricTimeControlType extends IfcFlowControllerType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcElectricTimeControlTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,16600};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	* @param PredefinedType DEMANDED parameter of type IfcElectricTimeControlTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcElectricTimeControlType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcElectricTimeControlTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcElectricTimeControlType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCELECTRICTIMECONTROLTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcElectricTimeControlTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcElectricTimeControlType ifcElectricTimeControlType = new IfcElectricTimeControlType();
		if(this.GlobalId != null)
			ifcElectricTimeControlType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcElectricTimeControlType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcElectricTimeControlType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcElectricTimeControlType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcElectricTimeControlType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcElectricTimeControlType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcElectricTimeControlType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcElectricTimeControlType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcElectricTimeControlType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcElectricTimeControlType.setPredefinedType((IfcElectricTimeControlTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcElectricTimeControlType ifcElectricTimeControlType = new IfcElectricTimeControlType();
		if(this.GlobalId != null)
			ifcElectricTimeControlType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcElectricTimeControlType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcElectricTimeControlType.setName(this.Name);
		if(this.Description != null)
			ifcElectricTimeControlType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcElectricTimeControlType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcElectricTimeControlType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcElectricTimeControlType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcElectricTimeControlType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcElectricTimeControlType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcElectricTimeControlType.setPredefinedType(this.PredefinedType);
		return ifcElectricTimeControlType;
	}
