...
/**
 * This is a default implementation of the entity IfcHumidifierType<br><br>
 *<br><br>
 ...
 */
public class IfcHumidifierType extends IfcEnergyConversionDeviceType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcHumidifierTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,48406};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	...
	/**
	* Constructs a new IfcHumidifierType object using the given parameters.
	*
	...
	* @param PredefinedType DEMANDED parameter of type IfcHumidifierTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcHumidifierType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcHumidifierTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcHumidifierType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCHUMIDIFIERTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcHumidifierTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcHumidifierType ifcHumidifierType = new IfcHumidifierType();
		if(this.GlobalId != null)
			ifcHumidifierType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcHumidifierType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcHumidifierType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcHumidifierType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcHumidifierType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcHumidifierType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcHumidifierType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcHumidifierType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcHumidifierType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcHumidifierType.setPredefinedType((IfcHumidifierTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcHumidifierType ifcHumidifierType = new IfcHumidifierType();
		if(this.GlobalId != null)
			ifcHumidifierType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcHumidifierType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcHumidifierType.setName(this.Name);
		if(this.Description != null)
			ifcHumidifierType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcHumidifierType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcHumidifierType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcHumidifierType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcHumidifierType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcHumidifierType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcHumidifierType.setPredefinedType(this.PredefinedType);
		return ifcHumidifierType;
	}
