...
/**
 * This is a default implementation of the entity IfcStructuralLinearActionVarying<br><br>
 *<br><br>
 ...
 */
public class IfcStructuralLinearActionVarying extends IfcStructuralLinearAction implements ClassInterface
{
...
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,268435456,37475,268435456,21554,47261,268435456,11259,6813,-2147445316};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	...
	/**
	 * This method initializes the IfcStructuralLinearActionVarying object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	{
		return IfcStructuralLinearActionVarying.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCSTRUCTURALLINEARACTIONVARYING(");
	...
	**/
	...
	public Object clone()
	{
		IfcStructuralLinearActionVarying ifcStructuralLinearActionVarying = new IfcStructuralLinearActionVarying();
		if(this.GlobalId != null)
			ifcStructuralLinearActionVarying.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcStructuralLinearActionVarying.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcStructuralLinearActionVarying.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcStructuralLinearActionVarying.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcStructuralLinearActionVarying.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcStructuralLinearActionVarying.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcStructuralLinearActionVarying.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.AppliedLoad != null)
			ifcStructuralLinearActionVarying.setAppliedLoad((IfcStructuralLoad)this.AppliedLoad.clone());
		if(this.GlobalOrLocal != null)
			ifcStructuralLinearActionVarying.setGlobalOrLocal((IfcGlobalOrLocalEnum)this.GlobalOrLocal.clone());
		if(this.DestabilizingLoad != null)
			ifcStructuralLinearActionVarying.setDestabilizingLoad((BOOLEAN)this.DestabilizingLoad.clone());
		if(this.CausedBy != null)
			ifcStructuralLinearActionVarying.setCausedBy((IfcStructuralReaction)this.CausedBy.clone());
		if(this.ProjectedOrTrue != null)
			ifcStructuralLinearActionVarying.setProjectedOrTrue((IfcProjectedOrTrueLengthEnum)this.ProjectedOrTrue.clone());
		if(this.VaryingAppliedLoadLocation != null)
			ifcStructuralLinearActionVarying.setVaryingAppliedLoadLocation((IfcShapeAspect)this.VaryingAppliedLoadLocation.clone());
		if(this.SubsequentAppliedLoads != null)
			ifcStructuralLinearActionVarying.setSubsequentAppliedLoads((LIST<IfcStructuralLoad>)this.SubsequentAppliedLoads.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcStructuralLinearActionVarying ifcStructuralLinearActionVarying = new IfcStructuralLinearActionVarying();
		if(this.GlobalId != null)
			ifcStructuralLinearActionVarying.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcStructuralLinearActionVarying.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcStructuralLinearActionVarying.setName(this.Name);
		if(this.Description != null)
			ifcStructuralLinearActionVarying.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcStructuralLinearActionVarying.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcStructuralLinearActionVarying.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcStructuralLinearActionVarying.setRepresentation(this.Representation);
		if(this.AppliedLoad != null)
			ifcStructuralLinearActionVarying.setAppliedLoad(this.AppliedLoad);
		if(this.GlobalOrLocal != null)
			ifcStructuralLinearActionVarying.setGlobalOrLocal(this.GlobalOrLocal);
		if(this.DestabilizingLoad != null)
			ifcStructuralLinearActionVarying.setDestabilizingLoad(this.DestabilizingLoad);
		if(this.CausedBy != null)
			ifcStructuralLinearActionVarying.setCausedBy(this.CausedBy);
		if(this.ProjectedOrTrue != null)
			ifcStructuralLinearActionVarying.setProjectedOrTrue(this.ProjectedOrTrue);
		if(this.VaryingAppliedLoadLocation != null)
			ifcStructuralLinearActionVarying.setVaryingAppliedLoadLocation(this.VaryingAppliedLoadLocation);
		if(this.SubsequentAppliedLoads != null)
			ifcStructuralLinearActionVarying.setSubsequentAppliedLoads(this.SubsequentAppliedLoads);
		return ifcStructuralLinearActionVarying;
	}
