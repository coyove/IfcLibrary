...
/**
 * This is a default implementation of the entity IfcFlowTerminal<br><br>
 *<br><br>
 ...
 */
public class IfcFlowTerminal extends IfcDistributionFlowElement implements ClassInterface
{
...
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,268435456,37475,44139};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	...
	/**
	* Constructs a new IfcFlowTerminal object using the given parameters.
	*
	...
	**/
	...
	{
		return IfcFlowTerminal.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCFLOWTERMINAL(");
	...
	**/
	public Object clone()
	{
		IfcFlowTerminal ifcFlowTerminal = new IfcFlowTerminal();
		if(this.GlobalId != null)
			ifcFlowTerminal.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcFlowTerminal.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcFlowTerminal.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcFlowTerminal.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcFlowTerminal.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcFlowTerminal.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcFlowTerminal.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcFlowTerminal.setTag((IfcIdentifier)this.Tag.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcFlowTerminal ifcFlowTerminal = new IfcFlowTerminal();
		if(this.GlobalId != null)
			ifcFlowTerminal.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcFlowTerminal.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcFlowTerminal.setName(this.Name);
		if(this.Description != null)
			ifcFlowTerminal.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcFlowTerminal.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcFlowTerminal.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcFlowTerminal.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcFlowTerminal.setTag(this.Tag);
		return ifcFlowTerminal;
	}
