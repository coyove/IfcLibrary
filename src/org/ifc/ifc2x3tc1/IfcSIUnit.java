...
/**
 * This is a default implementation of the entity IfcSIUnit<br><br>
 *<br><br>
 ...
 */
public class IfcSIUnit extends IfcNamedUnit implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcDimensionalExponents","IfcUnitEnum","IfcSIPrefix","IfcSIUnitName"};
private static final int[] nonInverseHashAttributes = new int[]{12523,41062,41081,13654};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	private java.util.ArrayList<CloneableObject> stepParameter = null;
	private java.util.HashSet<ObjectChangeListener> listenerList = null;
	protected int stepLineNumber;
	/** Prefix is an OPTIONAL attribute**/
	...
	* @param Prefix OPTIONAL parameter of type IfcSIPrefix
	* @param Name DEMANDED parameter of type IfcSIUnitName - may not be null.
	**/
	...
	**/
	...
	{
		return IfcSIUnit.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		if(getRedefinedDerivedAttributeTypes().contains("Prefix")) stepString = stepString.concat("*,");
		else{
		if(this.Prefix != null)		stepString = stepString.concat(((RootInterface)this.Prefix).getStepParameter(IfcSIPrefix.class.isInterface())+",");
		else		stepString = stepString.concat("$,");
		}
		if(getRedefinedDerivedAttributeTypes().contains("Name")) stepString = stepString.concat("*);");
		else{
		if(this.Name != null)		stepString = stepString.concat(((RootInterface)this.Name).getStepParameter(IfcSIUnitName.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	*
	* @param Prefix DEMANDED value to set - may not be null
	**/
	...
	**/
	public Object clone()
	{
		...
		if(this.Dimensions != null)
			ifcSIUnit.setDimensions((IfcDimensionalExponents)this.Dimensions.clone());
		if(this.UnitType != null)
			ifcSIUnit.setUnitType((IfcUnitEnum)this.UnitType.clone());
		if(this.Prefix != null)
			ifcSIUnit.setPrefix((IfcSIPrefix)this.Prefix.clone());
		if(this.Name != null)
			ifcSIUnit.setName((IfcSIUnitName)this.Name.clone());
		return ifcSIUnit;
	}
	...
	**/
	public Object shallowCopy()
	{
		IfcSIUnit ifcSIUnit = new IfcSIUnit();
		if(this.Dimensions != null)
			ifcSIUnit.setDimensions(this.Dimensions);
		if(this.UnitType != null)
			ifcSIUnit.setUnitType(this.UnitType);
		if(this.Prefix != null)
			ifcSIUnit.setPrefix(this.Prefix);
		if(this.Name != null)
			ifcSIUnit.setName(this.Name);
		return ifcSIUnit;
	}
