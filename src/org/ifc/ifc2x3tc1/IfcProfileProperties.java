 ...
 */
public abstract class IfcProfileProperties extends InternalAccessClass implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcLabel","IfcProfileDef"};
private static final int[] nonInverseHashAttributes = new int[]{3773,268435456};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	/** ProfileDefinition is an OPTIONAL attribute**/
	...
	* @param ProfileDefinition OPTIONAL parameter of type IfcProfileDef
	**/
	public void setParameters(IfcLabel ProfileName, IfcProfileDef ProfileDefinition)
	{
		this.ProfileName = ProfileName;
		this.ProfileDefinition = ProfileDefinition;
		resolveInverses();
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	*
	* @param ProfileDefinition DEMANDED value to set - may not be null
	**/
