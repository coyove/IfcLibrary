...
/**
 * This is a default implementation of the entity IfcVibrationIsolatorType<br><br>
 *<br><br>
 ...
 */
public class IfcVibrationIsolatorType extends IfcDiscreteAccessoryType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcVibrationIsolatorTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,31972};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	* @param PredefinedType DEMANDED parameter of type IfcVibrationIsolatorTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcVibrationIsolatorType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcVibrationIsolatorTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcVibrationIsolatorType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCVIBRATIONISOLATORTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcVibrationIsolatorTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcVibrationIsolatorType ifcVibrationIsolatorType = new IfcVibrationIsolatorType();
		if(this.GlobalId != null)
			ifcVibrationIsolatorType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcVibrationIsolatorType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcVibrationIsolatorType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcVibrationIsolatorType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcVibrationIsolatorType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcVibrationIsolatorType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcVibrationIsolatorType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcVibrationIsolatorType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcVibrationIsolatorType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcVibrationIsolatorType.setPredefinedType((IfcVibrationIsolatorTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcVibrationIsolatorType ifcVibrationIsolatorType = new IfcVibrationIsolatorType();
		if(this.GlobalId != null)
			ifcVibrationIsolatorType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcVibrationIsolatorType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcVibrationIsolatorType.setName(this.Name);
		if(this.Description != null)
			ifcVibrationIsolatorType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcVibrationIsolatorType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcVibrationIsolatorType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcVibrationIsolatorType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcVibrationIsolatorType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcVibrationIsolatorType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcVibrationIsolatorType.setPredefinedType(this.PredefinedType);
		return ifcVibrationIsolatorType;
	}
