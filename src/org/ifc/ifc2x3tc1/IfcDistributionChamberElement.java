...
/**
 * This is a default implementation of the entity IfcDistributionChamberElement<br><br>
 *<br><br>
 ...
 */
public class IfcDistributionChamberElement extends IfcDistributionFlowElement implements ClassInterface
{
	...
	**/
	public IfcDistributionChamberElement(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag)
	{
	...
	**/
	...
	{
		return IfcDistributionChamberElement.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCDISTRIBUTIONCHAMBERELEMENT(");
	...
	**/
	public Object clone()
	{
		IfcDistributionChamberElement ifcDistributionChamberElement = new IfcDistributionChamberElement();
		if(this.GlobalId != null)
			ifcDistributionChamberElement.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcDistributionChamberElement.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcDistributionChamberElement.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcDistributionChamberElement.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcDistributionChamberElement.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcDistributionChamberElement.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcDistributionChamberElement.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcDistributionChamberElement.setTag((IfcIdentifier)this.Tag.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcDistributionChamberElement ifcDistributionChamberElement = new IfcDistributionChamberElement();
		if(this.GlobalId != null)
			ifcDistributionChamberElement.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcDistributionChamberElement.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcDistributionChamberElement.setName(this.Name);
		if(this.Description != null)
			ifcDistributionChamberElement.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcDistributionChamberElement.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcDistributionChamberElement.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcDistributionChamberElement.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcDistributionChamberElement.setTag(this.Tag);
		return ifcDistributionChamberElement;
	}
