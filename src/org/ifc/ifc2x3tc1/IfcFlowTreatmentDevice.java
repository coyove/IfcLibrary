...
/**
 * This is a default implementation of the entity IfcFlowTreatmentDevice<br><br>
 *<br><br>
 ...
 */
public class IfcFlowTreatmentDevice extends IfcDistributionFlowElement implements ClassInterface
{
...
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,268435456,37475,44139};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	...
	{
		return IfcFlowTreatmentDevice.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCFLOWTREATMENTDEVICE(");
	...
	**/
	public Object clone()
	{
		IfcFlowTreatmentDevice ifcFlowTreatmentDevice = new IfcFlowTreatmentDevice();
		if(this.GlobalId != null)
			ifcFlowTreatmentDevice.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcFlowTreatmentDevice.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcFlowTreatmentDevice.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcFlowTreatmentDevice.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcFlowTreatmentDevice.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcFlowTreatmentDevice.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcFlowTreatmentDevice.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcFlowTreatmentDevice.setTag((IfcIdentifier)this.Tag.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcFlowTreatmentDevice ifcFlowTreatmentDevice = new IfcFlowTreatmentDevice();
		if(this.GlobalId != null)
			ifcFlowTreatmentDevice.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcFlowTreatmentDevice.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcFlowTreatmentDevice.setName(this.Name);
		if(this.Description != null)
			ifcFlowTreatmentDevice.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcFlowTreatmentDevice.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcFlowTreatmentDevice.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcFlowTreatmentDevice.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcFlowTreatmentDevice.setTag(this.Tag);
		return ifcFlowTreatmentDevice;
	}
