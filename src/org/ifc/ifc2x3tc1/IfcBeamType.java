...
/**
 * This is a default implementation of the entity IfcBeamType<br><br>
 *<br><br>
 ...
 */
public class IfcBeamType extends IfcBuildingElementType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcBeamTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,50730};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	* @param PredefinedType DEMANDED parameter of type IfcBeamTypeEnum - may not be null.
	**/
	public IfcBeamType(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ApplicableOccurrence, SET<IfcPropertySetDefinition> HasPropertySets, LIST<IfcRepresentationMap> RepresentationMaps, IfcLabel Tag, IfcLabel ElementType, IfcBeamTypeEnum PredefinedType)
	{
	...
	/**
	 * This method initializes the IfcBeamType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcBeamTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcBeamType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCBEAMTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcBeamTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcBeamType ifcBeamType = new IfcBeamType();
		if(this.GlobalId != null)
			ifcBeamType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcBeamType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcBeamType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcBeamType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcBeamType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcBeamType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcBeamType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcBeamType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcBeamType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcBeamType.setPredefinedType((IfcBeamTypeEnum)this.PredefinedType.clone());
		return ifcBeamType;
	}
	...
	**/
	public Object shallowCopy()
	{
		IfcBeamType ifcBeamType = new IfcBeamType();
		if(this.GlobalId != null)
			ifcBeamType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcBeamType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcBeamType.setName(this.Name);
		if(this.Description != null)
			ifcBeamType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcBeamType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcBeamType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcBeamType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcBeamType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcBeamType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcBeamType.setPredefinedType(this.PredefinedType);
		return ifcBeamType;
	}
