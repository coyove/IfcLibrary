...
/**
 * This is a default implementation of the entity IfcBlock<br><br>
 *<br><br>
 ...
 */
public class IfcBlock extends IfcCsgPrimitive3D implements ClassInterface
{
...
private static final int[] nonInverseHashAttributes = new int[]{46787,35714,35714,35714};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	/** ZLength is an DEMANDED attribute - may not be null**/
	...
	* @param ZLength DEMANDED parameter of type IfcPositiveLengthMeasure - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcBlock object using the given parameters.
	*
	* @param Position DEMANDED parameter of type IfcAxis2Placement3D - may not be null.
	* @param XLength DEMANDED parameter of type IfcPositiveLengthMeasure - may not be null.
	* @param YLength DEMANDED parameter of type IfcPositiveLengthMeasure - may not be null.
	* @param ZLength DEMANDED parameter of type IfcPositiveLengthMeasure - may not be null.
	**/
	public void setParameters(IfcAxis2Placement3D Position, IfcPositiveLengthMeasure XLength, IfcPositiveLengthMeasure YLength, IfcPositiveLengthMeasure ZLength)
	{
		this.Position = Position;
		this.XLength = XLength;
		this.YLength = YLength;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.ZLength = (IfcPositiveLengthMeasure) parameters.get(3);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcBlock.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCBLOCK(");
		...
		if(getRedefinedDerivedAttributeTypes().contains("ZLength")) stepString = stepString.concat("*);");
		else{
		if(this.ZLength != null)		stepString = stepString.concat(((RootInterface)this.ZLength).getStepParameter(IfcPositiveLengthMeasure.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	* @return the value of YLength
	...
	/**
	* This method sets the ZLength attribute to the given value.
	*
	* @param ZLength OPTIONAL value to set
	**/
	...
	/**
	* This method returns the value of the ZLength attribute.
	*
	* @return the value of ZLength
	/**/
	...
	**/
	public Object clone()
	{
		IfcBlock ifcBlock = new IfcBlock();
		if(this.Position != null)
			ifcBlock.setPosition((IfcAxis2Placement3D)this.Position.clone());
		if(this.XLength != null)
			ifcBlock.setXLength((IfcPositiveLengthMeasure)this.XLength.clone());
		if(this.YLength != null)
			ifcBlock.setYLength((IfcPositiveLengthMeasure)this.YLength.clone());
		if(this.ZLength != null)
			ifcBlock.setZLength((IfcPositiveLengthMeasure)this.ZLength.clone());
		return ifcBlock;
	}
	...
	**/
	public Object shallowCopy()
	{
		IfcBlock ifcBlock = new IfcBlock();
		if(this.Position != null)
			ifcBlock.setPosition(this.Position);
		if(this.XLength != null)
			ifcBlock.setXLength(this.XLength);
		if(this.YLength != null)
			ifcBlock.setYLength(this.YLength);
		if(this.ZLength != null)
			ifcBlock.setZLength(this.ZLength);
		return ifcBlock;
	}
