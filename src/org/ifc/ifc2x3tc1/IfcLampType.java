...
/**
 * This is a default implementation of the entity IfcLampType<br><br>
 *<br><br>
 ...
 */
public class IfcLampType extends IfcFlowTerminalType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcLampTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,53768};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	* @param PredefinedType DEMANDED parameter of type IfcLampTypeEnum - may not be null.
	**/
	public IfcLampType(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ApplicableOccurrence, SET<IfcPropertySetDefinition> HasPropertySets, LIST<IfcRepresentationMap> RepresentationMaps, IfcLabel Tag, IfcLabel ElementType, IfcLampTypeEnum PredefinedType)
	{
	...
	/**
	 * This method initializes the IfcLampType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcLampTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcLampType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCLAMPTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcLampTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcLampType ifcLampType = new IfcLampType();
		if(this.GlobalId != null)
			ifcLampType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcLampType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcLampType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcLampType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcLampType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcLampType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcLampType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcLampType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcLampType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcLampType.setPredefinedType((IfcLampTypeEnum)this.PredefinedType.clone());
		return ifcLampType;
	}
	...
	**/
	public Object shallowCopy()
	{
		IfcLampType ifcLampType = new IfcLampType();
		if(this.GlobalId != null)
			ifcLampType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcLampType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcLampType.setName(this.Name);
		if(this.Description != null)
			ifcLampType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcLampType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcLampType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcLampType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcLampType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcLampType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcLampType.setPredefinedType(this.PredefinedType);
		return ifcLampType;
	}
