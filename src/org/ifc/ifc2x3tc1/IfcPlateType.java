...
/**
 * This is a default implementation of the entity IfcPlateType<br><br>
 *<br><br>
 ...
 */
public class IfcPlateType extends IfcBuildingElementType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcPlateTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,8073};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	* @param PredefinedType DEMANDED parameter of type IfcPlateTypeEnum - may not be null.
	**/
	public IfcPlateType(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ApplicableOccurrence, SET<IfcPropertySetDefinition> HasPropertySets, LIST<IfcRepresentationMap> RepresentationMaps, IfcLabel Tag, IfcLabel ElementType, IfcPlateTypeEnum PredefinedType)
	{
	...
	/**
	 * This method initializes the IfcPlateType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcPlateTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcPlateType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCPLATETYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcPlateTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcPlateType ifcPlateType = new IfcPlateType();
		if(this.GlobalId != null)
			ifcPlateType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcPlateType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcPlateType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcPlateType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcPlateType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcPlateType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcPlateType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcPlateType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcPlateType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcPlateType.setPredefinedType((IfcPlateTypeEnum)this.PredefinedType.clone());
		return ifcPlateType;
	}
	...
	**/
	public Object shallowCopy()
	{
		IfcPlateType ifcPlateType = new IfcPlateType();
		if(this.GlobalId != null)
			ifcPlateType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcPlateType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcPlateType.setName(this.Name);
		if(this.Description != null)
			ifcPlateType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcPlateType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcPlateType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcPlateType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcPlateType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcPlateType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcPlateType.setPredefinedType(this.PredefinedType);
		return ifcPlateType;
	}
