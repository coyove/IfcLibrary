...
/**
 * This is a default implementation of the entity IfcFlowStorageDevice<br><br>
 *<br><br>
 ...
 */
public class IfcFlowStorageDevice extends IfcDistributionFlowElement implements ClassInterface
{
...
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,268435456,37475,44139};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	...
	{
		return IfcFlowStorageDevice.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCFLOWSTORAGEDEVICE(");
	...
	**/
	public Object clone()
	{
		IfcFlowStorageDevice ifcFlowStorageDevice = new IfcFlowStorageDevice();
		if(this.GlobalId != null)
			ifcFlowStorageDevice.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcFlowStorageDevice.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcFlowStorageDevice.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcFlowStorageDevice.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcFlowStorageDevice.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcFlowStorageDevice.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcFlowStorageDevice.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcFlowStorageDevice.setTag((IfcIdentifier)this.Tag.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcFlowStorageDevice ifcFlowStorageDevice = new IfcFlowStorageDevice();
		if(this.GlobalId != null)
			ifcFlowStorageDevice.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcFlowStorageDevice.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcFlowStorageDevice.setName(this.Name);
		if(this.Description != null)
			ifcFlowStorageDevice.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcFlowStorageDevice.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcFlowStorageDevice.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcFlowStorageDevice.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcFlowStorageDevice.setTag(this.Tag);
		return ifcFlowStorageDevice;
	}
