...
/**
 * This is a default implementation of the entity IfcAirTerminalType<br><br>
 *<br><br>
 ...
 */
public class IfcAirTerminalType extends IfcFlowTerminalType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcAirTerminalTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,10770};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	...
	/**
	* Constructs a new IfcAirTerminalType object using the given parameters.
	*
	...
	* @param PredefinedType DEMANDED parameter of type IfcAirTerminalTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcAirTerminalType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcAirTerminalTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcAirTerminalType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCAIRTERMINALTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcAirTerminalTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcAirTerminalType ifcAirTerminalType = new IfcAirTerminalType();
		if(this.GlobalId != null)
			ifcAirTerminalType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcAirTerminalType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcAirTerminalType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcAirTerminalType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcAirTerminalType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcAirTerminalType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcAirTerminalType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcAirTerminalType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcAirTerminalType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcAirTerminalType.setPredefinedType((IfcAirTerminalTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcAirTerminalType ifcAirTerminalType = new IfcAirTerminalType();
		if(this.GlobalId != null)
			ifcAirTerminalType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcAirTerminalType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcAirTerminalType.setName(this.Name);
		if(this.Description != null)
			ifcAirTerminalType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcAirTerminalType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcAirTerminalType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcAirTerminalType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcAirTerminalType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcAirTerminalType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcAirTerminalType.setPredefinedType(this.PredefinedType);
		return ifcAirTerminalType;
	}
