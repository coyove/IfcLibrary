...
/**
 * This is a default implementation of the enumeration type IfcMemberTypeEnum<br><br>
 *<br><br>
 ...
 */
public class IfcMemberTypeEnum extends ENUM implements TypeInterface
{
	/**
 ...
 * Constructs a new IfcMemberTypeEnum enumeration object using the given parameter.
	...
	* The value has to be of type IfcMemberTypeEnum_internal.
	...
	* The String must be one of: "BRACE", "CHORD", "COLLAR", "MEMBER", "MULLION", "PLATE", "POST", "PURLIN", "RAFTER", "STRINGER", "STRUT", "STUD", "USERDEFINED", "NOTDEFINED".
	*
	* @param value the value to set
	*/
	...
	**/
	...
	public static enum IfcMemberTypeEnum_internal
	{
		BRACE,
		CHORD,
		COLLAR,
	...
	**/
	...
	{
		if(isSelectType) return new String("IFCMEMBERTYPEENUM("+super.getStepParameter(false)+")");
