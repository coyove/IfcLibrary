...
/**
 * This is a default implementation of the entity IfcFlowInstrumentType<br><br>
 *<br><br>
 ...
 */
public class IfcFlowInstrumentType extends IfcDistributionControlElementType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcFlowInstrumentTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,34162};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	* @param PredefinedType DEMANDED parameter of type IfcFlowInstrumentTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcFlowInstrumentType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcFlowInstrumentTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcFlowInstrumentType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCFLOWINSTRUMENTTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcFlowInstrumentTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcFlowInstrumentType ifcFlowInstrumentType = new IfcFlowInstrumentType();
		if(this.GlobalId != null)
			ifcFlowInstrumentType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcFlowInstrumentType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcFlowInstrumentType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcFlowInstrumentType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcFlowInstrumentType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcFlowInstrumentType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcFlowInstrumentType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcFlowInstrumentType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcFlowInstrumentType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcFlowInstrumentType.setPredefinedType((IfcFlowInstrumentTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcFlowInstrumentType ifcFlowInstrumentType = new IfcFlowInstrumentType();
		if(this.GlobalId != null)
			ifcFlowInstrumentType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcFlowInstrumentType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcFlowInstrumentType.setName(this.Name);
		if(this.Description != null)
			ifcFlowInstrumentType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcFlowInstrumentType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcFlowInstrumentType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcFlowInstrumentType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcFlowInstrumentType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcFlowInstrumentType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcFlowInstrumentType.setPredefinedType(this.PredefinedType);
		return ifcFlowInstrumentType;
	}
