...
/**
 * This is a default implementation of the entity IfcAirTerminalBoxType<br><br>
 *<br><br>
 ...
 */
public class IfcAirTerminalBoxType extends IfcFlowControllerType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcAirTerminalBoxTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,34260};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	...
	/**
	* Constructs a new IfcAirTerminalBoxType object using the given parameters.
	*
	...
	* @param PredefinedType DEMANDED parameter of type IfcAirTerminalBoxTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcAirTerminalBoxType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcAirTerminalBoxTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcAirTerminalBoxType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCAIRTERMINALBOXTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcAirTerminalBoxTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcAirTerminalBoxType ifcAirTerminalBoxType = new IfcAirTerminalBoxType();
		if(this.GlobalId != null)
			ifcAirTerminalBoxType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcAirTerminalBoxType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcAirTerminalBoxType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcAirTerminalBoxType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcAirTerminalBoxType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcAirTerminalBoxType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcAirTerminalBoxType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcAirTerminalBoxType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcAirTerminalBoxType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcAirTerminalBoxType.setPredefinedType((IfcAirTerminalBoxTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcAirTerminalBoxType ifcAirTerminalBoxType = new IfcAirTerminalBoxType();
		if(this.GlobalId != null)
			ifcAirTerminalBoxType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcAirTerminalBoxType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcAirTerminalBoxType.setName(this.Name);
		if(this.Description != null)
			ifcAirTerminalBoxType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcAirTerminalBoxType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcAirTerminalBoxType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcAirTerminalBoxType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcAirTerminalBoxType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcAirTerminalBoxType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcAirTerminalBoxType.setPredefinedType(this.PredefinedType);
		return ifcAirTerminalBoxType;
	}
