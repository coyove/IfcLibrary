...
/**
 * This is a default implementation of the entity IfcExternallyDefinedHatchStyle<br><br>
 *<br><br>
 ...
 */
public class IfcExternallyDefinedHatchStyle extends IfcExternalReference implements IfcFillStyleSelect, ClassInterface
{
...
private static final int[] nonInverseHashAttributes = new int[]{3773,44139,3773};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	...
	{
		return IfcExternallyDefinedHatchStyle.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCEXTERNALLYDEFINEDHATCHSTYLE(");
	...
	**/
	public Object clone()
	{
		IfcExternallyDefinedHatchStyle ifcExternallyDefinedHatchStyle = new IfcExternallyDefinedHatchStyle();
		if(this.Location != null)
			ifcExternallyDefinedHatchStyle.setLocation((IfcLabel)this.Location.clone());
		if(this.ItemReference != null)
			ifcExternallyDefinedHatchStyle.setItemReference((IfcIdentifier)this.ItemReference.clone());
		if(this.Name != null)
			ifcExternallyDefinedHatchStyle.setName((IfcLabel)this.Name.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcExternallyDefinedHatchStyle ifcExternallyDefinedHatchStyle = new IfcExternallyDefinedHatchStyle();
		if(this.Location != null)
			ifcExternallyDefinedHatchStyle.setLocation(this.Location);
		if(this.ItemReference != null)
			ifcExternallyDefinedHatchStyle.setItemReference(this.ItemReference);
		if(this.Name != null)
			ifcExternallyDefinedHatchStyle.setName(this.Name);
		return ifcExternallyDefinedHatchStyle;
	}
