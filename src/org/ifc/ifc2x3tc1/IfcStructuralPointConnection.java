...
/**
 * This is a default implementation of the entity IfcStructuralPointConnection<br><br>
 *<br><br>
 ...
 */
public class IfcStructuralPointConnection extends IfcStructuralConnection implements ClassInterface
{
...
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,268435456,37475,268435456};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	public IfcStructuralPointConnection(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcBoundaryCondition AppliedCondition)
	{
	...
	**/
	...
	{
		return IfcStructuralPointConnection.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCSTRUCTURALPOINTCONNECTION(");
	...
	**/
	public Object clone()
	{
		IfcStructuralPointConnection ifcStructuralPointConnection = new IfcStructuralPointConnection();
		if(this.GlobalId != null)
			ifcStructuralPointConnection.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcStructuralPointConnection.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcStructuralPointConnection.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcStructuralPointConnection.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcStructuralPointConnection.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcStructuralPointConnection.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcStructuralPointConnection.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.AppliedCondition != null)
			ifcStructuralPointConnection.setAppliedCondition((IfcBoundaryCondition)this.AppliedCondition.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcStructuralPointConnection ifcStructuralPointConnection = new IfcStructuralPointConnection();
		if(this.GlobalId != null)
			ifcStructuralPointConnection.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcStructuralPointConnection.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcStructuralPointConnection.setName(this.Name);
		if(this.Description != null)
			ifcStructuralPointConnection.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcStructuralPointConnection.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcStructuralPointConnection.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcStructuralPointConnection.setRepresentation(this.Representation);
		if(this.AppliedCondition != null)
			ifcStructuralPointConnection.setAppliedCondition(this.AppliedCondition);
		return ifcStructuralPointConnection;
	}
