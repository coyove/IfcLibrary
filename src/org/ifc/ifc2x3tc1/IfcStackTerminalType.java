...
/**
 * This is a default implementation of the entity IfcStackTerminalType<br><br>
 *<br><br>
 ...
 */
public class IfcStackTerminalType extends IfcFlowTerminalType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcStackTerminalTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,21729};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	* @param PredefinedType DEMANDED parameter of type IfcStackTerminalTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcStackTerminalType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcStackTerminalTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcStackTerminalType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCSTACKTERMINALTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcStackTerminalTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcStackTerminalType ifcStackTerminalType = new IfcStackTerminalType();
		if(this.GlobalId != null)
			ifcStackTerminalType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcStackTerminalType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcStackTerminalType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcStackTerminalType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcStackTerminalType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcStackTerminalType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcStackTerminalType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcStackTerminalType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcStackTerminalType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcStackTerminalType.setPredefinedType((IfcStackTerminalTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcStackTerminalType ifcStackTerminalType = new IfcStackTerminalType();
		if(this.GlobalId != null)
			ifcStackTerminalType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcStackTerminalType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcStackTerminalType.setName(this.Name);
		if(this.Description != null)
			ifcStackTerminalType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcStackTerminalType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcStackTerminalType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcStackTerminalType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcStackTerminalType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcStackTerminalType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcStackTerminalType.setPredefinedType(this.PredefinedType);
		return ifcStackTerminalType;
	}
