...
/**
 * This is a default implementation of the entity IfcGasTerminalType<br><br>
 *<br><br>
 ...
 */
public class IfcGasTerminalType extends IfcFlowTerminalType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcGasTerminalTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,32736};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	private java.util.ArrayList<CloneableObject> stepParameter = null;
	private java.util.HashSet<ObjectChangeListener> listenerList = null;
	protected int stepLineNumber;
	/** PredefinedType is an DEMANDED attribute - may not be null**/
	protected IfcGasTerminalTypeEnum PredefinedType;
	/**
	...
	**/
	...
	/**
	 * This method initializes the IfcGasTerminalType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcGasTerminalTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcGasTerminalType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCGASTERMINALTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcGasTerminalTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcGasTerminalType ifcGasTerminalType = new IfcGasTerminalType();
		if(this.GlobalId != null)
			ifcGasTerminalType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcGasTerminalType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcGasTerminalType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcGasTerminalType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcGasTerminalType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcGasTerminalType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcGasTerminalType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcGasTerminalType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcGasTerminalType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcGasTerminalType.setPredefinedType((IfcGasTerminalTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcGasTerminalType ifcGasTerminalType = new IfcGasTerminalType();
		if(this.GlobalId != null)
			ifcGasTerminalType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcGasTerminalType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcGasTerminalType.setName(this.Name);
		if(this.Description != null)
			ifcGasTerminalType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcGasTerminalType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcGasTerminalType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcGasTerminalType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcGasTerminalType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcGasTerminalType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcGasTerminalType.setPredefinedType(this.PredefinedType);
		return ifcGasTerminalType;
	}
