...
/**
 * This is a default implementation of the entity IfcCondenserType<br><br>
 *<br><br>
 ...
 */
public class IfcCondenserType extends IfcEnergyConversionDeviceType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcCondenserTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,27875};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	* @param PredefinedType DEMANDED parameter of type IfcCondenserTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcCondenserType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcCondenserTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcCondenserType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCCONDENSERTYPE(");
	...
	**/
	...
	public Object clone()
	{
		IfcCondenserType ifcCondenserType = new IfcCondenserType();
		if(this.GlobalId != null)
			ifcCondenserType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcCondenserType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcCondenserType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcCondenserType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcCondenserType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcCondenserType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcCondenserType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcCondenserType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcCondenserType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcCondenserType.setPredefinedType((IfcCondenserTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcCondenserType ifcCondenserType = new IfcCondenserType();
		if(this.GlobalId != null)
			ifcCondenserType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcCondenserType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcCondenserType.setName(this.Name);
		if(this.Description != null)
			ifcCondenserType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcCondenserType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcCondenserType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcCondenserType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcCondenserType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcCondenserType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcCondenserType.setPredefinedType(this.PredefinedType);
		return ifcCondenserType;
	}
