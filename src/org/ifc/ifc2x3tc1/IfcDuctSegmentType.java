...
/**
 * This is a default implementation of the entity IfcDuctSegmentType<br><br>
 *<br><br>
 ...
 */
public class IfcDuctSegmentType extends IfcFlowSegmentType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcDuctSegmentTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,33702};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	...
	/**
	* Constructs a new IfcDuctSegmentType object using the given parameters.
	*
	...
	* @param PredefinedType DEMANDED parameter of type IfcDuctSegmentTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcDuctSegmentType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcDuctSegmentTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcDuctSegmentType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCDUCTSEGMENTTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcDuctSegmentTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcDuctSegmentType ifcDuctSegmentType = new IfcDuctSegmentType();
		if(this.GlobalId != null)
			ifcDuctSegmentType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcDuctSegmentType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcDuctSegmentType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcDuctSegmentType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcDuctSegmentType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcDuctSegmentType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcDuctSegmentType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcDuctSegmentType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcDuctSegmentType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcDuctSegmentType.setPredefinedType((IfcDuctSegmentTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcDuctSegmentType ifcDuctSegmentType = new IfcDuctSegmentType();
		if(this.GlobalId != null)
			ifcDuctSegmentType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcDuctSegmentType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcDuctSegmentType.setName(this.Name);
		if(this.Description != null)
			ifcDuctSegmentType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcDuctSegmentType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcDuctSegmentType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcDuctSegmentType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcDuctSegmentType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcDuctSegmentType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcDuctSegmentType.setPredefinedType(this.PredefinedType);
		return ifcDuctSegmentType;
	}
