...
/**
 * This is a default implementation of the entity IfcOpeningElement<br><br>
 *<br><br>
 ...
 */
public class IfcOpeningElement extends IfcFeatureElementSubtraction implements ClassInterface
{
	...
	protected SET<IfcRelFillsElement> HasFillings_Inverse;
	/**
	...
	**/
	...
	{
		return IfcOpeningElement.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCOPENINGELEMENT(");
	...
	**/
	...
	/**
	* This method returns a copy of the set of the HasFillings_Inverse attribute.
	*
	* @return a copy of the HasFillings_Inverse set
	**/
	public SET<IfcRelFillsElement> getHasFillings_Inverse()
	{
		if(this.HasFillings_Inverse != null)
			return new SET<IfcRelFillsElement>(this.HasFillings_Inverse);
		return null;
	}
	...
	**/
	public Object clone()
	{
		...
		if(this.GlobalId != null)
			ifcOpeningElement.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcOpeningElement.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcOpeningElement.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcOpeningElement.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcOpeningElement.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcOpeningElement.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcOpeningElement.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcOpeningElement.setTag((IfcIdentifier)this.Tag.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcOpeningElement ifcOpeningElement = new IfcOpeningElement();
		if(this.GlobalId != null)
			ifcOpeningElement.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcOpeningElement.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcOpeningElement.setName(this.Name);
		if(this.Description != null)
			ifcOpeningElement.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcOpeningElement.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcOpeningElement.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcOpeningElement.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcOpeningElement.setTag(this.Tag);
		return ifcOpeningElement;
	}
