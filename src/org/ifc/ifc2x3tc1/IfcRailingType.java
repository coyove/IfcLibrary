...
/**
 * This is a default implementation of the entity IfcRailingType<br><br>
 *<br><br>
 ...
 */
public class IfcRailingType extends IfcBuildingElementType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcRailingTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,11267};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	* @param PredefinedType DEMANDED parameter of type IfcRailingTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcRailingType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcRailingTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcRailingType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCRAILINGTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcRailingTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcRailingType ifcRailingType = new IfcRailingType();
		if(this.GlobalId != null)
			ifcRailingType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcRailingType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcRailingType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcRailingType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcRailingType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcRailingType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcRailingType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcRailingType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcRailingType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcRailingType.setPredefinedType((IfcRailingTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcRailingType ifcRailingType = new IfcRailingType();
		if(this.GlobalId != null)
			ifcRailingType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcRailingType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcRailingType.setName(this.Name);
		if(this.Description != null)
			ifcRailingType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcRailingType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcRailingType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcRailingType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcRailingType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcRailingType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcRailingType.setPredefinedType(this.PredefinedType);
		return ifcRailingType;
	}
