...
/**
 * This is a default implementation of the entity IfcLightSourceDirectional<br><br>
 *<br><br>
 ...
 */
public class IfcLightSourceDirectional extends IfcLightSource implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcLabel","IfcColourRgb","IfcNormalisedRatioMeasure","IfcNormalisedRatioMeasure","IfcDirection"};
private static final int[] nonInverseHashAttributes = new int[]{3773,5752,34149,34149,5701};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	...
	/**
	 * This method initializes the IfcLightSourceDirectional object using the given parameters.
	*
	* @param Name OPTIONAL parameter of type IfcLabel
	* @param LightColour DEMANDED parameter of type IfcColourRgb - may not be null.
	* @param AmbientIntensity OPTIONAL parameter of type IfcNormalisedRatioMeasure
	...
	* @param Orientation DEMANDED parameter of type IfcDirection - may not be null.
	**/
	public void setParameters(IfcLabel Name, IfcColourRgb LightColour, IfcNormalisedRatioMeasure AmbientIntensity, IfcNormalisedRatioMeasure Intensity, IfcDirection Orientation)
	{
		this.Name = Name;
		this.LightColour = LightColour;
		this.AmbientIntensity = AmbientIntensity;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.Orientation = (IfcDirection) parameters.get(4);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcLightSourceDirectional.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCLIGHTSOURCEDIRECTIONAL(");
	...
	**/
	public Object clone()
	{
		IfcLightSourceDirectional ifcLightSourceDirectional = new IfcLightSourceDirectional();
		if(this.Name != null)
			ifcLightSourceDirectional.setName((IfcLabel)this.Name.clone());
		if(this.LightColour != null)
			ifcLightSourceDirectional.setLightColour((IfcColourRgb)this.LightColour.clone());
		if(this.AmbientIntensity != null)
			ifcLightSourceDirectional.setAmbientIntensity((IfcNormalisedRatioMeasure)this.AmbientIntensity.clone());
		if(this.Intensity != null)
			ifcLightSourceDirectional.setIntensity((IfcNormalisedRatioMeasure)this.Intensity.clone());
		if(this.Orientation != null)
			ifcLightSourceDirectional.setOrientation((IfcDirection)this.Orientation.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcLightSourceDirectional ifcLightSourceDirectional = new IfcLightSourceDirectional();
		if(this.Name != null)
			ifcLightSourceDirectional.setName(this.Name);
		if(this.LightColour != null)
			ifcLightSourceDirectional.setLightColour(this.LightColour);
		if(this.AmbientIntensity != null)
			ifcLightSourceDirectional.setAmbientIntensity(this.AmbientIntensity);
		if(this.Intensity != null)
			ifcLightSourceDirectional.setIntensity(this.Intensity);
		if(this.Orientation != null)
			ifcLightSourceDirectional.setOrientation(this.Orientation);
		return ifcLightSourceDirectional;
	}
