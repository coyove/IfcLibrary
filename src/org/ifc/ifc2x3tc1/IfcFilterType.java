...
/**
 * This is a default implementation of the entity IfcFilterType<br><br>
 *<br><br>
 ...
 */
public class IfcFilterType extends IfcFlowTreatmentDeviceType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcFilterTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,44352};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	...
	/**
	* Constructs a new IfcFilterType object using the given parameters.
	*
	...
	* @param PredefinedType DEMANDED parameter of type IfcFilterTypeEnum - may not be null.
	**/
	public IfcFilterType(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ApplicableOccurrence, SET<IfcPropertySetDefinition> HasPropertySets, LIST<IfcRepresentationMap> RepresentationMaps, IfcLabel Tag, IfcLabel ElementType, IfcFilterTypeEnum PredefinedType)
	{
	...
	/**
	 * This method initializes the IfcFilterType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcFilterTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcFilterType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCFILTERTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcFilterTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcFilterType ifcFilterType = new IfcFilterType();
		if(this.GlobalId != null)
			ifcFilterType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcFilterType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcFilterType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcFilterType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcFilterType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcFilterType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcFilterType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcFilterType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcFilterType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcFilterType.setPredefinedType((IfcFilterTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcFilterType ifcFilterType = new IfcFilterType();
		if(this.GlobalId != null)
			ifcFilterType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcFilterType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcFilterType.setName(this.Name);
		if(this.Description != null)
			ifcFilterType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcFilterType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcFilterType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcFilterType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcFilterType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcFilterType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcFilterType.setPredefinedType(this.PredefinedType);
		return ifcFilterType;
	}
