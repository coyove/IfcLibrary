...
/**
 * This is a default implementation of the entity IfcWindow<br><br>
 *<br><br>
 ...
 */
public class IfcWindow extends IfcBuildingElement implements ClassInterface
{
...
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,268435456,37475,44139,35714,35714};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	public IfcWindow(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcPositiveLengthMeasure OverallHeight, IfcPositiveLengthMeasure OverallWidth)
	{
	...
	/**
	 * This method initializes the IfcWindow object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param OverallWidth OPTIONAL parameter of type IfcPositiveLengthMeasure
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcPositiveLengthMeasure OverallHeight, IfcPositiveLengthMeasure OverallWidth)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	...
	{
		return IfcWindow.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCWINDOW(");
	...
	**/
	public Object clone()
	{
		IfcWindow ifcWindow = new IfcWindow();
		if(this.GlobalId != null)
			ifcWindow.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcWindow.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcWindow.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcWindow.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcWindow.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcWindow.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcWindow.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcWindow.setTag((IfcIdentifier)this.Tag.clone());
		if(this.OverallHeight != null)
			ifcWindow.setOverallHeight((IfcPositiveLengthMeasure)this.OverallHeight.clone());
		if(this.OverallWidth != null)
			ifcWindow.setOverallWidth((IfcPositiveLengthMeasure)this.OverallWidth.clone());
		return ifcWindow;
	}
	...
	**/
	public Object shallowCopy()
	{
		IfcWindow ifcWindow = new IfcWindow();
		if(this.GlobalId != null)
			ifcWindow.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcWindow.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcWindow.setName(this.Name);
		if(this.Description != null)
			ifcWindow.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcWindow.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcWindow.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcWindow.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcWindow.setTag(this.Tag);
		if(this.OverallHeight != null)
			ifcWindow.setOverallHeight(this.OverallHeight);
		if(this.OverallWidth != null)
			ifcWindow.setOverallWidth(this.OverallWidth);
		return ifcWindow;
	}
