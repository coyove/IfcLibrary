...
/**
 * This is a default implementation of the entity IfcBuildingElementProxyType<br><br>
 *<br><br>
 ...
 */
public class IfcBuildingElementProxyType extends IfcBuildingElementType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcBuildingElementProxyTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,11694};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	* @param PredefinedType DEMANDED parameter of type IfcBuildingElementProxyTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcBuildingElementProxyType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcBuildingElementProxyTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcBuildingElementProxyType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCBUILDINGELEMENTPROXYTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcBuildingElementProxyTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcBuildingElementProxyType ifcBuildingElementProxyType = new IfcBuildingElementProxyType();
		if(this.GlobalId != null)
			ifcBuildingElementProxyType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcBuildingElementProxyType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcBuildingElementProxyType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcBuildingElementProxyType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcBuildingElementProxyType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcBuildingElementProxyType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcBuildingElementProxyType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcBuildingElementProxyType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcBuildingElementProxyType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcBuildingElementProxyType.setPredefinedType((IfcBuildingElementProxyTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcBuildingElementProxyType ifcBuildingElementProxyType = new IfcBuildingElementProxyType();
		if(this.GlobalId != null)
			ifcBuildingElementProxyType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcBuildingElementProxyType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcBuildingElementProxyType.setName(this.Name);
		if(this.Description != null)
			ifcBuildingElementProxyType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcBuildingElementProxyType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcBuildingElementProxyType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcBuildingElementProxyType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcBuildingElementProxyType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcBuildingElementProxyType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcBuildingElementProxyType.setPredefinedType(this.PredefinedType);
		return ifcBuildingElementProxyType;
	}
