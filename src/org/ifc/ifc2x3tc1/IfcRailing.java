...
/**
 * This is a default implementation of the entity IfcRailing<br><br>
 *<br><br>
 ...
 */
public class IfcRailing extends IfcBuildingElement implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcRailingTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,268435456,37475,44139,11267};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	* @param PredefinedType OPTIONAL parameter of type IfcRailingTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcRailing object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcRailingTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcRailingTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcRailingTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcRailing.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCRAILING(");
	...
	**/
	public Object clone()
	{
		IfcRailing ifcRailing = new IfcRailing();
		if(this.GlobalId != null)
			ifcRailing.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcRailing.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcRailing.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcRailing.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcRailing.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcRailing.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcRailing.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcRailing.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcRailing.setPredefinedType((IfcRailingTypeEnum)this.PredefinedType.clone());
		return ifcRailing;
	}
	...
	**/
	public Object shallowCopy()
	{
		IfcRailing ifcRailing = new IfcRailing();
		if(this.GlobalId != null)
			ifcRailing.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcRailing.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcRailing.setName(this.Name);
		if(this.Description != null)
			ifcRailing.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcRailing.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcRailing.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcRailing.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcRailing.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcRailing.setPredefinedType(this.PredefinedType);
		return ifcRailing;
	}
