...
/**
 * This is a default implementation of the entity IfcPath<br><br>
 *<br><br>
 ...
 */
public class IfcPath extends IfcTopologicalRepresentationItem implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"LIST<IfcOrientedEdge>"};
private static final int[] nonInverseHashAttributes = new int[]{-2147438871};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	...
	/**
	 * This method initializes the IfcPath object using the given parameters.
	*
	* @param EdgeList DEMANDED parameter of type LIST<IfcOrientedEdge> - may not be null.
	**/
	...
	**/
	...
	{
		return IfcPath.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCPATH(");
	...
	**/
	...
	public Object clone()
	{
		IfcPath ifcPath = new IfcPath();
		if(this.EdgeList != null)
			ifcPath.setEdgeList((LIST<IfcOrientedEdge>)this.EdgeList.clone());
		return ifcPath;
	}
	...
	**/
	public Object shallowCopy()
	{
		IfcPath ifcPath = new IfcPath();
		if(this.EdgeList != null)
			ifcPath.setEdgeList(this.EdgeList);
		return ifcPath;
	}
