...
/**
 * This is a default implementation of the entity IfcActuatorType<br><br>
 *<br><br>
 ...
 */
public class IfcActuatorType extends IfcDistributionControlElementType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcActuatorTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,50771};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	...
	/**
	* Constructs a new IfcActuatorType object using the given parameters.
	*
	...
	* @param PredefinedType DEMANDED parameter of type IfcActuatorTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcActuatorType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcActuatorTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcActuatorType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCACTUATORTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcActuatorTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcActuatorType ifcActuatorType = new IfcActuatorType();
		if(this.GlobalId != null)
			ifcActuatorType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcActuatorType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcActuatorType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcActuatorType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcActuatorType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcActuatorType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcActuatorType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcActuatorType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcActuatorType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcActuatorType.setPredefinedType((IfcActuatorTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcActuatorType ifcActuatorType = new IfcActuatorType();
		if(this.GlobalId != null)
			ifcActuatorType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcActuatorType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcActuatorType.setName(this.Name);
		if(this.Description != null)
			ifcActuatorType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcActuatorType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcActuatorType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcActuatorType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcActuatorType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcActuatorType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcActuatorType.setPredefinedType(this.PredefinedType);
		return ifcActuatorType;
	}
