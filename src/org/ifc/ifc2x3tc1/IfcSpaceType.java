...
/**
 * This is a default implementation of the entity IfcSpaceType<br><br>
 *<br><br>
 ...
 */
public class IfcSpaceType extends IfcSpatialStructureElementType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcSpaceTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,7908};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	* @param PredefinedType DEMANDED parameter of type IfcSpaceTypeEnum - may not be null.
	**/
	public IfcSpaceType(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ApplicableOccurrence, SET<IfcPropertySetDefinition> HasPropertySets, LIST<IfcRepresentationMap> RepresentationMaps, IfcLabel Tag, IfcLabel ElementType, IfcSpaceTypeEnum PredefinedType)
	{
	...
	/**
	 * This method initializes the IfcSpaceType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcSpaceTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcSpaceType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCSPACETYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcSpaceTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcSpaceType ifcSpaceType = new IfcSpaceType();
		if(this.GlobalId != null)
			ifcSpaceType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcSpaceType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcSpaceType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcSpaceType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcSpaceType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcSpaceType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcSpaceType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcSpaceType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcSpaceType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcSpaceType.setPredefinedType((IfcSpaceTypeEnum)this.PredefinedType.clone());
		return ifcSpaceType;
	}
	...
	**/
	public Object shallowCopy()
	{
		IfcSpaceType ifcSpaceType = new IfcSpaceType();
		if(this.GlobalId != null)
			ifcSpaceType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcSpaceType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcSpaceType.setName(this.Name);
		if(this.Description != null)
			ifcSpaceType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcSpaceType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcSpaceType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcSpaceType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcSpaceType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcSpaceType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcSpaceType.setPredefinedType(this.PredefinedType);
		return ifcSpaceType;
	}
