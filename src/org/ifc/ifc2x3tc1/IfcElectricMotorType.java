...
/**
 * This is a default implementation of the entity IfcElectricMotorType<br><br>
 *<br><br>
 ...
 */
public class IfcElectricMotorType extends IfcEnergyConversionDeviceType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcElectricMotorTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,25782};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	* @param PredefinedType DEMANDED parameter of type IfcElectricMotorTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcElectricMotorType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcElectricMotorTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcElectricMotorType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCELECTRICMOTORTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcElectricMotorTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcElectricMotorType ifcElectricMotorType = new IfcElectricMotorType();
		if(this.GlobalId != null)
			ifcElectricMotorType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcElectricMotorType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcElectricMotorType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcElectricMotorType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcElectricMotorType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcElectricMotorType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcElectricMotorType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcElectricMotorType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcElectricMotorType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcElectricMotorType.setPredefinedType((IfcElectricMotorTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcElectricMotorType ifcElectricMotorType = new IfcElectricMotorType();
		if(this.GlobalId != null)
			ifcElectricMotorType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcElectricMotorType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcElectricMotorType.setName(this.Name);
		if(this.Description != null)
			ifcElectricMotorType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcElectricMotorType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcElectricMotorType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcElectricMotorType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcElectricMotorType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcElectricMotorType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcElectricMotorType.setPredefinedType(this.PredefinedType);
		return ifcElectricMotorType;
	}
