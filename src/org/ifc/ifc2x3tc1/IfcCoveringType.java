...
/**
 * This is a default implementation of the entity IfcCoveringType<br><br>
 *<br><br>
 ...
 */
public class IfcCoveringType extends IfcBuildingElementType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcCoveringTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,36978};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	* @param PredefinedType DEMANDED parameter of type IfcCoveringTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcCoveringType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcCoveringTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcCoveringType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCCOVERINGTYPE(");
	...
	**/
	...
	public Object clone()
	{
		IfcCoveringType ifcCoveringType = new IfcCoveringType();
		if(this.GlobalId != null)
			ifcCoveringType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcCoveringType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcCoveringType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcCoveringType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcCoveringType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcCoveringType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcCoveringType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcCoveringType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcCoveringType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcCoveringType.setPredefinedType((IfcCoveringTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcCoveringType ifcCoveringType = new IfcCoveringType();
		if(this.GlobalId != null)
			ifcCoveringType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcCoveringType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcCoveringType.setName(this.Name);
		if(this.Description != null)
			ifcCoveringType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcCoveringType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcCoveringType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcCoveringType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcCoveringType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcCoveringType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcCoveringType.setPredefinedType(this.PredefinedType);
		return ifcCoveringType;
	}
