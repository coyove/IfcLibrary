...
/**
 * This is a default implementation of the entity IfcAlarmType<br><br>
 *<br><br>
 ...
 */
public class IfcAlarmType extends IfcDistributionControlElementType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcAlarmTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,7869};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	...
	/**
	* Constructs a new IfcAlarmType object using the given parameters.
	*
	...
	* @param PredefinedType DEMANDED parameter of type IfcAlarmTypeEnum - may not be null.
	**/
	public IfcAlarmType(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ApplicableOccurrence, SET<IfcPropertySetDefinition> HasPropertySets, LIST<IfcRepresentationMap> RepresentationMaps, IfcLabel Tag, IfcLabel ElementType, IfcAlarmTypeEnum PredefinedType)
	{
	...
	/**
	 * This method initializes the IfcAlarmType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcAlarmTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcAlarmType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCALARMTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcAlarmTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcAlarmType ifcAlarmType = new IfcAlarmType();
		if(this.GlobalId != null)
			ifcAlarmType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcAlarmType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcAlarmType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcAlarmType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcAlarmType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcAlarmType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcAlarmType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcAlarmType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcAlarmType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcAlarmType.setPredefinedType((IfcAlarmTypeEnum)this.PredefinedType.clone());
		return ifcAlarmType;
	}
	...
	**/
	public Object shallowCopy()
	{
		IfcAlarmType ifcAlarmType = new IfcAlarmType();
		if(this.GlobalId != null)
			ifcAlarmType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcAlarmType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcAlarmType.setName(this.Name);
		if(this.Description != null)
			ifcAlarmType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcAlarmType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcAlarmType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcAlarmType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcAlarmType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcAlarmType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcAlarmType.setPredefinedType(this.PredefinedType);
		return ifcAlarmType;
	}
