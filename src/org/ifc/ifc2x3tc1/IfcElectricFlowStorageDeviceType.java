...
/**
 * This is a default implementation of the entity IfcElectricFlowStorageDeviceType<br><br>
 *<br><br>
 ...
 */
public class IfcElectricFlowStorageDeviceType extends IfcFlowStorageDeviceType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcElectricFlowStorageDeviceTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,63796};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	...
	/**
	* Constructs a new IfcElectricFlowStorageDeviceType object using the given parameters.
	*
	...
	* @param PredefinedType DEMANDED parameter of type IfcElectricFlowStorageDeviceTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcElectricFlowStorageDeviceType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcElectricFlowStorageDeviceTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcElectricFlowStorageDeviceType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCELECTRICFLOWSTORAGEDEVICETYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcElectricFlowStorageDeviceTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcElectricFlowStorageDeviceType ifcElectricFlowStorageDeviceType = new IfcElectricFlowStorageDeviceType();
		if(this.GlobalId != null)
			ifcElectricFlowStorageDeviceType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcElectricFlowStorageDeviceType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcElectricFlowStorageDeviceType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcElectricFlowStorageDeviceType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcElectricFlowStorageDeviceType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcElectricFlowStorageDeviceType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcElectricFlowStorageDeviceType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcElectricFlowStorageDeviceType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcElectricFlowStorageDeviceType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcElectricFlowStorageDeviceType.setPredefinedType((IfcElectricFlowStorageDeviceTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcElectricFlowStorageDeviceType ifcElectricFlowStorageDeviceType = new IfcElectricFlowStorageDeviceType();
		if(this.GlobalId != null)
			ifcElectricFlowStorageDeviceType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcElectricFlowStorageDeviceType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcElectricFlowStorageDeviceType.setName(this.Name);
		if(this.Description != null)
			ifcElectricFlowStorageDeviceType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcElectricFlowStorageDeviceType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcElectricFlowStorageDeviceType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcElectricFlowStorageDeviceType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcElectricFlowStorageDeviceType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcElectricFlowStorageDeviceType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcElectricFlowStorageDeviceType.setPredefinedType(this.PredefinedType);
		return ifcElectricFlowStorageDeviceType;
	}
