...
/**
 * This is a default implementation of the entity IfcJunctionBoxType<br><br>
 *<br><br>
 ...
 */
public class IfcJunctionBoxType extends IfcFlowFittingType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcJunctionBoxTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,8876};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	* @param PredefinedType DEMANDED parameter of type IfcJunctionBoxTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcJunctionBoxType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcJunctionBoxTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcJunctionBoxType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCJUNCTIONBOXTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcJunctionBoxTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcJunctionBoxType ifcJunctionBoxType = new IfcJunctionBoxType();
		if(this.GlobalId != null)
			ifcJunctionBoxType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcJunctionBoxType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcJunctionBoxType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcJunctionBoxType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcJunctionBoxType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcJunctionBoxType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcJunctionBoxType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcJunctionBoxType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcJunctionBoxType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcJunctionBoxType.setPredefinedType((IfcJunctionBoxTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcJunctionBoxType ifcJunctionBoxType = new IfcJunctionBoxType();
		if(this.GlobalId != null)
			ifcJunctionBoxType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcJunctionBoxType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcJunctionBoxType.setName(this.Name);
		if(this.Description != null)
			ifcJunctionBoxType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcJunctionBoxType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcJunctionBoxType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcJunctionBoxType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcJunctionBoxType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcJunctionBoxType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcJunctionBoxType.setPredefinedType(this.PredefinedType);
		return ifcJunctionBoxType;
	}
