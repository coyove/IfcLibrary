...
/**
 * This is a default implementation of the entity IfcStairFlightType<br><br>
 *<br><br>
 ...
 */
public class IfcStairFlightType extends IfcBuildingElementType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcStairFlightTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,20633};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	* @param PredefinedType DEMANDED parameter of type IfcStairFlightTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcStairFlightType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcStairFlightTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcStairFlightType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCSTAIRFLIGHTTYPE(");
	...
	**/
	...
	public Object clone()
	{
		IfcStairFlightType ifcStairFlightType = new IfcStairFlightType();
		if(this.GlobalId != null)
			ifcStairFlightType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcStairFlightType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcStairFlightType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcStairFlightType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcStairFlightType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcStairFlightType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcStairFlightType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcStairFlightType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcStairFlightType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcStairFlightType.setPredefinedType((IfcStairFlightTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcStairFlightType ifcStairFlightType = new IfcStairFlightType();
		if(this.GlobalId != null)
			ifcStairFlightType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcStairFlightType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcStairFlightType.setName(this.Name);
		if(this.Description != null)
			ifcStairFlightType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcStairFlightType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcStairFlightType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcStairFlightType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcStairFlightType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcStairFlightType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcStairFlightType.setPredefinedType(this.PredefinedType);
		return ifcStairFlightType;
	}
