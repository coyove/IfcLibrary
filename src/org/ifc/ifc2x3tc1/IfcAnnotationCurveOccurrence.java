...
/**
 * This is a default implementation of the entity IfcAnnotationCurveOccurrence<br><br>
 *<br><br>
 ...
 */
public class IfcAnnotationCurveOccurrence extends IfcAnnotationOccurrence implements IfcDraughtingCalloutElement, ClassInterface
{
...
private static final int[] nonInverseHashAttributes = new int[]{268435456,1073758784,3773};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	...
	{
		return IfcAnnotationCurveOccurrence.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	...
	public Object clone()
	{
		...
		if(this.Item != null)
			ifcAnnotationCurveOccurrence.setItem((IfcRepresentationItem)this.Item.clone());
		if(this.Styles != null)
			ifcAnnotationCurveOccurrence.setStyles((SET<IfcPresentationStyleAssignment>)this.Styles.clone());
		if(this.Name != null)
			ifcAnnotationCurveOccurrence.setName((IfcLabel)this.Name.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcAnnotationCurveOccurrence ifcAnnotationCurveOccurrence = new IfcAnnotationCurveOccurrence();
		if(this.Item != null)
			ifcAnnotationCurveOccurrence.setItem(this.Item);
		if(this.Styles != null)
			ifcAnnotationCurveOccurrence.setStyles(this.Styles);
		if(this.Name != null)
			ifcAnnotationCurveOccurrence.setName(this.Name);
		return ifcAnnotationCurveOccurrence;
	}
