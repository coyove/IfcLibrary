...
/**
 * This is a default implementation of the entity IfcSanitaryTerminalType<br><br>
 *<br><br>
 ...
 */
public class IfcSanitaryTerminalType extends IfcFlowTerminalType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcSanitaryTerminalTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,39127};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	* @param PredefinedType DEMANDED parameter of type IfcSanitaryTerminalTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcSanitaryTerminalType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcSanitaryTerminalTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcSanitaryTerminalType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCSANITARYTERMINALTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcSanitaryTerminalTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcSanitaryTerminalType ifcSanitaryTerminalType = new IfcSanitaryTerminalType();
		if(this.GlobalId != null)
			ifcSanitaryTerminalType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcSanitaryTerminalType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcSanitaryTerminalType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcSanitaryTerminalType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcSanitaryTerminalType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcSanitaryTerminalType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcSanitaryTerminalType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcSanitaryTerminalType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcSanitaryTerminalType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcSanitaryTerminalType.setPredefinedType((IfcSanitaryTerminalTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcSanitaryTerminalType ifcSanitaryTerminalType = new IfcSanitaryTerminalType();
		if(this.GlobalId != null)
			ifcSanitaryTerminalType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcSanitaryTerminalType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcSanitaryTerminalType.setName(this.Name);
		if(this.Description != null)
			ifcSanitaryTerminalType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcSanitaryTerminalType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcSanitaryTerminalType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcSanitaryTerminalType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcSanitaryTerminalType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcSanitaryTerminalType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcSanitaryTerminalType.setPredefinedType(this.PredefinedType);
		return ifcSanitaryTerminalType;
	}
