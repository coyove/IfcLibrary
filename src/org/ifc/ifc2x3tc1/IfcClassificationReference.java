...
public class IfcClassificationReference extends IfcExternalReference implements ClassInterface, IfcClassificationNotationSelect
{
	...
	* @param ReferencedSource OPTIONAL parameter of type IfcClassification
	**/
	public IfcClassificationReference(IfcLabel Location, IfcIdentifier ItemReference, IfcLabel Name, IfcClassification ReferencedSource)
	{
	...
	* @param ReferencedSource OPTIONAL parameter of type IfcClassification
	**/
	public void setParameters(IfcLabel Location, IfcIdentifier ItemReference, IfcLabel Name, IfcClassification ReferencedSource)
	{
		this.Location = Location;
		this.ItemReference = ItemReference;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.ReferencedSource = (IfcClassification) parameters.get(3);
		resolveInverses();
	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		if(this.ReferencedSource != null)		stepString = stepString.concat(((RootInterface)this.ReferencedSource).getStepParameter(IfcClassification.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	public Object clone()
	{
		...
		if(this.Location != null)
			ifcClassificationReference.setLocation((IfcLabel)this.Location.clone());
		if(this.ItemReference != null)
			ifcClassificationReference.setItemReference((IfcIdentifier)this.ItemReference.clone());
		if(this.Name != null)
			ifcClassificationReference.setName((IfcLabel)this.Name.clone());
		if(this.ReferencedSource != null)
			ifcClassificationReference.setReferencedSource((IfcClassification)this.ReferencedSource.clone());
	...
	**/
	public Object shallowCopy()
	{
		...
		if(this.ItemReference != null)
			ifcClassificationReference.setItemReference(this.ItemReference);
		if(this.Name != null)
