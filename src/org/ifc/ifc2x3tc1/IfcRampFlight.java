...
/**
 * This is a default implementation of the entity IfcRampFlight<br><br>
 *<br><br>
 ...
 */
public class IfcRampFlight extends IfcBuildingElement implements ClassInterface
{
	...
	**/
	...
	/**
	* Constructs a new IfcRampFlight object using the given parameters.
	*
	...
	**/
	public IfcRampFlight(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag)
	{
	...
	**/
	...
	{
		return IfcRampFlight.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCRAMPFLIGHT(");
	...
	**/
	public Object clone()
	{
		IfcRampFlight ifcRampFlight = new IfcRampFlight();
		if(this.GlobalId != null)
			ifcRampFlight.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcRampFlight.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcRampFlight.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcRampFlight.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcRampFlight.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcRampFlight.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcRampFlight.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcRampFlight.setTag((IfcIdentifier)this.Tag.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcRampFlight ifcRampFlight = new IfcRampFlight();
		if(this.GlobalId != null)
			ifcRampFlight.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcRampFlight.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcRampFlight.setName(this.Name);
		if(this.Description != null)
			ifcRampFlight.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcRampFlight.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcRampFlight.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcRampFlight.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcRampFlight.setTag(this.Tag);
		return ifcRampFlight;
	}
