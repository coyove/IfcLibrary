...
/**
 * This is a default implementation of the entity IfcMotorConnectionType<br><br>
 *<br><br>
 ...
 */
public class IfcMotorConnectionType extends IfcEnergyConversionDeviceType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcMotorConnectionTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,13233};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	* @param PredefinedType DEMANDED parameter of type IfcMotorConnectionTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcMotorConnectionType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcMotorConnectionTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcMotorConnectionType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCMOTORCONNECTIONTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcMotorConnectionTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcMotorConnectionType ifcMotorConnectionType = new IfcMotorConnectionType();
		if(this.GlobalId != null)
			ifcMotorConnectionType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcMotorConnectionType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcMotorConnectionType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcMotorConnectionType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcMotorConnectionType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcMotorConnectionType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcMotorConnectionType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcMotorConnectionType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcMotorConnectionType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcMotorConnectionType.setPredefinedType((IfcMotorConnectionTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcMotorConnectionType ifcMotorConnectionType = new IfcMotorConnectionType();
		if(this.GlobalId != null)
			ifcMotorConnectionType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcMotorConnectionType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcMotorConnectionType.setName(this.Name);
		if(this.Description != null)
			ifcMotorConnectionType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcMotorConnectionType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcMotorConnectionType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcMotorConnectionType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcMotorConnectionType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcMotorConnectionType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcMotorConnectionType.setPredefinedType(this.PredefinedType);
		return ifcMotorConnectionType;
	}
