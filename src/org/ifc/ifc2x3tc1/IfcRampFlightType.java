...
/**
 * This is a default implementation of the entity IfcRampFlightType<br><br>
 *<br><br>
 ...
 */
public class IfcRampFlightType extends IfcBuildingElementType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcRampFlightTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,40186};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	* @param PredefinedType DEMANDED parameter of type IfcRampFlightTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcRampFlightType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcRampFlightTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcRampFlightType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCRAMPFLIGHTTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcRampFlightTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcRampFlightType ifcRampFlightType = new IfcRampFlightType();
		if(this.GlobalId != null)
			ifcRampFlightType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcRampFlightType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcRampFlightType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcRampFlightType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcRampFlightType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcRampFlightType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcRampFlightType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcRampFlightType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcRampFlightType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcRampFlightType.setPredefinedType((IfcRampFlightTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcRampFlightType ifcRampFlightType = new IfcRampFlightType();
		if(this.GlobalId != null)
			ifcRampFlightType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcRampFlightType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcRampFlightType.setName(this.Name);
		if(this.Description != null)
			ifcRampFlightType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcRampFlightType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcRampFlightType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcRampFlightType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcRampFlightType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcRampFlightType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcRampFlightType.setPredefinedType(this.PredefinedType);
		return ifcRampFlightType;
	}
