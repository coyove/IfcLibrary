...
/**
 * This is a default implementation of the entity IfcDistributionChamberElementType<br><br>
 *<br><br>
 ...
 */
public class IfcDistributionChamberElementType extends IfcDistributionFlowElementType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcDistributionChamberElementTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,10675};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	...
	/**
	* Constructs a new IfcDistributionChamberElementType object using the given parameters.
	*
	...
	* @param PredefinedType DEMANDED parameter of type IfcDistributionChamberElementTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcDistributionChamberElementType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcDistributionChamberElementTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcDistributionChamberElementType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCDISTRIBUTIONCHAMBERELEMENTTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcDistributionChamberElementTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcDistributionChamberElementType ifcDistributionChamberElementType = new IfcDistributionChamberElementType();
		if(this.GlobalId != null)
			ifcDistributionChamberElementType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcDistributionChamberElementType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcDistributionChamberElementType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcDistributionChamberElementType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcDistributionChamberElementType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcDistributionChamberElementType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcDistributionChamberElementType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcDistributionChamberElementType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcDistributionChamberElementType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcDistributionChamberElementType.setPredefinedType((IfcDistributionChamberElementTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcDistributionChamberElementType ifcDistributionChamberElementType = new IfcDistributionChamberElementType();
		if(this.GlobalId != null)
			ifcDistributionChamberElementType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcDistributionChamberElementType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcDistributionChamberElementType.setName(this.Name);
		if(this.Description != null)
			ifcDistributionChamberElementType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcDistributionChamberElementType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcDistributionChamberElementType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcDistributionChamberElementType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcDistributionChamberElementType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcDistributionChamberElementType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcDistributionChamberElementType.setPredefinedType(this.PredefinedType);
		return ifcDistributionChamberElementType;
	}
