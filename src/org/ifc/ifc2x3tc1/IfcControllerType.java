...
/**
 * This is a default implementation of the entity IfcControllerType<br><br>
 *<br><br>
 ...
 */
public class IfcControllerType extends IfcDistributionControlElementType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcControllerTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,40429};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	* @param PredefinedType DEMANDED parameter of type IfcControllerTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcControllerType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcControllerTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcControllerType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCCONTROLLERTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcControllerTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcControllerType ifcControllerType = new IfcControllerType();
		if(this.GlobalId != null)
			ifcControllerType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcControllerType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcControllerType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcControllerType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcControllerType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcControllerType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcControllerType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcControllerType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcControllerType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcControllerType.setPredefinedType((IfcControllerTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcControllerType ifcControllerType = new IfcControllerType();
		if(this.GlobalId != null)
			ifcControllerType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcControllerType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcControllerType.setName(this.Name);
		if(this.Description != null)
			ifcControllerType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcControllerType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcControllerType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcControllerType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcControllerType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcControllerType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcControllerType.setPredefinedType(this.PredefinedType);
		return ifcControllerType;
	}
