...
/**
 * This is a default implementation of the entity IfcOutletType<br><br>
 *<br><br>
 ...
 */
public class IfcOutletType extends IfcFlowTerminalType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcOutletTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,44436};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	* @param PredefinedType DEMANDED parameter of type IfcOutletTypeEnum - may not be null.
	**/
	public IfcOutletType(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ApplicableOccurrence, SET<IfcPropertySetDefinition> HasPropertySets, LIST<IfcRepresentationMap> RepresentationMaps, IfcLabel Tag, IfcLabel ElementType, IfcOutletTypeEnum PredefinedType)
	{
	...
	/**
	 * This method initializes the IfcOutletType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcOutletTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcOutletType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCOUTLETTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcOutletTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcOutletType ifcOutletType = new IfcOutletType();
		if(this.GlobalId != null)
			ifcOutletType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcOutletType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcOutletType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcOutletType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcOutletType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcOutletType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcOutletType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcOutletType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcOutletType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcOutletType.setPredefinedType((IfcOutletTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcOutletType ifcOutletType = new IfcOutletType();
		if(this.GlobalId != null)
			ifcOutletType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcOutletType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcOutletType.setName(this.Name);
		if(this.Description != null)
			ifcOutletType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcOutletType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcOutletType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcOutletType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcOutletType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcOutletType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcOutletType.setPredefinedType(this.PredefinedType);
		return ifcOutletType;
	}
