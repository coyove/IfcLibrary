...
/**
 * This is a default implementation of the entity IfcOffsetCurve2D<br><br>
 *<br><br>
...
private static final int[] nonInverseHashAttributes = new int[]{268435456,30921,47284};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	...
	/**
	 * This method initializes the IfcOffsetCurve2D object using the given parameters.
	*
	* @param BasisCurve DEMANDED parameter of type IfcCurve - may not be null.
	* @param Distance DEMANDED parameter of type IfcLengthMeasure - may not be null.
	* @param SelfIntersect DEMANDED parameter of type LOGICAL - may not be null.
	**/
	public void setParameters(IfcCurve BasisCurve, IfcLengthMeasure Distance, LOGICAL SelfIntersect)
	{
		this.BasisCurve = BasisCurve;
		this.Distance = Distance;
		this.SelfIntersect = SelfIntersect;
	...
	**/
	...
	{
		return IfcOffsetCurve2D.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCOFFSETCURVE2D(");
	...
	**/
	public Object clone()
	{
		IfcOffsetCurve2D ifcOffsetCurve2D = new IfcOffsetCurve2D();
		if(this.BasisCurve != null)
			ifcOffsetCurve2D.setBasisCurve((IfcCurve)this.BasisCurve.clone());
		if(this.Distance != null)
			ifcOffsetCurve2D.setDistance((IfcLengthMeasure)this.Distance.clone());
		if(this.SelfIntersect != null)
			ifcOffsetCurve2D.setSelfIntersect((LOGICAL)this.SelfIntersect.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcOffsetCurve2D ifcOffsetCurve2D = new IfcOffsetCurve2D();
		if(this.BasisCurve != null)
			ifcOffsetCurve2D.setBasisCurve(this.BasisCurve);
		if(this.Distance != null)
			ifcOffsetCurve2D.setDistance(this.Distance);
		if(this.SelfIntersect != null)
			ifcOffsetCurve2D.setSelfIntersect(this.SelfIntersect);
		return ifcOffsetCurve2D;
	}
