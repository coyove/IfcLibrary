...
/**
 * This is a default implementation of the entity IfcFlowSegment<br><br>
 *<br><br>
 ...
 */
public class IfcFlowSegment extends IfcDistributionFlowElement implements ClassInterface
{
	...
	**/
	...
	{
		return IfcFlowSegment.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCFLOWSEGMENT(");
	...
	**/
	public Object clone()
	{
		IfcFlowSegment ifcFlowSegment = new IfcFlowSegment();
		if(this.GlobalId != null)
			ifcFlowSegment.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcFlowSegment.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcFlowSegment.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcFlowSegment.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcFlowSegment.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcFlowSegment.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcFlowSegment.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcFlowSegment.setTag((IfcIdentifier)this.Tag.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcFlowSegment ifcFlowSegment = new IfcFlowSegment();
		if(this.GlobalId != null)
			ifcFlowSegment.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcFlowSegment.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcFlowSegment.setName(this.Name);
		if(this.Description != null)
			ifcFlowSegment.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcFlowSegment.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcFlowSegment.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcFlowSegment.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcFlowSegment.setTag(this.Tag);
		return ifcFlowSegment;
	}
