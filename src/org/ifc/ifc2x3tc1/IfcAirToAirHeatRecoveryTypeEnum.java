...
/**
 * This is a default implementation of the enumeration type IfcAirToAirHeatRecoveryTypeEnum<br><br>
 *<br><br>
 ...
 */
public class IfcAirToAirHeatRecoveryTypeEnum extends ENUM implements TypeInterface
{
	/**
 ...
 * Constructs a new IfcAirToAirHeatRecoveryTypeEnum enumeration object using the given parameter.
	...
	* The value has to be of type IfcAirToAirHeatRecoveryTypeEnum_internal.
	...
	* The String must be one of: "FIXEDPLATECOUNTERFLOWEXCHANGER", "FIXEDPLATECROSSFLOWEXCHANGER", "FIXEDPLATEPARALLELFLOWEXCHANGER", "ROTARYWHEEL", "RUNAROUNDCOILLOOP", "HEATPIPE", "TWINTOWERENTHALPYRECOVERYLOOPS", "THERMOSIPHONSEALEDTUBEHEATEXCHANGERS", "THERMOSIPHONCOILTYPEHEATEXCHANGERS", "USERDEFINED", "NOTDEFINED".
	*
	* @param value the value to set
	*/
	...
	**/
	...
	public static enum IfcAirToAirHeatRecoveryTypeEnum_internal
	{
	...
	**/
	...
	{
		if(isSelectType) return new String("IFCAIRTOAIRHEATRECOVERYTYPEENUM("+super.getStepParameter(false)+")");
