...
/**
 * This is a default implementation of the entity IfcProtectiveDeviceType<br><br>
 *<br><br>
 ...
 */
public class IfcProtectiveDeviceType extends IfcFlowControllerType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcProtectiveDeviceTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,51102};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	* @param PredefinedType DEMANDED parameter of type IfcProtectiveDeviceTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcProtectiveDeviceType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcProtectiveDeviceTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcProtectiveDeviceType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCPROTECTIVEDEVICETYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcProtectiveDeviceTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcProtectiveDeviceType ifcProtectiveDeviceType = new IfcProtectiveDeviceType();
		if(this.GlobalId != null)
			ifcProtectiveDeviceType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcProtectiveDeviceType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcProtectiveDeviceType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcProtectiveDeviceType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcProtectiveDeviceType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcProtectiveDeviceType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcProtectiveDeviceType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcProtectiveDeviceType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcProtectiveDeviceType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcProtectiveDeviceType.setPredefinedType((IfcProtectiveDeviceTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcProtectiveDeviceType ifcProtectiveDeviceType = new IfcProtectiveDeviceType();
		if(this.GlobalId != null)
			ifcProtectiveDeviceType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcProtectiveDeviceType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcProtectiveDeviceType.setName(this.Name);
		if(this.Description != null)
			ifcProtectiveDeviceType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcProtectiveDeviceType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcProtectiveDeviceType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcProtectiveDeviceType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcProtectiveDeviceType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcProtectiveDeviceType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcProtectiveDeviceType.setPredefinedType(this.PredefinedType);
		return ifcProtectiveDeviceType;
	}
