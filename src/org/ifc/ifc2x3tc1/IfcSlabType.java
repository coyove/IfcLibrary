...
/**
 * This is a default implementation of the entity IfcSlabType<br><br>
 *<br><br>
 ...
 */
public class IfcSlabType extends IfcBuildingElementType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcSlabTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,43278};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	* @param PredefinedType DEMANDED parameter of type IfcSlabTypeEnum - may not be null.
	**/
	public IfcSlabType(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ApplicableOccurrence, SET<IfcPropertySetDefinition> HasPropertySets, LIST<IfcRepresentationMap> RepresentationMaps, IfcLabel Tag, IfcLabel ElementType, IfcSlabTypeEnum PredefinedType)
	{
	...
	/**
	 * This method initializes the IfcSlabType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcSlabTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcSlabType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCSLABTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcSlabTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcSlabType ifcSlabType = new IfcSlabType();
		if(this.GlobalId != null)
			ifcSlabType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcSlabType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcSlabType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcSlabType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcSlabType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcSlabType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcSlabType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcSlabType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcSlabType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcSlabType.setPredefinedType((IfcSlabTypeEnum)this.PredefinedType.clone());
		return ifcSlabType;
	}
	...
	**/
	public Object shallowCopy()
	{
		IfcSlabType ifcSlabType = new IfcSlabType();
		if(this.GlobalId != null)
			ifcSlabType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcSlabType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcSlabType.setName(this.Name);
		if(this.Description != null)
			ifcSlabType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcSlabType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcSlabType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcSlabType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcSlabType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcSlabType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcSlabType.setPredefinedType(this.PredefinedType);
		return ifcSlabType;
	}
