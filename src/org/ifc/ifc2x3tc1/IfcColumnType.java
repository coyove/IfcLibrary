...
/**
 * This is a default implementation of the entity IfcColumnType<br><br>
 *<br><br>
 ...
 */
public class IfcColumnType extends IfcBuildingElementType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcColumnTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,38180};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	...
	/**
	* Constructs a new IfcColumnType object using the given parameters.
	*
	...
	* @param PredefinedType DEMANDED parameter of type IfcColumnTypeEnum - may not be null.
	**/
	public IfcColumnType(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ApplicableOccurrence, SET<IfcPropertySetDefinition> HasPropertySets, LIST<IfcRepresentationMap> RepresentationMaps, IfcLabel Tag, IfcLabel ElementType, IfcColumnTypeEnum PredefinedType)
	{
	...
	/**
	 * This method initializes the IfcColumnType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcColumnTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcColumnType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCCOLUMNTYPE(");
	...
	**/
	...
	public Object clone()
	{
		IfcColumnType ifcColumnType = new IfcColumnType();
		if(this.GlobalId != null)
			ifcColumnType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcColumnType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcColumnType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcColumnType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcColumnType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcColumnType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcColumnType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcColumnType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcColumnType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcColumnType.setPredefinedType((IfcColumnTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcColumnType ifcColumnType = new IfcColumnType();
		if(this.GlobalId != null)
			ifcColumnType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcColumnType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcColumnType.setName(this.Name);
		if(this.Description != null)
			ifcColumnType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcColumnType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcColumnType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcColumnType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcColumnType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcColumnType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcColumnType.setPredefinedType(this.PredefinedType);
		return ifcColumnType;
	}
