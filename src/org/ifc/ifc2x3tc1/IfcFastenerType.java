...
/**
 * This is a default implementation of the entity IfcFastenerType<br><br>
 *<br><br>
 ...
 */
public class IfcFastenerType extends IfcElementComponentType implements ClassInterface
{
...
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	public IfcFastenerType(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ApplicableOccurrence, SET<IfcPropertySetDefinition> HasPropertySets, LIST<IfcRepresentationMap> RepresentationMaps, IfcLabel Tag, IfcLabel ElementType)
	{
	...
	**/
	...
	{
		return IfcFastenerType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCFASTENERTYPE(");
	...
	**/
	...
	public Object clone()
	{
		IfcFastenerType ifcFastenerType = new IfcFastenerType();
		if(this.GlobalId != null)
			ifcFastenerType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcFastenerType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcFastenerType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcFastenerType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcFastenerType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcFastenerType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcFastenerType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcFastenerType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcFastenerType.setElementType((IfcLabel)this.ElementType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcFastenerType ifcFastenerType = new IfcFastenerType();
		if(this.GlobalId != null)
			ifcFastenerType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcFastenerType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcFastenerType.setName(this.Name);
		if(this.Description != null)
			ifcFastenerType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcFastenerType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcFastenerType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcFastenerType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcFastenerType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcFastenerType.setElementType(this.ElementType);
		return ifcFastenerType;
	}
