...
/**
 * This is a default implementation of the entity IfcEdgeFeature<br><br>
 *<br><br>
 ...
 */
public abstract class IfcEdgeFeature extends IfcFeatureElementSubtraction implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcPositiveLengthMeasure"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,268435456,37475,44139,35714};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	private java.util.ArrayList<CloneableObject> stepParameter = null;
	private java.util.HashSet<ObjectChangeListener> listenerList = null;
	protected int stepLineNumber;
	/** FeatureLength is an OPTIONAL attribute**/
	protected IfcPositiveLengthMeasure FeatureLength;
	/**
	...
	**/
	public IfcEdgeFeature(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcPositiveLengthMeasure FeatureLength)
	{
	...
	/**
	 * This method initializes the IfcEdgeFeature object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param FeatureLength OPTIONAL parameter of type IfcPositiveLengthMeasure
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcPositiveLengthMeasure FeatureLength)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	...
	{
		return IfcEdgeFeature.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCEDGEFEATURE(");
	...
	**/
	...
	/**
	* This method sets the FeatureLength attribute to the given value.
	*
	* @param FeatureLength DEMANDED value to set - may not be null
	**/
	...
	/**
	* This method returns the value of the FeatureLength attribute.
	*
	* @return the value of FeatureLength
	/**/
