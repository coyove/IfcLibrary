...
/**
 * This is a default implementation of the entity IfcSphere<br><br>
 *<br><br>
 ...
 */
public class IfcSphere extends IfcCsgPrimitive3D implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcAxis2Placement3D","IfcPositiveLengthMeasure"};
private static final int[] nonInverseHashAttributes = new int[]{46787,35714};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	...
	/**
	 * This method initializes the IfcSphere object using the given parameters.
	*
	* @param Position DEMANDED parameter of type IfcAxis2Placement3D - may not be null.
	* @param Radius DEMANDED parameter of type IfcPositiveLengthMeasure - may not be null.
	**/
	public void setParameters(IfcAxis2Placement3D Position, IfcPositiveLengthMeasure Radius)
	{
		this.Position = Position;
		this.Radius = Radius;
		resolveInverses();
	...
	**/
	...
	{
		return IfcSphere.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCSPHERE(");
	...
	**/
	public Object clone()
	{
		IfcSphere ifcSphere = new IfcSphere();
		if(this.Position != null)
			ifcSphere.setPosition((IfcAxis2Placement3D)this.Position.clone());
		if(this.Radius != null)
			ifcSphere.setRadius((IfcPositiveLengthMeasure)this.Radius.clone());
		return ifcSphere;
	}
	...
	**/
	public Object shallowCopy()
	{
		IfcSphere ifcSphere = new IfcSphere();
		if(this.Position != null)
			ifcSphere.setPosition(this.Position);
		if(this.Radius != null)
			ifcSphere.setRadius(this.Radius);
		return ifcSphere;
	}
