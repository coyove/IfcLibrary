...
/**
 * This is a default implementation of the entity IfcDuctSilencerType<br><br>
 *<br><br>
 ...
 */
public class IfcDuctSilencerType extends IfcFlowTreatmentDeviceType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcDuctSilencerTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,55702};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	* @param PredefinedType DEMANDED parameter of type IfcDuctSilencerTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcDuctSilencerType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcDuctSilencerTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcDuctSilencerType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCDUCTSILENCERTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcDuctSilencerTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcDuctSilencerType ifcDuctSilencerType = new IfcDuctSilencerType();
		if(this.GlobalId != null)
			ifcDuctSilencerType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcDuctSilencerType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcDuctSilencerType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcDuctSilencerType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcDuctSilencerType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcDuctSilencerType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcDuctSilencerType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcDuctSilencerType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcDuctSilencerType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcDuctSilencerType.setPredefinedType((IfcDuctSilencerTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcDuctSilencerType ifcDuctSilencerType = new IfcDuctSilencerType();
		if(this.GlobalId != null)
			ifcDuctSilencerType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcDuctSilencerType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcDuctSilencerType.setName(this.Name);
		if(this.Description != null)
			ifcDuctSilencerType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcDuctSilencerType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcDuctSilencerType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcDuctSilencerType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcDuctSilencerType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcDuctSilencerType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcDuctSilencerType.setPredefinedType(this.PredefinedType);
		return ifcDuctSilencerType;
	}
