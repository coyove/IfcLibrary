...
/**
 * This is a default implementation of the entity IfcEnergyConversionDevice<br><br>
 *<br><br>
 ...
 */
public class IfcEnergyConversionDevice extends IfcDistributionFlowElement implements ClassInterface
{
...
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,268435456,37475,44139};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	...
	/**
	* Constructs a new IfcEnergyConversionDevice object using the given parameters.
	*
	...
	**/
	...
	{
		return IfcEnergyConversionDevice.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCENERGYCONVERSIONDEVICE(");
	...
	**/
	public Object clone()
	{
		IfcEnergyConversionDevice ifcEnergyConversionDevice = new IfcEnergyConversionDevice();
		if(this.GlobalId != null)
			ifcEnergyConversionDevice.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcEnergyConversionDevice.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcEnergyConversionDevice.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcEnergyConversionDevice.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcEnergyConversionDevice.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcEnergyConversionDevice.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcEnergyConversionDevice.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcEnergyConversionDevice.setTag((IfcIdentifier)this.Tag.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcEnergyConversionDevice ifcEnergyConversionDevice = new IfcEnergyConversionDevice();
		if(this.GlobalId != null)
			ifcEnergyConversionDevice.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcEnergyConversionDevice.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcEnergyConversionDevice.setName(this.Name);
		if(this.Description != null)
			ifcEnergyConversionDevice.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcEnergyConversionDevice.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcEnergyConversionDevice.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcEnergyConversionDevice.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcEnergyConversionDevice.setTag(this.Tag);
		return ifcEnergyConversionDevice;
	}
