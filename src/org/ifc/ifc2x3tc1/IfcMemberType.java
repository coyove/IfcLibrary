...
/**
 * This is a default implementation of the entity IfcMemberType<br><br>
 *<br><br>
 ...
 */
public class IfcMemberType extends IfcBuildingElementType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcMemberTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,38089};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	* @param PredefinedType DEMANDED parameter of type IfcMemberTypeEnum - may not be null.
	**/
	public IfcMemberType(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ApplicableOccurrence, SET<IfcPropertySetDefinition> HasPropertySets, LIST<IfcRepresentationMap> RepresentationMaps, IfcLabel Tag, IfcLabel ElementType, IfcMemberTypeEnum PredefinedType)
	{
	...
	/**
	 * This method initializes the IfcMemberType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcMemberTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcMemberType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCMEMBERTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcMemberTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcMemberType ifcMemberType = new IfcMemberType();
		if(this.GlobalId != null)
			ifcMemberType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcMemberType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcMemberType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcMemberType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcMemberType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcMemberType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcMemberType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcMemberType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcMemberType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcMemberType.setPredefinedType((IfcMemberTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcMemberType ifcMemberType = new IfcMemberType();
		if(this.GlobalId != null)
			ifcMemberType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcMemberType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcMemberType.setName(this.Name);
		if(this.Description != null)
			ifcMemberType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcMemberType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcMemberType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcMemberType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcMemberType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcMemberType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcMemberType.setPredefinedType(this.PredefinedType);
		return ifcMemberType;
	}
