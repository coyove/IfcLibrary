...
/**
 * This is a default implementation of the entity IfcElectricHeaterType<br><br>
 *<br><br>
 ...
 */
public class IfcElectricHeaterType extends IfcFlowTerminalType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcElectricHeaterTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,9231};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	private java.util.ArrayList<CloneableObject> stepParameter = null;
	private java.util.HashSet<ObjectChangeListener> listenerList = null;
	protected int stepLineNumber;
	/** PredefinedType is an DEMANDED attribute - may not be null**/
	protected IfcElectricHeaterTypeEnum PredefinedType;
	/**
	...
	**/
	...
	/**
	 * This method initializes the IfcElectricHeaterType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcElectricHeaterTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcElectricHeaterType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCELECTRICHEATERTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcElectricHeaterTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcElectricHeaterType ifcElectricHeaterType = new IfcElectricHeaterType();
		if(this.GlobalId != null)
			ifcElectricHeaterType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcElectricHeaterType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcElectricHeaterType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcElectricHeaterType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcElectricHeaterType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcElectricHeaterType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcElectricHeaterType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcElectricHeaterType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcElectricHeaterType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcElectricHeaterType.setPredefinedType((IfcElectricHeaterTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcElectricHeaterType ifcElectricHeaterType = new IfcElectricHeaterType();
		if(this.GlobalId != null)
			ifcElectricHeaterType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcElectricHeaterType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcElectricHeaterType.setName(this.Name);
		if(this.Description != null)
			ifcElectricHeaterType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcElectricHeaterType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcElectricHeaterType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcElectricHeaterType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcElectricHeaterType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcElectricHeaterType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcElectricHeaterType.setPredefinedType(this.PredefinedType);
		return ifcElectricHeaterType;
	}
