...
/**
 * This is a default implementation of the entity IfcAirToAirHeatRecoveryType<br><br>
 *<br><br>
 ...
 */
public class IfcAirToAirHeatRecoveryType extends IfcEnergyConversionDeviceType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcAirToAirHeatRecoveryTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,43817};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	...
	/**
	* Constructs a new IfcAirToAirHeatRecoveryType object using the given parameters.
	*
	...
	* @param PredefinedType DEMANDED parameter of type IfcAirToAirHeatRecoveryTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcAirToAirHeatRecoveryType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcAirToAirHeatRecoveryTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcAirToAirHeatRecoveryType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCAIRTOAIRHEATRECOVERYTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcAirToAirHeatRecoveryTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcAirToAirHeatRecoveryType ifcAirToAirHeatRecoveryType = new IfcAirToAirHeatRecoveryType();
		if(this.GlobalId != null)
			ifcAirToAirHeatRecoveryType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcAirToAirHeatRecoveryType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcAirToAirHeatRecoveryType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcAirToAirHeatRecoveryType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcAirToAirHeatRecoveryType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcAirToAirHeatRecoveryType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcAirToAirHeatRecoveryType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcAirToAirHeatRecoveryType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcAirToAirHeatRecoveryType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcAirToAirHeatRecoveryType.setPredefinedType((IfcAirToAirHeatRecoveryTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcAirToAirHeatRecoveryType ifcAirToAirHeatRecoveryType = new IfcAirToAirHeatRecoveryType();
		if(this.GlobalId != null)
			ifcAirToAirHeatRecoveryType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcAirToAirHeatRecoveryType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcAirToAirHeatRecoveryType.setName(this.Name);
		if(this.Description != null)
			ifcAirToAirHeatRecoveryType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcAirToAirHeatRecoveryType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcAirToAirHeatRecoveryType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcAirToAirHeatRecoveryType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcAirToAirHeatRecoveryType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcAirToAirHeatRecoveryType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcAirToAirHeatRecoveryType.setPredefinedType(this.PredefinedType);
		return ifcAirToAirHeatRecoveryType;
	}
