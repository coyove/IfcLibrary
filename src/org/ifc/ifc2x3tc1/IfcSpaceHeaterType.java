...
/**
 * This is a default implementation of the entity IfcSpaceHeaterType<br><br>
 *<br><br>
 ...
 */
public class IfcSpaceHeaterType extends IfcEnergyConversionDeviceType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcSpaceHeaterTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,3111};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	...
	/**
	* Constructs a new IfcSpaceHeaterType object using the given parameters.
	*
	...
	* @param PredefinedType DEMANDED parameter of type IfcSpaceHeaterTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcSpaceHeaterType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcSpaceHeaterTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcSpaceHeaterType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCSPACEHEATERTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcSpaceHeaterTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcSpaceHeaterType ifcSpaceHeaterType = new IfcSpaceHeaterType();
		if(this.GlobalId != null)
			ifcSpaceHeaterType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcSpaceHeaterType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcSpaceHeaterType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcSpaceHeaterType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcSpaceHeaterType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcSpaceHeaterType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcSpaceHeaterType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcSpaceHeaterType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcSpaceHeaterType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcSpaceHeaterType.setPredefinedType((IfcSpaceHeaterTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcSpaceHeaterType ifcSpaceHeaterType = new IfcSpaceHeaterType();
		if(this.GlobalId != null)
			ifcSpaceHeaterType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcSpaceHeaterType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcSpaceHeaterType.setName(this.Name);
		if(this.Description != null)
			ifcSpaceHeaterType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcSpaceHeaterType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcSpaceHeaterType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcSpaceHeaterType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcSpaceHeaterType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcSpaceHeaterType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcSpaceHeaterType.setPredefinedType(this.PredefinedType);
		return ifcSpaceHeaterType;
	}
