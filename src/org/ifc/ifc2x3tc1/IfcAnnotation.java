...
/**
 * This is a default implementation of the entity IfcAnnotation<br><br>
 *<br><br>
 ...
 */
public class IfcAnnotation extends IfcProduct implements ClassInterface
{
...
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,268435456,37475};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	...
	{
		return IfcAnnotation.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCANNOTATION(");
	...
	**/
	public Object clone()
	{
		IfcAnnotation ifcAnnotation = new IfcAnnotation();
		if(this.GlobalId != null)
			ifcAnnotation.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcAnnotation.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcAnnotation.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcAnnotation.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcAnnotation.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcAnnotation.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcAnnotation.setRepresentation((IfcProductRepresentation)this.Representation.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcAnnotation ifcAnnotation = new IfcAnnotation();
		if(this.GlobalId != null)
			ifcAnnotation.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcAnnotation.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcAnnotation.setName(this.Name);
		if(this.Description != null)
			ifcAnnotation.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcAnnotation.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcAnnotation.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcAnnotation.setRepresentation(this.Representation);
		return ifcAnnotation;
	}
