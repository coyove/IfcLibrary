...
/**
 * This is a default implementation of the entity IfcVirtualElement<br><br>
 *<br><br>
 ...
 */
public class IfcVirtualElement extends IfcElement implements ClassInterface
{
...
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,268435456,37475,44139};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	...
	{
		return IfcVirtualElement.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCVIRTUALELEMENT(");
	...
	**/
	public Object clone()
	{
		IfcVirtualElement ifcVirtualElement = new IfcVirtualElement();
		if(this.GlobalId != null)
			ifcVirtualElement.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcVirtualElement.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcVirtualElement.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcVirtualElement.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcVirtualElement.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcVirtualElement.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcVirtualElement.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcVirtualElement.setTag((IfcIdentifier)this.Tag.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcVirtualElement ifcVirtualElement = new IfcVirtualElement();
		if(this.GlobalId != null)
			ifcVirtualElement.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcVirtualElement.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcVirtualElement.setName(this.Name);
		if(this.Description != null)
			ifcVirtualElement.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcVirtualElement.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcVirtualElement.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcVirtualElement.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcVirtualElement.setTag(this.Tag);
		return ifcVirtualElement;
	}
