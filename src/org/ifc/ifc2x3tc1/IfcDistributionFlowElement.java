...
/**
 * This is a default implementation of the entity IfcDistributionFlowElement<br><br>
 *<br><br>
 ...
 */
public class IfcDistributionFlowElement extends IfcDistributionElement implements ClassInterface
{
	...
	protected SET<IfcRelFlowControlElements> HasControlElements_Inverse;
	/**
	...
	**/
	void destruct()
	{
		 super.destruct();
		listenerList = null;
		HasControlElements_Inverse = null;
	}
	...
	**/
	...
	{
		return IfcDistributionFlowElement.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCDISTRIBUTIONFLOWELEMENT(");
	...
	**/
	...
	/**
	* This method returns a copy of the set of the HasControlElements_Inverse attribute.
	*
	* @return a copy of the HasControlElements_Inverse set
	**/
	public SET<IfcRelFlowControlElements> getHasControlElements_Inverse()
	{
		if(this.HasControlElements_Inverse != null)
			return new SET<IfcRelFlowControlElements>(this.HasControlElements_Inverse);
		return null;
	}
	...
	**/
	public Object clone()
	{
		IfcDistributionFlowElement ifcDistributionFlowElement = new IfcDistributionFlowElement();
		if(this.GlobalId != null)
			ifcDistributionFlowElement.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcDistributionFlowElement.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcDistributionFlowElement.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcDistributionFlowElement.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcDistributionFlowElement.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcDistributionFlowElement.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcDistributionFlowElement.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcDistributionFlowElement.setTag((IfcIdentifier)this.Tag.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcDistributionFlowElement ifcDistributionFlowElement = new IfcDistributionFlowElement();
		if(this.GlobalId != null)
			ifcDistributionFlowElement.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcDistributionFlowElement.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcDistributionFlowElement.setName(this.Name);
		if(this.Description != null)
			ifcDistributionFlowElement.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcDistributionFlowElement.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcDistributionFlowElement.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcDistributionFlowElement.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcDistributionFlowElement.setTag(this.Tag);
		return ifcDistributionFlowElement;
	}
