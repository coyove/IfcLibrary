...
/**
 * This is a default implementation of the entity IfcTransformerType<br><br>
 *<br><br>
 ...
 */
public class IfcTransformerType extends IfcEnergyConversionDeviceType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcTransformerTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,30068};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	* @param PredefinedType DEMANDED parameter of type IfcTransformerTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcTransformerType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcTransformerTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcTransformerType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCTRANSFORMERTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcTransformerTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcTransformerType ifcTransformerType = new IfcTransformerType();
		if(this.GlobalId != null)
			ifcTransformerType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcTransformerType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcTransformerType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcTransformerType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcTransformerType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcTransformerType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcTransformerType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcTransformerType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcTransformerType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcTransformerType.setPredefinedType((IfcTransformerTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcTransformerType ifcTransformerType = new IfcTransformerType();
		if(this.GlobalId != null)
			ifcTransformerType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcTransformerType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcTransformerType.setName(this.Name);
		if(this.Description != null)
			ifcTransformerType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcTransformerType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcTransformerType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcTransformerType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcTransformerType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcTransformerType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcTransformerType.setPredefinedType(this.PredefinedType);
		return ifcTransformerType;
	}
