...
/**
 * This is a default implementation of the entity IfcColumn<br><br>
 *<br><br>
 ...
 */
public class IfcColumn extends IfcBuildingElement implements ClassInterface
{
...
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,268435456,37475,44139};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	public IfcColumn(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag)
	{
	...
	**/
	...
	{
		return IfcColumn.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCCOLUMN(");
	...
	**/
	public Object clone()
	{
		IfcColumn ifcColumn = new IfcColumn();
		if(this.GlobalId != null)
			ifcColumn.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcColumn.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcColumn.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcColumn.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcColumn.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcColumn.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcColumn.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcColumn.setTag((IfcIdentifier)this.Tag.clone());
		return ifcColumn;
	}
	...
	**/
	public Object shallowCopy()
	{
		IfcColumn ifcColumn = new IfcColumn();
		if(this.GlobalId != null)
			ifcColumn.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcColumn.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcColumn.setName(this.Name);
		if(this.Description != null)
			ifcColumn.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcColumn.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcColumn.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcColumn.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcColumn.setTag(this.Tag);
		return ifcColumn;
	}
