...
/**
 * This is a default implementation of the entity IfcCableSegmentType<br><br>
 *<br><br>
 ...
 */
public class IfcCableSegmentType extends IfcFlowSegmentType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcCableSegmentTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,54820};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	* @param PredefinedType DEMANDED parameter of type IfcCableSegmentTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcCableSegmentType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcCableSegmentTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcCableSegmentType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCCABLESEGMENTTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcCableSegmentTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcCableSegmentType ifcCableSegmentType = new IfcCableSegmentType();
		if(this.GlobalId != null)
			ifcCableSegmentType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcCableSegmentType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcCableSegmentType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcCableSegmentType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcCableSegmentType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcCableSegmentType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcCableSegmentType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcCableSegmentType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcCableSegmentType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcCableSegmentType.setPredefinedType((IfcCableSegmentTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcCableSegmentType ifcCableSegmentType = new IfcCableSegmentType();
		if(this.GlobalId != null)
			ifcCableSegmentType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcCableSegmentType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcCableSegmentType.setName(this.Name);
		if(this.Description != null)
			ifcCableSegmentType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcCableSegmentType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcCableSegmentType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcCableSegmentType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcCableSegmentType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcCableSegmentType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcCableSegmentType.setPredefinedType(this.PredefinedType);
		return ifcCableSegmentType;
	}
