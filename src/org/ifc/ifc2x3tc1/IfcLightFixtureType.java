...
/**
 * This is a default implementation of the entity IfcLightFixtureType<br><br>
 *<br><br>
 ...
 */
public class IfcLightFixtureType extends IfcFlowTerminalType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcLightFixtureTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,8679};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	* @param PredefinedType DEMANDED parameter of type IfcLightFixtureTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcLightFixtureType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcLightFixtureTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcLightFixtureType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCLIGHTFIXTURETYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcLightFixtureTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcLightFixtureType ifcLightFixtureType = new IfcLightFixtureType();
		if(this.GlobalId != null)
			ifcLightFixtureType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcLightFixtureType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcLightFixtureType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcLightFixtureType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcLightFixtureType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcLightFixtureType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcLightFixtureType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcLightFixtureType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcLightFixtureType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcLightFixtureType.setPredefinedType((IfcLightFixtureTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcLightFixtureType ifcLightFixtureType = new IfcLightFixtureType();
		if(this.GlobalId != null)
			ifcLightFixtureType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcLightFixtureType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcLightFixtureType.setName(this.Name);
		if(this.Description != null)
			ifcLightFixtureType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcLightFixtureType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcLightFixtureType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcLightFixtureType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcLightFixtureType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcLightFixtureType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcLightFixtureType.setPredefinedType(this.PredefinedType);
		return ifcLightFixtureType;
	}
