...
/**
 * This is a default implementation of the entity IfcPipeSegmentType<br><br>
 *<br><br>
 ...
 */
public class IfcPipeSegmentType extends IfcFlowSegmentType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcPipeSegmentTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,10837};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	* @param PredefinedType DEMANDED parameter of type IfcPipeSegmentTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcPipeSegmentType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcPipeSegmentTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcPipeSegmentType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCPIPESEGMENTTYPE(");
	...
	**/
	...
	public Object clone()
	{
		IfcPipeSegmentType ifcPipeSegmentType = new IfcPipeSegmentType();
		if(this.GlobalId != null)
			ifcPipeSegmentType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcPipeSegmentType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcPipeSegmentType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcPipeSegmentType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcPipeSegmentType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcPipeSegmentType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcPipeSegmentType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcPipeSegmentType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcPipeSegmentType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcPipeSegmentType.setPredefinedType((IfcPipeSegmentTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcPipeSegmentType ifcPipeSegmentType = new IfcPipeSegmentType();
		if(this.GlobalId != null)
			ifcPipeSegmentType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcPipeSegmentType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcPipeSegmentType.setName(this.Name);
		if(this.Description != null)
			ifcPipeSegmentType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcPipeSegmentType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcPipeSegmentType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcPipeSegmentType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcPipeSegmentType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcPipeSegmentType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcPipeSegmentType.setPredefinedType(this.PredefinedType);
		return ifcPipeSegmentType;
	}
