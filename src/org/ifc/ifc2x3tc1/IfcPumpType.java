...
/**
 * This is a default implementation of the entity IfcPumpType<br><br>
 *<br><br>
 ...
 */
public class IfcPumpType extends IfcFlowMovingDeviceType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcPumpTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,43388};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	...
	/**
	* Constructs a new IfcPumpType object using the given parameters.
	*
	...
	* @param PredefinedType DEMANDED parameter of type IfcPumpTypeEnum - may not be null.
	**/
	public IfcPumpType(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ApplicableOccurrence, SET<IfcPropertySetDefinition> HasPropertySets, LIST<IfcRepresentationMap> RepresentationMaps, IfcLabel Tag, IfcLabel ElementType, IfcPumpTypeEnum PredefinedType)
	{
	...
	/**
	 * This method initializes the IfcPumpType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcPumpTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcPumpType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCPUMPTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcPumpTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcPumpType ifcPumpType = new IfcPumpType();
		if(this.GlobalId != null)
			ifcPumpType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcPumpType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcPumpType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcPumpType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcPumpType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcPumpType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcPumpType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcPumpType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcPumpType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcPumpType.setPredefinedType((IfcPumpTypeEnum)this.PredefinedType.clone());
		return ifcPumpType;
	}
	...
	**/
	public Object shallowCopy()
	{
		IfcPumpType ifcPumpType = new IfcPumpType();
		if(this.GlobalId != null)
			ifcPumpType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcPumpType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcPumpType.setName(this.Name);
		if(this.Description != null)
			ifcPumpType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcPumpType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcPumpType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcPumpType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcPumpType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcPumpType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcPumpType.setPredefinedType(this.PredefinedType);
		return ifcPumpType;
	}
