...
/**
 * This is a default implementation of the entity IfcDuctFittingType<br><br>
 *<br><br>
 ...
 */
public class IfcDuctFittingType extends IfcFlowFittingType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcDuctFittingTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,12853};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	* @param PredefinedType DEMANDED parameter of type IfcDuctFittingTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcDuctFittingType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcDuctFittingTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcDuctFittingType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCDUCTFITTINGTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcDuctFittingTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcDuctFittingType ifcDuctFittingType = new IfcDuctFittingType();
		if(this.GlobalId != null)
			ifcDuctFittingType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcDuctFittingType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcDuctFittingType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcDuctFittingType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcDuctFittingType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcDuctFittingType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcDuctFittingType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcDuctFittingType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcDuctFittingType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcDuctFittingType.setPredefinedType((IfcDuctFittingTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcDuctFittingType ifcDuctFittingType = new IfcDuctFittingType();
		if(this.GlobalId != null)
			ifcDuctFittingType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcDuctFittingType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcDuctFittingType.setName(this.Name);
		if(this.Description != null)
			ifcDuctFittingType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcDuctFittingType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcDuctFittingType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcDuctFittingType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcDuctFittingType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcDuctFittingType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcDuctFittingType.setPredefinedType(this.PredefinedType);
		return ifcDuctFittingType;
	}
