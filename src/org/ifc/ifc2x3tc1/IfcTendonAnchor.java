...
/**
 * This is a default implementation of the entity IfcTendonAnchor<br><br>
 *<br><br>
 ...
 */
public class IfcTendonAnchor extends IfcReinforcingElement implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcLabel"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,268435456,37475,44139,3773};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	public IfcTendonAnchor(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcLabel SteelGrade)
	{
	...
	**/
	...
	{
		return IfcTendonAnchor.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCTENDONANCHOR(");
	...
	**/
	public Object clone()
	{
		IfcTendonAnchor ifcTendonAnchor = new IfcTendonAnchor();
		if(this.GlobalId != null)
			ifcTendonAnchor.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcTendonAnchor.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcTendonAnchor.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcTendonAnchor.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcTendonAnchor.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcTendonAnchor.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcTendonAnchor.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcTendonAnchor.setTag((IfcIdentifier)this.Tag.clone());
		if(this.SteelGrade != null)
			ifcTendonAnchor.setSteelGrade((IfcLabel)this.SteelGrade.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcTendonAnchor ifcTendonAnchor = new IfcTendonAnchor();
		if(this.GlobalId != null)
			ifcTendonAnchor.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcTendonAnchor.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcTendonAnchor.setName(this.Name);
		if(this.Description != null)
			ifcTendonAnchor.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcTendonAnchor.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcTendonAnchor.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcTendonAnchor.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcTendonAnchor.setTag(this.Tag);
		if(this.SteelGrade != null)
			ifcTendonAnchor.setSteelGrade(this.SteelGrade);
		return ifcTendonAnchor;
	}
