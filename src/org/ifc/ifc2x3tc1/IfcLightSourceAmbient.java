...
/**
 * This is a default implementation of the entity IfcLightSourceAmbient<br><br>
 *<br><br>
 ...
 */
public class IfcLightSourceAmbient extends IfcLightSource implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcLabel","IfcColourRgb","IfcNormalisedRatioMeasure","IfcNormalisedRatioMeasure"};
private static final int[] nonInverseHashAttributes = new int[]{3773,5752,34149,34149};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	...
	{
		return IfcLightSourceAmbient.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCLIGHTSOURCEAMBIENT(");
	...
	**/
	public Object clone()
	{
		IfcLightSourceAmbient ifcLightSourceAmbient = new IfcLightSourceAmbient();
		if(this.Name != null)
			ifcLightSourceAmbient.setName((IfcLabel)this.Name.clone());
		if(this.LightColour != null)
			ifcLightSourceAmbient.setLightColour((IfcColourRgb)this.LightColour.clone());
		if(this.AmbientIntensity != null)
			ifcLightSourceAmbient.setAmbientIntensity((IfcNormalisedRatioMeasure)this.AmbientIntensity.clone());
		if(this.Intensity != null)
			ifcLightSourceAmbient.setIntensity((IfcNormalisedRatioMeasure)this.Intensity.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcLightSourceAmbient ifcLightSourceAmbient = new IfcLightSourceAmbient();
		if(this.Name != null)
			ifcLightSourceAmbient.setName(this.Name);
		if(this.LightColour != null)
			ifcLightSourceAmbient.setLightColour(this.LightColour);
		if(this.AmbientIntensity != null)
			ifcLightSourceAmbient.setAmbientIntensity(this.AmbientIntensity);
		if(this.Intensity != null)
			ifcLightSourceAmbient.setIntensity(this.Intensity);
		return ifcLightSourceAmbient;
	}
