...
/**
 * This is a default implementation of the entity IfcRightCircularCylinder<br><br>
 *<br><br>
...
private static final int[] nonInverseHashAttributes = new int[]{46787,35714,35714};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	...
	/**
	 * This method initializes the IfcRightCircularCylinder object using the given parameters.
	*
	* @param Position DEMANDED parameter of type IfcAxis2Placement3D - may not be null.
	* @param Height DEMANDED parameter of type IfcPositiveLengthMeasure - may not be null.
	* @param Radius DEMANDED parameter of type IfcPositiveLengthMeasure - may not be null.
	**/
	public void setParameters(IfcAxis2Placement3D Position, IfcPositiveLengthMeasure Height, IfcPositiveLengthMeasure Radius)
	{
		this.Position = Position;
		this.Height = Height;
		this.Radius = Radius;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.Radius = (IfcPositiveLengthMeasure) parameters.get(2);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcRightCircularCylinder.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCRIGHTCIRCULARCYLINDER(");
	...
	**/
	public Object clone()
	{
		IfcRightCircularCylinder ifcRightCircularCylinder = new IfcRightCircularCylinder();
		if(this.Position != null)
			ifcRightCircularCylinder.setPosition((IfcAxis2Placement3D)this.Position.clone());
		if(this.Height != null)
			ifcRightCircularCylinder.setHeight((IfcPositiveLengthMeasure)this.Height.clone());
		if(this.Radius != null)
			ifcRightCircularCylinder.setRadius((IfcPositiveLengthMeasure)this.Radius.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcRightCircularCylinder ifcRightCircularCylinder = new IfcRightCircularCylinder();
		if(this.Position != null)
			ifcRightCircularCylinder.setPosition(this.Position);
		if(this.Height != null)
			ifcRightCircularCylinder.setHeight(this.Height);
		if(this.Radius != null)
			ifcRightCircularCylinder.setRadius(this.Radius);
		return ifcRightCircularCylinder;
	}
