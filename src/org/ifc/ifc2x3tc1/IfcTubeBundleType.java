...
/**
 * This is a default implementation of the entity IfcTubeBundleType<br><br>
 *<br><br>
 ...
 */
public class IfcTubeBundleType extends IfcEnergyConversionDeviceType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcTubeBundleTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,56272};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	* @param PredefinedType DEMANDED parameter of type IfcTubeBundleTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcTubeBundleType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcTubeBundleTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcTubeBundleType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCTUBEBUNDLETYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcTubeBundleTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcTubeBundleType ifcTubeBundleType = new IfcTubeBundleType();
		if(this.GlobalId != null)
			ifcTubeBundleType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcTubeBundleType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcTubeBundleType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcTubeBundleType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcTubeBundleType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcTubeBundleType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcTubeBundleType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcTubeBundleType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcTubeBundleType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcTubeBundleType.setPredefinedType((IfcTubeBundleTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcTubeBundleType ifcTubeBundleType = new IfcTubeBundleType();
		if(this.GlobalId != null)
			ifcTubeBundleType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcTubeBundleType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcTubeBundleType.setName(this.Name);
		if(this.Description != null)
			ifcTubeBundleType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcTubeBundleType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcTubeBundleType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcTubeBundleType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcTubeBundleType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcTubeBundleType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcTubeBundleType.setPredefinedType(this.PredefinedType);
		return ifcTubeBundleType;
	}
