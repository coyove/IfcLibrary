...
/**
 * This is a default implementation of the entity IfcDistributionElement<br><br>
 *<br><br>
 ...
 */
public class IfcDistributionElement extends IfcElement implements ClassInterface
{
...
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,268435456,37475,44139};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	...
	{
		return IfcDistributionElement.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCDISTRIBUTIONELEMENT(");
	...
	**/
	public Object clone()
	{
		IfcDistributionElement ifcDistributionElement = new IfcDistributionElement();
		if(this.GlobalId != null)
			ifcDistributionElement.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcDistributionElement.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcDistributionElement.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcDistributionElement.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcDistributionElement.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcDistributionElement.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcDistributionElement.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcDistributionElement.setTag((IfcIdentifier)this.Tag.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcDistributionElement ifcDistributionElement = new IfcDistributionElement();
		if(this.GlobalId != null)
			ifcDistributionElement.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcDistributionElement.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcDistributionElement.setName(this.Name);
		if(this.Description != null)
			ifcDistributionElement.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcDistributionElement.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcDistributionElement.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcDistributionElement.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcDistributionElement.setTag(this.Tag);
		return ifcDistributionElement;
	}
