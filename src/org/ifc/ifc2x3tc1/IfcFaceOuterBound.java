...
/**
 * This is a default implementation of the entity IfcFaceOuterBound<br><br>
 *<br><br>
 ...
 */
public class IfcFaceOuterBound extends IfcFaceBound implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcLoop","BOOLEAN"};
private static final int[] nonInverseHashAttributes = new int[]{47509,47261};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	...
	{
		return IfcFaceOuterBound.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCFACEOUTERBOUND(");
	...
	**/
	public Object clone()
	{
		IfcFaceOuterBound ifcFaceOuterBound = new IfcFaceOuterBound();
		if(this.Bound != null)
			ifcFaceOuterBound.setBound((IfcLoop)this.Bound.clone());
		if(this.Orientation != null)
			ifcFaceOuterBound.setOrientation((BOOLEAN)this.Orientation.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcFaceOuterBound ifcFaceOuterBound = new IfcFaceOuterBound();
		if(this.Bound != null)
			ifcFaceOuterBound.setBound(this.Bound);
		if(this.Orientation != null)
			ifcFaceOuterBound.setOrientation(this.Orientation);
		return ifcFaceOuterBound;
	}
