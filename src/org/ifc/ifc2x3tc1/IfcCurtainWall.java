...
/**
 * This is a default implementation of the entity IfcCurtainWall<br><br>
 *<br><br>
 ...
 */
public class IfcCurtainWall extends IfcBuildingElement implements ClassInterface
{
	...
	**/
	...
	/**
	* Constructs a new IfcCurtainWall object using the given parameters.
	*
	...
	**/
	public IfcCurtainWall(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag)
	{
	...
	**/
	...
	{
		return IfcCurtainWall.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCCURTAINWALL(");
	...
	**/
	public Object clone()
	{
		IfcCurtainWall ifcCurtainWall = new IfcCurtainWall();
		if(this.GlobalId != null)
			ifcCurtainWall.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcCurtainWall.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcCurtainWall.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcCurtainWall.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcCurtainWall.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcCurtainWall.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcCurtainWall.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcCurtainWall.setTag((IfcIdentifier)this.Tag.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcCurtainWall ifcCurtainWall = new IfcCurtainWall();
		if(this.GlobalId != null)
			ifcCurtainWall.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcCurtainWall.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcCurtainWall.setName(this.Name);
		if(this.Description != null)
			ifcCurtainWall.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcCurtainWall.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcCurtainWall.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcCurtainWall.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcCurtainWall.setTag(this.Tag);
		return ifcCurtainWall;
	}
