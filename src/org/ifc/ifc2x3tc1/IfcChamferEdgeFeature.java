...
/**
 * This is a default implementation of the entity IfcChamferEdgeFeature<br><br>
 *<br><br>
 ...
 */
public class IfcChamferEdgeFeature extends IfcEdgeFeature implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcPositiveLengthMeasure","IfcPositiveLengthMeasure","IfcPositiveLengthMeasure"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,268435456,37475,44139,35714,35714,35714};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	private java.util.ArrayList<CloneableObject> stepParameter = null;
	private java.util.HashSet<ObjectChangeListener> listenerList = null;
	protected int stepLineNumber;
	/** Width is an OPTIONAL attribute**/
	protected IfcPositiveLengthMeasure Width;
	/** Height is an OPTIONAL attribute**/
	...
	* @param FeatureLength OPTIONAL parameter of type IfcPositiveLengthMeasure
	* @param Width OPTIONAL parameter of type IfcPositiveLengthMeasure
	* @param Height OPTIONAL parameter of type IfcPositiveLengthMeasure
	**/
	...
	/**
	 * This method initializes the IfcChamferEdgeFeature object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.FeatureLength = (IfcPositiveLengthMeasure) parameters.get(8);
		this.Width = (IfcPositiveLengthMeasure) parameters.get(9);
		this.Height = (IfcPositiveLengthMeasure) parameters.get(10);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcChamferEdgeFeature.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCCHAMFEREDGEFEATURE(");
		...
		if(getRedefinedDerivedAttributeTypes().contains("FeatureLength")) stepString = stepString.concat("*,");
		else{
		if(this.FeatureLength != null)		stepString = stepString.concat(((RootInterface)this.FeatureLength).getStepParameter(IfcPositiveLengthMeasure.class.isInterface())+",");
		else		stepString = stepString.concat("$,");
		}
	...
	*
	* @param Height DEMANDED value to set - may not be null
	**/
	...
	**/
	public Object clone()
	{
		IfcChamferEdgeFeature ifcChamferEdgeFeature = new IfcChamferEdgeFeature();
		if(this.GlobalId != null)
			ifcChamferEdgeFeature.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcChamferEdgeFeature.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcChamferEdgeFeature.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcChamferEdgeFeature.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcChamferEdgeFeature.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcChamferEdgeFeature.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcChamferEdgeFeature.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcChamferEdgeFeature.setTag((IfcIdentifier)this.Tag.clone());
		if(this.FeatureLength != null)
			ifcChamferEdgeFeature.setFeatureLength((IfcPositiveLengthMeasure)this.FeatureLength.clone());
		if(this.Width != null)
			ifcChamferEdgeFeature.setWidth((IfcPositiveLengthMeasure)this.Width.clone());
		if(this.Height != null)
			ifcChamferEdgeFeature.setHeight((IfcPositiveLengthMeasure)this.Height.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcChamferEdgeFeature ifcChamferEdgeFeature = new IfcChamferEdgeFeature();
		if(this.GlobalId != null)
			ifcChamferEdgeFeature.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcChamferEdgeFeature.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcChamferEdgeFeature.setName(this.Name);
		if(this.Description != null)
			ifcChamferEdgeFeature.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcChamferEdgeFeature.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcChamferEdgeFeature.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcChamferEdgeFeature.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcChamferEdgeFeature.setTag(this.Tag);
		if(this.FeatureLength != null)
			ifcChamferEdgeFeature.setFeatureLength(this.FeatureLength);
		if(this.Width != null)
			ifcChamferEdgeFeature.setWidth(this.Width);
		if(this.Height != null)
			ifcChamferEdgeFeature.setHeight(this.Height);
		return ifcChamferEdgeFeature;
	}
