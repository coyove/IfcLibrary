...
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcIdentifier","IfcLabel","IfcLabel","BOOLEAN","INTEGER"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,44139,3773,3773,47261,47884};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	private java.util.ArrayList<CloneableObject> stepParameter = null;
	private java.util.HashSet<ObjectChangeListener> listenerList = null;
	protected int stepLineNumber;
	/** TaskId is an DEMANDED attribute - may not be null**/
	protected IfcIdentifier TaskId;
	...
	**/
	public IfcTask(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcIdentifier TaskId, IfcLabel Status, IfcLabel WorkMethod, BOOLEAN IsMilestone, INTEGER Priority)
	{
	...
	* @param Priority OPTIONAL parameter of type INTEGER
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcIdentifier TaskId, IfcLabel Status, IfcLabel WorkMethod, BOOLEAN IsMilestone, INTEGER Priority)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	...
	/**
	* This method sets the TaskId attribute to the given value.
	*
	* @param TaskId OPTIONAL value to set
	**/
	...
	/**
	* This method returns the value of the TaskId attribute.
	*
	...
	**/
	public Object clone()
	{
		...
		if(this.TaskId != null)
			ifcTask.setTaskId((IfcIdentifier)this.TaskId.clone());
		if(this.Status != null)
