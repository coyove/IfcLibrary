...
/**
 * This is a default implementation of the entity IfcMember<br><br>
 *<br><br>
 ...
 */
public class IfcMember extends IfcBuildingElement implements ClassInterface
{
	...
	**/
	...
	/**
	* Constructs a new IfcMember object using the given parameters.
	*
	...
	**/
	public IfcMember(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag)
	{
	...
	**/
	...
	{
		return IfcMember.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCMEMBER(");
	...
	**/
	public Object clone()
	{
		IfcMember ifcMember = new IfcMember();
		if(this.GlobalId != null)
			ifcMember.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcMember.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcMember.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcMember.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcMember.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcMember.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcMember.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcMember.setTag((IfcIdentifier)this.Tag.clone());
		return ifcMember;
	}
	...
	**/
	public Object shallowCopy()
	{
		IfcMember ifcMember = new IfcMember();
		if(this.GlobalId != null)
			ifcMember.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcMember.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcMember.setName(this.Name);
		if(this.Description != null)
			ifcMember.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcMember.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcMember.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcMember.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcMember.setTag(this.Tag);
		return ifcMember;
	}
