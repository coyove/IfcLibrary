...
/**
 * This is a default implementation of the entity IfcFlowMovingDevice<br><br>
 *<br><br>
 ...
 */
public class IfcFlowMovingDevice extends IfcDistributionFlowElement implements ClassInterface
{
	...
	**/
	...
	{
		return IfcFlowMovingDevice.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCFLOWMOVINGDEVICE(");
	...
	**/
	public Object clone()
	{
		IfcFlowMovingDevice ifcFlowMovingDevice = new IfcFlowMovingDevice();
		if(this.GlobalId != null)
			ifcFlowMovingDevice.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcFlowMovingDevice.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcFlowMovingDevice.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcFlowMovingDevice.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcFlowMovingDevice.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcFlowMovingDevice.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcFlowMovingDevice.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcFlowMovingDevice.setTag((IfcIdentifier)this.Tag.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcFlowMovingDevice ifcFlowMovingDevice = new IfcFlowMovingDevice();
		if(this.GlobalId != null)
			ifcFlowMovingDevice.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcFlowMovingDevice.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcFlowMovingDevice.setName(this.Name);
		if(this.Description != null)
			ifcFlowMovingDevice.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcFlowMovingDevice.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcFlowMovingDevice.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcFlowMovingDevice.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcFlowMovingDevice.setTag(this.Tag);
		return ifcFlowMovingDevice;
	}
