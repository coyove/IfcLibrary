...
public class LOGICAL implements RootInterface {
    public final static LOGICAL LogicalTrue = new LOGICAL(true);
    public final static LOGICAL LogicalFalse = new LOGICAL(false);
    public final static LOGICAL LogicalNull = new LOGICAL(null);
