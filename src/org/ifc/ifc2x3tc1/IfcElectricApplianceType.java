...
/**
 * This is a default implementation of the entity IfcElectricApplianceType<br><br>
 *<br><br>
 ...
 */
public class IfcElectricApplianceType extends IfcFlowTerminalType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcElectricApplianceTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,35798};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	...
	/**
	* Constructs a new IfcElectricApplianceType object using the given parameters.
	*
	...
	* @param PredefinedType DEMANDED parameter of type IfcElectricApplianceTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcElectricApplianceType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcElectricApplianceTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcElectricApplianceType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCELECTRICAPPLIANCETYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcElectricApplianceTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcElectricApplianceType ifcElectricApplianceType = new IfcElectricApplianceType();
		if(this.GlobalId != null)
			ifcElectricApplianceType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcElectricApplianceType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcElectricApplianceType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcElectricApplianceType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcElectricApplianceType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcElectricApplianceType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcElectricApplianceType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcElectricApplianceType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcElectricApplianceType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcElectricApplianceType.setPredefinedType((IfcElectricApplianceTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcElectricApplianceType ifcElectricApplianceType = new IfcElectricApplianceType();
		if(this.GlobalId != null)
			ifcElectricApplianceType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcElectricApplianceType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcElectricApplianceType.setName(this.Name);
		if(this.Description != null)
			ifcElectricApplianceType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcElectricApplianceType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcElectricApplianceType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcElectricApplianceType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcElectricApplianceType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcElectricApplianceType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcElectricApplianceType.setPredefinedType(this.PredefinedType);
		return ifcElectricApplianceType;
	}
