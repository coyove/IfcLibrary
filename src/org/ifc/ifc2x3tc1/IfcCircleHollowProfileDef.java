...
/**
 * This is a default implementation of the entity IfcCircleHollowProfileDef<br><br>
 *<br><br>
 ...
 */
public class IfcCircleHollowProfileDef extends IfcCircleProfileDef implements ClassInterface
{
...
private static final int[] nonInverseHashAttributes = new int[]{9197,3773,46805,35714,35714};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	...
	/**
	 * This method initializes the IfcCircleHollowProfileDef object using the given parameters.
	*
	* @param ProfileType DEMANDED parameter of type IfcProfileTypeEnum - may not be null.
	* @param ProfileName OPTIONAL parameter of type IfcLabel
	* @param Position DEMANDED parameter of type IfcAxis2Placement2D - may not be null.
	...
	* @param WallThickness DEMANDED parameter of type IfcPositiveLengthMeasure - may not be null.
	**/
	public void setParameters(IfcProfileTypeEnum ProfileType, IfcLabel ProfileName, IfcAxis2Placement2D Position, IfcPositiveLengthMeasure Radius, IfcPositiveLengthMeasure WallThickness)
	{
		this.ProfileType = ProfileType;
		this.ProfileName = ProfileName;
		this.Position = Position;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.WallThickness = (IfcPositiveLengthMeasure) parameters.get(4);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcCircleHollowProfileDef.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCCIRCLEHOLLOWPROFILEDEF(");
	...
	**/
	public Object clone()
	{
		IfcCircleHollowProfileDef ifcCircleHollowProfileDef = new IfcCircleHollowProfileDef();
		if(this.ProfileType != null)
			ifcCircleHollowProfileDef.setProfileType((IfcProfileTypeEnum)this.ProfileType.clone());
		if(this.ProfileName != null)
			ifcCircleHollowProfileDef.setProfileName((IfcLabel)this.ProfileName.clone());
		if(this.Position != null)
			ifcCircleHollowProfileDef.setPosition((IfcAxis2Placement2D)this.Position.clone());
		if(this.Radius != null)
			ifcCircleHollowProfileDef.setRadius((IfcPositiveLengthMeasure)this.Radius.clone());
		if(this.WallThickness != null)
			ifcCircleHollowProfileDef.setWallThickness((IfcPositiveLengthMeasure)this.WallThickness.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcCircleHollowProfileDef ifcCircleHollowProfileDef = new IfcCircleHollowProfileDef();
		if(this.ProfileType != null)
			ifcCircleHollowProfileDef.setProfileType(this.ProfileType);
		if(this.ProfileName != null)
			ifcCircleHollowProfileDef.setProfileName(this.ProfileName);
		if(this.Position != null)
			ifcCircleHollowProfileDef.setPosition(this.Position);
		if(this.Radius != null)
			ifcCircleHollowProfileDef.setRadius(this.Radius);
		if(this.WallThickness != null)
			ifcCircleHollowProfileDef.setWallThickness(this.WallThickness);
		return ifcCircleHollowProfileDef;
	}
