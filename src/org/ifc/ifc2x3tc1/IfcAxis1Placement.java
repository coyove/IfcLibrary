...
/**
 * This is a default implementation of the entity IfcAxis1Placement<br><br>
 *<br><br>
 ...
 */
public class IfcAxis1Placement extends IfcPlacement implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcCartesianPoint","IfcDirection"};
private static final int[] nonInverseHashAttributes = new int[]{51826,5701};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	...
	/**
	 * This method initializes the IfcAxis1Placement object using the given parameters.
	*
	* @param Location DEMANDED parameter of type IfcCartesianPoint - may not be null.
	* @param Axis OPTIONAL parameter of type IfcDirection
	**/
	public void setParameters(IfcCartesianPoint Location, IfcDirection Axis)
	{
		this.Location = Location;
		this.Axis = Axis;
		resolveInverses();
	...
	**/
	...
	{
		return IfcAxis1Placement.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCAXIS1PLACEMENT(");
	...
	**/
	public Object clone()
	{
		IfcAxis1Placement ifcAxis1Placement = new IfcAxis1Placement();
		if(this.Location != null)
			ifcAxis1Placement.setLocation((IfcCartesianPoint)this.Location.clone());
		if(this.Axis != null)
			ifcAxis1Placement.setAxis((IfcDirection)this.Axis.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcAxis1Placement ifcAxis1Placement = new IfcAxis1Placement();
		if(this.Location != null)
			ifcAxis1Placement.setLocation(this.Location);
		if(this.Axis != null)
			ifcAxis1Placement.setAxis(this.Axis);
		return ifcAxis1Placement;
	}
