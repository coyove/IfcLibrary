...
/**
 * This is a default implementation of the entity IfcEvaporatorType<br><br>
 *<br><br>
 ...
 */
public class IfcEvaporatorType extends IfcEnergyConversionDeviceType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcEvaporatorTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,37987};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	* @param PredefinedType DEMANDED parameter of type IfcEvaporatorTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcEvaporatorType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcEvaporatorTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcEvaporatorType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCEVAPORATORTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcEvaporatorTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcEvaporatorType ifcEvaporatorType = new IfcEvaporatorType();
		if(this.GlobalId != null)
			ifcEvaporatorType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcEvaporatorType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcEvaporatorType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcEvaporatorType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcEvaporatorType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcEvaporatorType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcEvaporatorType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcEvaporatorType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcEvaporatorType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcEvaporatorType.setPredefinedType((IfcEvaporatorTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcEvaporatorType ifcEvaporatorType = new IfcEvaporatorType();
		if(this.GlobalId != null)
			ifcEvaporatorType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcEvaporatorType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcEvaporatorType.setName(this.Name);
		if(this.Description != null)
			ifcEvaporatorType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcEvaporatorType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcEvaporatorType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcEvaporatorType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcEvaporatorType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcEvaporatorType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcEvaporatorType.setPredefinedType(this.PredefinedType);
		return ifcEvaporatorType;
	}
