...
/**
 * This is a default implementation of the entity IfcTransportElementType<br><br>
 *<br><br>
 ...
 */
public class IfcTransportElementType extends IfcElementType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcTransportElementTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,33139};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	* @param PredefinedType DEMANDED parameter of type IfcTransportElementTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcTransportElementType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcTransportElementTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcTransportElementType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCTRANSPORTELEMENTTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcTransportElementTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcTransportElementType ifcTransportElementType = new IfcTransportElementType();
		if(this.GlobalId != null)
			ifcTransportElementType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcTransportElementType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcTransportElementType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcTransportElementType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcTransportElementType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcTransportElementType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcTransportElementType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcTransportElementType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcTransportElementType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcTransportElementType.setPredefinedType((IfcTransportElementTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcTransportElementType ifcTransportElementType = new IfcTransportElementType();
		if(this.GlobalId != null)
			ifcTransportElementType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcTransportElementType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcTransportElementType.setName(this.Name);
		if(this.Description != null)
			ifcTransportElementType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcTransportElementType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcTransportElementType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcTransportElementType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcTransportElementType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcTransportElementType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcTransportElementType.setPredefinedType(this.PredefinedType);
		return ifcTransportElementType;
	}
