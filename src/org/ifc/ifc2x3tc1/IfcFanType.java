...
/**
 * This is a default implementation of the entity IfcFanType<br><br>
 *<br><br>
 ...
 */
public class IfcFanType extends IfcFlowMovingDeviceType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcFanTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,29131};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	* @param PredefinedType DEMANDED parameter of type IfcFanTypeEnum - may not be null.
	**/
	public IfcFanType(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ApplicableOccurrence, SET<IfcPropertySetDefinition> HasPropertySets, LIST<IfcRepresentationMap> RepresentationMaps, IfcLabel Tag, IfcLabel ElementType, IfcFanTypeEnum PredefinedType)
	{
	...
	/**
	 * This method initializes the IfcFanType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcFanTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcFanType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCFANTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcFanTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcFanType ifcFanType = new IfcFanType();
		if(this.GlobalId != null)
			ifcFanType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcFanType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcFanType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcFanType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcFanType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcFanType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcFanType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcFanType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcFanType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcFanType.setPredefinedType((IfcFanTypeEnum)this.PredefinedType.clone());
		return ifcFanType;
	}
	...
	**/
	public Object shallowCopy()
	{
		IfcFanType ifcFanType = new IfcFanType();
		if(this.GlobalId != null)
			ifcFanType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcFanType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcFanType.setName(this.Name);
		if(this.Description != null)
			ifcFanType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcFanType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcFanType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcFanType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcFanType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcFanType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcFanType.setPredefinedType(this.PredefinedType);
		return ifcFanType;
	}
