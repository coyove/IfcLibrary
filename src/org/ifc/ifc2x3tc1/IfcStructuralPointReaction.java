...
/**
 * This is a default implementation of the entity IfcStructuralPointReaction<br><br>
 *<br><br>
 ...
 */
public class IfcStructuralPointReaction extends IfcStructuralReaction implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcStructuralLoad","IfcGlobalOrLocalEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,268435456,37475,268435456,21554};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	...
	{
		return IfcStructuralPointReaction.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCSTRUCTURALPOINTREACTION(");
	...
	**/
	public Object clone()
	{
		IfcStructuralPointReaction ifcStructuralPointReaction = new IfcStructuralPointReaction();
		if(this.GlobalId != null)
			ifcStructuralPointReaction.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcStructuralPointReaction.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcStructuralPointReaction.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcStructuralPointReaction.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcStructuralPointReaction.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcStructuralPointReaction.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcStructuralPointReaction.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.AppliedLoad != null)
			ifcStructuralPointReaction.setAppliedLoad((IfcStructuralLoad)this.AppliedLoad.clone());
		if(this.GlobalOrLocal != null)
			ifcStructuralPointReaction.setGlobalOrLocal((IfcGlobalOrLocalEnum)this.GlobalOrLocal.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcStructuralPointReaction ifcStructuralPointReaction = new IfcStructuralPointReaction();
		if(this.GlobalId != null)
			ifcStructuralPointReaction.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcStructuralPointReaction.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcStructuralPointReaction.setName(this.Name);
		if(this.Description != null)
			ifcStructuralPointReaction.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcStructuralPointReaction.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcStructuralPointReaction.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcStructuralPointReaction.setRepresentation(this.Representation);
		if(this.AppliedLoad != null)
			ifcStructuralPointReaction.setAppliedLoad(this.AppliedLoad);
		if(this.GlobalOrLocal != null)
			ifcStructuralPointReaction.setGlobalOrLocal(this.GlobalOrLocal);
		return ifcStructuralPointReaction;
	}
