...
/**
 * This is a default implementation of the entity IfcExternallyDefinedTextFont<br><br>
 *<br><br>
 ...
 */
public class IfcExternallyDefinedTextFont extends IfcExternalReference implements ClassInterface, IfcTextFontSelect
{
...
private static final int[] nonInverseHashAttributes = new int[]{3773,44139,3773};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	**/
	...
	{
		return IfcExternallyDefinedTextFont.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCEXTERNALLYDEFINEDTEXTFONT(");
	...
	**/
	public Object clone()
	{
		IfcExternallyDefinedTextFont ifcExternallyDefinedTextFont = new IfcExternallyDefinedTextFont();
		if(this.Location != null)
			ifcExternallyDefinedTextFont.setLocation((IfcLabel)this.Location.clone());
		if(this.ItemReference != null)
			ifcExternallyDefinedTextFont.setItemReference((IfcIdentifier)this.ItemReference.clone());
		if(this.Name != null)
			ifcExternallyDefinedTextFont.setName((IfcLabel)this.Name.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcExternallyDefinedTextFont ifcExternallyDefinedTextFont = new IfcExternallyDefinedTextFont();
		if(this.Location != null)
			ifcExternallyDefinedTextFont.setLocation(this.Location);
		if(this.ItemReference != null)
			ifcExternallyDefinedTextFont.setItemReference(this.ItemReference);
		if(this.Name != null)
			ifcExternallyDefinedTextFont.setName(this.Name);
		return ifcExternallyDefinedTextFont;
	}
