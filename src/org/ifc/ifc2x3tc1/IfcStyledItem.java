...
/**
 * This is a default implementation of the entity IfcStyledItem<br><br>
 *<br><br>
 ...
 */
public class IfcStyledItem extends IfcRepresentationItem implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcRepresentationItem","SET<IfcPresentationStyleAssignment>","IfcLabel"};
private static final int[] nonInverseHashAttributes = new int[]{268435456,1073758784,3773};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	private java.util.ArrayList<CloneableObject> stepParameter = null;
	private java.util.HashSet<ObjectChangeListener> listenerList = null;
	protected int stepLineNumber;
	/** Item is an OPTIONAL attribute**/
	protected IfcRepresentationItem Item;
	/** Styles is an DEMANDED attribute - may not be null**/
	protected SET<IfcPresentationStyleAssignment> Styles;
	...
	**/
	...
	/**
	 * This method initializes the IfcStyledItem object using the given parameters.
	*
	* @param Item OPTIONAL parameter of type IfcRepresentationItem
	* @param Styles DEMANDED parameter of type SET<IfcPresentationStyleAssignment> - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	**/
	public void setParameters(IfcRepresentationItem Item, SET<IfcPresentationStyleAssignment> Styles, IfcLabel Name)
	{
		this.Item = Item;
		this.Styles = Styles;
		this.Name = Name;
	...
	**/
	...
	{
		return IfcStyledItem.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCSTYLEDITEM(");
	...
	*
	* @param Item DEMANDED value to set - may not be null
	**/
	public void setItem(IfcRepresentationItem Item)
	{
		synchronizeInversesRemoveItem(this.Item);
		this.Item = Item;
		synchronizeInversesAddItem(this.Item);
		fireChangeEvent();
	}
	...
	* @return the value of Item
	...
	private void synchronizeInversesAddItem(IfcRepresentationItem Item)
	{
		if(Item != null)
		{
				if(Item.StyledByItem_Inverse == null)
	...
	private void synchronizeInversesRemoveItem(IfcRepresentationItem Item)
	{
		if(Item != null)
		{
				if(Item.StyledByItem_Inverse != null)
				{
					Item.StyledByItem_Inverse.remove(this);
				}
		}
	}
	...
	**/
	...
	{
		if(this.Styles != null)
			return new SET<IfcPresentationStyleAssignment>(this.Styles);
		return null;
	}

	/**
	* This method adds an IfcPresentationStyleAssignment object to the Styles set.
	* @param Styles element to be appended to this set.
	**/
	public void addStyles(IfcPresentationStyleAssignment Styles)
	{
		if(this.Styles == null)
			this.Styles = new SET<IfcPresentationStyleAssignment>();
		this.Styles.add(Styles);
		fireChangeEvent();
	}

	/**
	* This method adds a collection of IfcPresentationStyleAssignment objects to the Styles set.
	* @param Styles collection containing elements to be added to this set.
	**/
	public void addAllStyles(java.util.Collection<IfcPresentationStyleAssignment> Styles)
	{
		if(this.Styles == null)
			this.Styles = new SET<IfcPresentationStyleAssignment>();
	...
	**/
	...
	/**
	* This method removes an IfcPresentationStyleAssignment object from the Styles set.
	* @param Styles element to be removed from this set.
	**/
	public void removeStyles(IfcPresentationStyleAssignment Styles)
	{
		if(this.Styles != null)
		{
	...
	/**
	* This method removes a collection of IfcPresentationStyleAssignment objects from the Styles set.
	* @param Styles collection containing elements to be removed from this set.
	**/
	public void removeAllStyles(java.util.Collection<IfcPresentationStyleAssignment> Styles)
	{
		if(this.Styles != null)
		{
	...
	**/
	...
	public Object clone()
	{
		IfcStyledItem ifcStyledItem = new IfcStyledItem();
		if(this.Item != null)
			ifcStyledItem.setItem((IfcRepresentationItem)this.Item.clone());
		if(this.Styles != null)
			ifcStyledItem.setStyles((SET<IfcPresentationStyleAssignment>)this.Styles.clone());
		if(this.Name != null)
			ifcStyledItem.setName((IfcLabel)this.Name.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcStyledItem ifcStyledItem = new IfcStyledItem();
		if(this.Item != null)
			ifcStyledItem.setItem(this.Item);
		if(this.Styles != null)
			ifcStyledItem.setStyles(this.Styles);
		if(this.Name != null)
			ifcStyledItem.setName(this.Name);
		return ifcStyledItem;
	}
