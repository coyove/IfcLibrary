...
/**
 * This is a default implementation of the entity IfcWasteTerminalType<br><br>
 *<br><br>
 ...
 */
public class IfcWasteTerminalType extends IfcFlowTerminalType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcWasteTerminalTypeEnum"};
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,3773,1073753902,-2147420789,3773,3773,12210};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	* @param PredefinedType DEMANDED parameter of type IfcWasteTerminalTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcWasteTerminalType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory DEMANDED parameter of type IfcOwnerHistory - may not be null.
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcWasteTerminalTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcWasteTerminalType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCWASTETERMINALTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcWasteTerminalTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcWasteTerminalType ifcWasteTerminalType = new IfcWasteTerminalType();
		if(this.GlobalId != null)
			ifcWasteTerminalType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcWasteTerminalType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcWasteTerminalType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcWasteTerminalType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcWasteTerminalType.setApplicableOccurrence((IfcLabel)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcWasteTerminalType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcWasteTerminalType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcWasteTerminalType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcWasteTerminalType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcWasteTerminalType.setPredefinedType((IfcWasteTerminalTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcWasteTerminalType ifcWasteTerminalType = new IfcWasteTerminalType();
		if(this.GlobalId != null)
			ifcWasteTerminalType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcWasteTerminalType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcWasteTerminalType.setName(this.Name);
		if(this.Description != null)
			ifcWasteTerminalType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcWasteTerminalType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcWasteTerminalType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcWasteTerminalType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcWasteTerminalType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcWasteTerminalType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcWasteTerminalType.setPredefinedType(this.PredefinedType);
		return ifcWasteTerminalType;
	}
