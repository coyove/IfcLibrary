...
/**
 * This is a default implementation of the entity IfcRelAssignsToControl<br><br>
 *<br><br>
 ...
 */
public class IfcRelAssignsToControl extends IfcRelAssigns implements ClassInterface
{
...
private static final int[] nonInverseHashAttributes = new int[]{12553,43192,3773,47402,1073794844,52215,268435456};int[] getNonInverseHashAttributeTypes(){return nonInverseHashAttributes;}
	...
	/** RelatingControl is an DEMANDED attribute - may not be null**/
	...
	**/
	...
	{
		return IfcRelAssignsToControl.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	*
	* @param RelatingControl OPTIONAL value to set
	**/
	public void setRelatingControl(IfcControl RelatingControl)
	{
		synchronizeInversesRemoveRelatingControl(this.RelatingControl);
		this.RelatingControl = RelatingControl;
		synchronizeInversesAddRelatingControl(this.RelatingControl);
		fireChangeEvent();
	}
	...
	* @return the value of RelatingControl
	...
	private void synchronizeInversesAddRelatingControl(IfcControl RelatingControl)
	{
		if(RelatingControl != null)
		{
				if(RelatingControl.Controls_Inverse == null)
	...
	private void synchronizeInversesRemoveRelatingControl(IfcControl RelatingControl)
	{
		if(RelatingControl != null)
		{
				if(RelatingControl.Controls_Inverse != null)
				{
					RelatingControl.Controls_Inverse.remove(this);
				}
		}
	}
	...
	**/
	...
	public Object clone()
	{
		...
		if(this.GlobalId != null)
			ifcRelAssignsToControl.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcRelAssignsToControl.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcRelAssignsToControl.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcRelAssignsToControl.setDescription((IfcText)this.Description.clone());
		if(this.RelatedObjects != null)
			ifcRelAssignsToControl.setRelatedObjects((SET<IfcObjectDefinition>)this.RelatedObjects.clone());
		if(this.RelatedObjectsType != null)
			ifcRelAssignsToControl.setRelatedObjectsType((IfcObjectTypeEnum)this.RelatedObjectsType.clone());
		if(this.RelatingControl != null)
			ifcRelAssignsToControl.setRelatingControl((IfcControl)this.RelatingControl.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcRelAssignsToControl ifcRelAssignsToControl = new IfcRelAssignsToControl();
		if(this.GlobalId != null)
			ifcRelAssignsToControl.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcRelAssignsToControl.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcRelAssignsToControl.setName(this.Name);
		if(this.Description != null)
			ifcRelAssignsToControl.setDescription(this.Description);
		if(this.RelatedObjects != null)
			ifcRelAssignsToControl.setRelatedObjects(this.RelatedObjects);
		if(this.RelatedObjectsType != null)
			ifcRelAssignsToControl.setRelatedObjectsType(this.RelatedObjectsType);
		if(this.RelatingControl != null)
			ifcRelAssignsToControl.setRelatingControl(this.RelatingControl);
		return ifcRelAssignsToControl;
	}
