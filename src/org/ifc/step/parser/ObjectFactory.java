...
public class ObjectFactory extends java.util.HashMap<String, ObjectFactory.ClassBuilder> {
    ...
    public final static int LIST_TYPE = 0x80000000;
    public final static int SET_TYPE = 0x40000000;
    public final static int SKIP_TYPE = 0x10000000;

    public static java.util.HashMap<String, ObjectFactory.ClassBuilder> FACTORY_MAP = new ObjectFactory();
    public static ClassBuilder[] FACTORY_ARRAY;
...
//        if (h > 100000) System.out.println(entityName);
    ...
    public static Object createInstance(int hash) {
        return FACTORY_ARRAY[hash - 59].instance();
    }

    private ObjectFactory() {
        FACTORY_ARRAY = new ClassBuilder[64760];
        FACTORY_ARRAY[0] = new IfcEnergyMeasureBuilder();
        FACTORY_ARRAY[57] = new IfcPressureMeasureBuilder();
        FACTORY_ARRAY[134] = new IfcThermodynamicTemperatureMeasureBuilder();
        FACTORY_ARRAY[192] = new IfcFaceBasedSurfaceModelBuilder();
        FACTORY_ARRAY[193] = new IfcRelAssociatesClassificationBuilder();
        FACTORY_ARRAY[197] = new IfcPipeFittingTypeEnumBuilder();
        FACTORY_ARRAY[250] = new IfcRationalBezierCurveBuilder();
        FACTORY_ARRAY[261] = new IfcBooleanResultBuilder();
        FACTORY_ARRAY[369] = new IfcSwitchingDeviceTypeBuilder();
        FACTORY_ARRAY[379] = new IfcRadiusDimensionBuilder();
        FACTORY_ARRAY[401] = new IfcCompositeProfileDefBuilder();
        FACTORY_ARRAY[1199] = new IfcMonthInYearNumberBuilder();
        FACTORY_ARRAY[1212] = new IfcSolidAngleMeasureBuilder();
        FACTORY_ARRAY[1229] = new IfcPropertyListValueBuilder();
        FACTORY_ARRAY[1246] = new IfcLaborResourceBuilder();
        FACTORY_ARRAY[1263] = new IfcRelAssociatesBuilder();
        FACTORY_ARRAY[1267] = new IfcSpaceHeaterTypeBuilder();
        FACTORY_ARRAY[1384] = new IfcComplexNumberBuilder();
        FACTORY_ARRAY[1413] = new IfcDocumentReferenceBuilder();
        FACTORY_ARRAY[1629] = new IfcReinforcingMeshBuilder();
        FACTORY_ARRAY[1643] = new IfcSwitchingDeviceTypeEnumBuilder();
        FACTORY_ARRAY[1750] = new IfcTrapeziumProfileDefBuilder();
        FACTORY_ARRAY[2095] = new IfcBezierCurveBuilder();
        FACTORY_ARRAY[2266] = new IfcRelOccupiesSpacesBuilder();
        FACTORY_ARRAY[2301] = new IfcEllipseBuilder();
        FACTORY_ARRAY[2357] = new IfcRelSchedulesCostItemsBuilder();
        FACTORY_ARRAY[2385] = new IfcDoseEquivalentMeasureBuilder();
        FACTORY_ARRAY[2413] = new IfcProjectBuilder();
        FACTORY_ARRAY[2487] = new IfcFanTypeBuilder();
        FACTORY_ARRAY[2500] = new IfcRectangleProfileDefBuilder();
        FACTORY_ARRAY[2560] = new DOUBLEBuilder();
        FACTORY_ARRAY[2588] = new IfcBooleanClippingResultBuilder();
        FACTORY_ARRAY[2759] = new BINARYBuilder();
        FACTORY_ARRAY[3052] = new IfcSpaceHeaterTypeEnumBuilder();
        FACTORY_ARRAY[3251] = new IfcWorkControlTypeEnumBuilder();
        FACTORY_ARRAY[3268] = new IfcFlowStorageDeviceBuilder();
        FACTORY_ARRAY[3392] = new IfcTransformerTypeBuilder();
        FACTORY_ARRAY[3432] = new IfcActorBuilder();
        FACTORY_ARRAY[3566] = new IfcGroupBuilder();
        FACTORY_ARRAY[3622] = new IfcPlaneBuilder();
        FACTORY_ARRAY[3708] = new IfcInventoryTypeEnumBuilder();
        FACTORY_ARRAY[3714] = new IfcLabelBuilder();
        FACTORY_ARRAY[3748] = new IfcSpaceBuilder();
        FACTORY_ARRAY[3799] = new REALBuilder();
        FACTORY_ARRAY[3840] = new IfcConversionBasedUnitBuilder();
        FACTORY_ARRAY[3921] = new IfcPlateBuilder();
        FACTORY_ARRAY[3924] = new IfcRelConnectsElementsBuilder();
        FACTORY_ARRAY[3985] = new IfcProxyBuilder();
        FACTORY_ARRAY[4014] = new IfcSurfaceStyleRenderingBuilder();
        FACTORY_ARRAY[4016] = new IfcTableBuilder();
        FACTORY_ARRAY[4107] = new IfcPHMeasureBuilder();
        FACTORY_ARRAY[4189] = new IfcRectangleHollowProfileDefBuilder();
        FACTORY_ARRAY[4215] = new IfcStructuralAnalysisModelBuilder();
        FACTORY_ARRAY[4221] = new IfcConstraintAggregationRelationshipBuilder();
        FACTORY_ARRAY[4274] = new IfcFillAreaStyleTileSymbolWithStyleBuilder();
        FACTORY_ARRAY[4348] = new IfcThermalTransmittanceMeasureBuilder();
        FACTORY_ARRAY[4398] = new IfcConnectionCurveGeometryBuilder();
        FACTORY_ARRAY[4483] = new IfcStructuralSurfaceConnectionBuilder();
        FACTORY_ARRAY[4564] = new IfcBooleanBuilder();
        FACTORY_ARRAY[4820] = new IfcSurfaceStyleShadingBuilder();
        FACTORY_ARRAY[4830] = new IfcReinforcingBarSurfaceEnumBuilder();
        FACTORY_ARRAY[4985] = new IfcFootingBuilder();
        FACTORY_ARRAY[5059] = new IfcRailingBuilder();
        FACTORY_ARRAY[5173] = new IfcStructuralCurveMemberBuilder();
        FACTORY_ARRAY[5240] = new IfcBoundaryEdgeConditionBuilder();
        FACTORY_ARRAY[5243] = new IfcBoundaryFaceConditionBuilder();
        FACTORY_ARRAY[5397] = new IfcThermalLoadSourceEnumBuilder();
        FACTORY_ARRAY[5427] = new IfcRelAssignsToProductBuilder();
        FACTORY_ARRAY[5482] = new IfcVertexBasedTextureMapBuilder();
        FACTORY_ARRAY[5488] = new IfcStructuralSurfaceTypeEnumBuilder();
        FACTORY_ARRAY[5506] = new IfcSurfaceOfRevolutionBuilder();
        FACTORY_ARRAY[5533] = new IfcClassificationItemRelationshipBuilder();
        FACTORY_ARRAY[5590] = new IfcFontStyleBuilder();
        FACTORY_ARRAY[5597] = new IfcOpenShellBuilder();
        FACTORY_ARRAY[5622] = new IfcSlippageConnectionConditionBuilder();
        FACTORY_ARRAY[5629] = new IfcTextLiteralWithExtentBuilder();
        FACTORY_ARRAY[5642] = new IfcDirectionBuilder();
        FACTORY_ARRAY[5673] = new IfcDocumentInformationRelationshipBuilder();
        FACTORY_ARRAY[5693] = new IfcColourRgbBuilder();
        FACTORY_ARRAY[5705] = new IfcDerivedUnitBuilder();
        FACTORY_ARRAY[5719] = new IfcInventoryBuilder();
        FACTORY_ARRAY[5769] = new IfcAlarmTypeBuilder();
        FACTORY_ARRAY[5771] = new IfcDocumentConfidentialityEnumBuilder();
        FACTORY_ARRAY[5785] = new IfcHourInDayBuilder();
        FACTORY_ARRAY[5794] = new IfcNullStyleBuilder();
        FACTORY_ARRAY[5814] = new IfcProcedureBuilder();
        FACTORY_ARRAY[5815] = new IfcCostValueBuilder();
        FACTORY_ARRAY[5839] = new IfcSpaceTypeBuilder();
        FACTORY_ARRAY[5862] = new IfcQuantityCountBuilder();
        FACTORY_ARRAY[5948] = new IfcTimeStampBuilder();
        FACTORY_ARRAY[5955] = new IfcStateEnumBuilder();
        FACTORY_ARRAY[6001] = new IfcReferencesValueDocumentBuilder();
        FACTORY_ARRAY[6008] = new IfcPlateTypeBuilder();
        FACTORY_ARRAY[6037] = new IfcPlanarBoxBuilder();
        FACTORY_ARRAY[6068] = new IfcDoorStyleBuilder();
        FACTORY_ARRAY[6082] = new IfcValveTypeBuilder();
        FACTORY_ARRAY[6167] = new IfcSoundPropertiesBuilder();
        FACTORY_ARRAY[6380] = new IfcPipeFittingTypeBuilder();
        FACTORY_ARRAY[6392] = new IfcDoorStyleConstructionEnumBuilder();
        FACTORY_ARRAY[6523] = new IfcTextLiteralBuilder();
        FACTORY_ARRAY[6598] = new IfcVolumetricFlowRateMeasureBuilder();
        FACTORY_ARRAY[6629] = new IfcClosedShellBuilder();
        FACTORY_ARRAY[6697] = new IfcBoundingBoxBuilder();
        FACTORY_ARRAY[6724] = new IfcRelSequenceBuilder();
        FACTORY_ARRAY[6754] = new IfcShapeAspectBuilder();
        FACTORY_ARRAY[6776] = new IfcJunctionBoxTypeBuilder();
        FACTORY_ARRAY[6788] = new IfcApplicationBuilder();
        FACTORY_ARRAY[6802] = new IfcPropertySetBuilder();
        FACTORY_ARRAY[6820] = new IfcVertexPointBuilder();
        FACTORY_ARRAY[6867] = new IfcCurtainWallBuilder();
        FACTORY_ARRAY[6912] = new IfcDiameterDimensionBuilder();
        FACTORY_ARRAY[6929] = new IfcSurfaceSideBuilder();
        FACTORY_ARRAY[6949] = new IfcStructuralProfilePropertiesBuilder();
        FACTORY_ARRAY[6992] = new IfcPolygonalBoundedHalfSpaceBuilder();
        FACTORY_ARRAY[7027] = new IfcDraughtingPreDefinedCurveFontBuilder();
        FACTORY_ARRAY[7034] = new IfcFlowFittingBuilder();
        FACTORY_ARRAY[7044] = new IfcWindowStyleBuilder();
        FACTORY_ARRAY[7060] = new IfcServiceLifeBuilder();
        FACTORY_ARRAY[7075] = new IfcPresentationLayerAssignmentBuilder();
        FACTORY_ARRAY[7146] = new IfcRailingTypeBuilder();
        FACTORY_ARRAY[7222] = new IfcCraneRailFShapeProfileDefBuilder();
        FACTORY_ARRAY[7266] = new IfcRelAssociatesDocumentBuilder();
        FACTORY_ARRAY[7330] = new IfcPostalAddressBuilder();
        FACTORY_ARRAY[7375] = new IfcTypeProductBuilder();
        FACTORY_ARRAY[7425] = new IfcTextStyleBuilder();
        FACTORY_ARRAY[7440] = new IfcRelAggregatesBuilder();
        FACTORY_ARRAY[7441] = new IfcDraughtingCalloutRelationshipBuilder();
        FACTORY_ARRAY[7465] = new IfcPermeableCoveringOperationEnumBuilder();
        FACTORY_ARRAY[7467] = new IfcIntegerBuilder();
        FACTORY_ARRAY[7621] = new IfcFurnitureTypeBuilder();
        FACTORY_ARRAY[7665] = new IfcGridPlacementBuilder();
        FACTORY_ARRAY[7746] = new IfcDerivedUnitEnumBuilder();
        FACTORY_ARRAY[7810] = new IfcAlarmTypeEnumBuilder();
        FACTORY_ARRAY[7849] = new IfcSpaceTypeEnumBuilder();
        FACTORY_ARRAY[7889] = new IfcVolumeMeasureBuilder();
        FACTORY_ARRAY[7898] = new IfcStructuralPlanarActionVaryingBuilder();
        FACTORY_ARRAY[8014] = new IfcPlateTypeEnumBuilder();
        FACTORY_ARRAY[8021] = new IfcTextureVertexBuilder();
        FACTORY_ARRAY[8033] = new IfcOffsetCurve2DBuilder();
        FACTORY_ARRAY[8047] = new IfcOffsetCurve3DBuilder();
        FACTORY_ARRAY[8052] = new IfcTextAlignmentBuilder();
        FACTORY_ARRAY[8128] = new IfcValveTypeEnumBuilder();
        FACTORY_ARRAY[8203] = new IfcProjectOrderRecordTypeEnumBuilder();
        FACTORY_ARRAY[8313] = new IfcDerivedProfileDefBuilder();
        FACTORY_ARRAY[8538] = new IfcDistributionChamberElementTypeBuilder();
        FACTORY_ARRAY[8620] = new IfcLightFixtureTypeEnumBuilder();
        FACTORY_ARRAY[8645] = new IfcMeasureWithUnitBuilder();
        FACTORY_ARRAY[8660] = new IfcPlaneAngleMeasureBuilder();
        FACTORY_ARRAY[8674] = new IfcBooleanOperatorBuilder();
        FACTORY_ARRAY[8705] = new IfcDuctFittingTypeBuilder();
        FACTORY_ARRAY[8736] = new IfcRelAssignsTasksBuilder();
        FACTORY_ARRAY[8737] = new IfcPipeSegmentTypeBuilder();
        FACTORY_ARRAY[8748] = new IfcFlowTreatmentDeviceBuilder();
        FACTORY_ARRAY[8750] = new IfcComplexPropertyBuilder();
        FACTORY_ARRAY[8767] = new IfcRelVoidsElementBuilder();
        FACTORY_ARRAY[8817] = new IfcJunctionBoxTypeEnumBuilder();
        FACTORY_ARRAY[8867] = new IfcRelFillsElementBuilder();
        FACTORY_ARRAY[8893] = new IfcAirTerminalTypeBuilder();
        FACTORY_ARRAY[8906] = new IfcRelCoversSpacesBuilder();
        FACTORY_ARRAY[8912] = new IfcSectionTypeEnumBuilder();
        FACTORY_ARRAY[8954] = new IfcCurtainWallTypeBuilder();
        FACTORY_ARRAY[8966] = new IfcLinearDimensionBuilder();
        FACTORY_ARRAY[9116] = new IfcMonetaryMeasureBuilder();
        FACTORY_ARRAY[9138] = new IfcProfileTypeEnumBuilder();
        FACTORY_ARRAY[9142] = new IfcFootingTypeEnumBuilder();
        FACTORY_ARRAY[9172] = new IfcElectricHeaterTypeEnumBuilder();
        FACTORY_ARRAY[9316] = new IfcTimeSeriesScheduleTypeEnumBuilder();
        FACTORY_ARRAY[9593] = new IfcBuildingElementProxyTypeBuilder();
        FACTORY_ARRAY[9598] = new IfcLightSourceDirectionalBuilder();
        FACTORY_ARRAY[9614] = new IfcTimeSeriesDataTypeEnumBuilder();
        FACTORY_ARRAY[9679] = new IfcIrregularTimeSeriesBuilder();
        FACTORY_ARRAY[9718] = new IfcDraughtingCalloutBuilder();
        FACTORY_ARRAY[9738] = new IfcServiceLifeFactorBuilder();
        FACTORY_ARRAY[9779] = new IfcRelAssignsToGroupBuilder();
        FACTORY_ARRAY[9792] = new IfcInductanceMeasureBuilder();
        FACTORY_ARRAY[9847] = new IfcSectionPropertiesBuilder();
        FACTORY_ARRAY[9866] = new IfcEquipmentStandardBuilder();
        FACTORY_ARRAY[9934] = new IfcSpecularRoughnessBuilder();
        FACTORY_ARRAY[9943] = new IfcHeatingValueMeasureBuilder();
        FACTORY_ARRAY[9967] = new IfcFurnishingElementBuilder();
        FACTORY_ARRAY[9992] = new IfcRegularTimeSeriesBuilder();
        FACTORY_ARRAY[10020] = new IfcRightCircularConeBuilder();
        FACTORY_ARRAY[10077] = new IfcWasteTerminalTypeBuilder();
        FACTORY_ARRAY[10088] = new IfcAccelerationMeasureBuilder();
        FACTORY_ARRAY[10106] = new IfcSoundPowerMeasureBuilder();
        FACTORY_ARRAY[10162] = new IfcProcedureTypeEnumBuilder();
        FACTORY_ARRAY[10173] = new IfcRelAssignsToActorBuilder();
        FACTORY_ARRAY[10174] = new IfcFurnitureStandardBuilder();
        FACTORY_ARRAY[10350] = new IfcMagneticFluxMeasureBuilder();
        FACTORY_ARRAY[10557] = new IfcIonConcentrationMeasureBuilder();
        FACTORY_ARRAY[10616] = new IfcDistributionChamberElementTypeEnumBuilder();
        FACTORY_ARRAY[10620] = new IfcThermalMaterialPropertiesBuilder();
        FACTORY_ARRAY[10694] = new IfcRelAssignsToProcessBuilder();
        FACTORY_ARRAY[10711] = new IfcAirTerminalTypeEnumBuilder();
        FACTORY_ARRAY[10768] = new IfcShapeRepresentationBuilder();
        FACTORY_ARRAY[10774] = new IfcThermalLoadTypeEnumBuilder();
        FACTORY_ARRAY[10778] = new IfcPipeSegmentTypeEnumBuilder();
        FACTORY_ARRAY[10796] = new IfcLuminousFluxMeasureBuilder();
        FACTORY_ARRAY[10797] = new IfcRelAssignsToControlBuilder();
        FACTORY_ARRAY[10871] = new IfcFlowDirectionEnumBuilder();
        FACTORY_ARRAY[10896] = new IfcPropertySingleValueBuilder();
        FACTORY_ARRAY[10968] = new IfcServiceLifeTypeEnumBuilder();
        FACTORY_ARRAY[10981] = new IfcStructuralLoadGroupBuilder();
        FACTORY_ARRAY[11022] = new IfcDocumentInformationBuilder();
        FACTORY_ARRAY[11024] = new IfcPropertyEnumerationBuilder();
        FACTORY_ARRAY[11032] = new IfcCurtainWallTypeEnumBuilder();
        FACTORY_ARRAY[11051] = new IfcShearModulusMeasureBuilder();
        FACTORY_ARRAY[11052] = new IfcScheduleTimeControlBuilder();
        FACTORY_ARRAY[11094] = new IfcLinearMomentMeasureBuilder();
        FACTORY_ARRAY[11133] = new IfcMotorConnectionTypeBuilder();
        FACTORY_ARRAY[11200] = new IfcProjectedOrTrueLengthEnumBuilder();
        FACTORY_ARRAY[11208] = new IfcRailingTypeEnumBuilder();
        FACTORY_ARRAY[11213] = new IfcPresentableTextBuilder();
        FACTORY_ARRAY[11397] = new IfcCurveBoundedPlaneBuilder();
        FACTORY_ARRAY[11460] = new IfcStructuralPointActionBuilder();
        FACTORY_ARRAY[11635] = new IfcBuildingElementProxyTypeEnumBuilder();
        FACTORY_ARRAY[11770] = new IfcCableCarrierSegmentTypeEnumBuilder();
        FACTORY_ARRAY[11780] = new IfcCableCarrierSegmentTypeBuilder();
        FACTORY_ARRAY[11903] = new IfcRelCoversBldgElementsBuilder();
        FACTORY_ARRAY[12004] = new IfcRightCircularCylinderBuilder();
        FACTORY_ARRAY[12054] = new IfcFurnishingElementTypeBuilder();
        FACTORY_ARRAY[12132] = new IfcLinearVelocityMeasureBuilder();
        FACTORY_ARRAY[12151] = new IfcWasteTerminalTypeEnumBuilder();
        FACTORY_ARRAY[12158] = new IfcSectionModulusMeasureBuilder();
        FACTORY_ARRAY[12173] = new IfcStructuralSurfaceMemberBuilder();
        FACTORY_ARRAY[12182] = new IfcStructuralResultGroupBuilder();
        FACTORY_ARRAY[12194] = new IfcAnalysisModelTypeEnumBuilder();
        FACTORY_ARRAY[12241] = new IfcCurveStyleFontPatternBuilder();
        FACTORY_ARRAY[12270] = new IfcProjectOrderRecordBuilder();
        FACTORY_ARRAY[12346] = new IfcCooledBeamTypeEnumBuilder();
        FACTORY_ARRAY[12381] = new IfcCompoundPlaneAngleMeasureBuilder();
        FACTORY_ARRAY[12464] = new IfcDimensionalExponentsBuilder();
        FACTORY_ARRAY[12494] = new IfcGloballyUniqueIdBuilder();
        FACTORY_ARRAY[12576] = new IfcIlluminanceMeasureBuilder();
        FACTORY_ARRAY[12681] = new IfcElectricCapacitanceMeasureBuilder();
        FACTORY_ARRAY[12697] = new IfcPositiveRatioMeasureBuilder();
        FACTORY_ARRAY[12730] = new TimeStampTextBuilder();
        FACTORY_ARRAY[12794] = new IfcDuctFittingTypeEnumBuilder();
        FACTORY_ARRAY[13008] = new IfcStructuralPointReactionBuilder();
        FACTORY_ARRAY[13079] = new IfcAnnotationFillAreaOccurrenceBuilder();
        FACTORY_ARRAY[13112] = new IfcStructuralCurveTypeEnumBuilder();
        FACTORY_ARRAY[13170] = new IfcPropertyEnumeratedValueBuilder();
        FACTORY_ARRAY[13174] = new IfcMotorConnectionTypeEnumBuilder();
        FACTORY_ARRAY[13199] = new IfcWindowPanelPositionEnumBuilder();
        FACTORY_ARRAY[13270] = new IfcElectricHeaterTypeBuilder();
        FACTORY_ARRAY[13352] = new IfcFaceOuterBoundBuilder();
        FACTORY_ARRAY[13429] = new IfcStructuralLoadTemperatureBuilder();
        FACTORY_ARRAY[13595] = new IfcSIUnitNameBuilder();
        FACTORY_ARRAY[13633] = new IfcClassificationBuilder();
        FACTORY_ARRAY[13771] = new IfcStructuralCurveConnectionBuilder();
        FACTORY_ARRAY[13779] = new IfcStructuralLoadLinearForceBuilder();
        FACTORY_ARRAY[13831] = new IfcServiceLifeFactorTypeEnumBuilder();
        FACTORY_ARRAY[13856] = new IfcApprovalActorRelationshipBuilder();
        FACTORY_ARRAY[13859] = new IfcCraneRailAShapeProfileDefBuilder();
        FACTORY_ARRAY[13865] = new IfcStructuralLoadSingleForceBuilder();
        FACTORY_ARRAY[13871] = new IfcStructuralLoadPlanarForceBuilder();
        FACTORY_ARRAY[13874] = new IfcOpticalMaterialPropertiesBuilder();
        FACTORY_ARRAY[14125] = new IfcContextDependentMeasureBuilder();
        FACTORY_ARRAY[14151] = new IfcRelConnectsWithEccentricityBuilder();
        FACTORY_ARRAY[14185] = new IfcStructuralPointConnectionBuilder();
        FACTORY_ARRAY[14201] = new IfcMaterialLayerSetBuilder();
        FACTORY_ARRAY[14436] = new IfcAnnotationFillAreaBuilder();
        FACTORY_ARRAY[14614] = new IfcProductDefinitionShapeBuilder();
        FACTORY_ARRAY[14643] = new IfcDistributionChamberElementBuilder();
        FACTORY_ARRAY[14771] = new IfcLightFixtureTypeBuilder();
        FACTORY_ARRAY[14845] = new IfcElectricConductanceMeasureBuilder();
        FACTORY_ARRAY[14856] = new IfcWindowStyleConstructionEnumBuilder();
        FACTORY_ARRAY[15039] = new IfcConstructionEquipmentResourceBuilder();
        FACTORY_ARRAY[15088] = new IfcElementCompositionEnumBuilder();
        FACTORY_ARRAY[15125] = new IfcArbitraryOpenProfileDefBuilder();
        FACTORY_ARRAY[15301] = new IfcArbitraryClosedProfileDefBuilder();
        FACTORY_ARRAY[15424] = new IfcTimeSeriesScheduleBuilder();
        FACTORY_ARRAY[15540] = new IfcFillAreaStyleTilesBuilder();
        FACTORY_ARRAY[15554] = new IfcClassificationItemBuilder();
        FACTORY_ARRAY[15643] = new IfcLightSourceAmbientBuilder();
        FACTORY_ARRAY[15664] = new IfcRepresentationBuilder();
        FACTORY_ARRAY[15734] = new IfcBuildingElementProxyBuilder();
        FACTORY_ARRAY[15758] = new IfcProjectOrderTypeEnumBuilder();
        FACTORY_ARRAY[15762] = new IfcWindowPanelPropertiesBuilder();
        FACTORY_ARRAY[16037] = new IfcHygroscopicMaterialPropertiesBuilder();
        FACTORY_ARRAY[16058] = new IfcMassPerLengthMeasureBuilder();
        FACTORY_ARRAY[16541] = new IfcElectricTimeControlTypeEnumBuilder();
        FACTORY_ARRAY[16721] = new IfcTimeSeriesReferenceRelationshipBuilder();
        FACTORY_ARRAY[16901] = new IfcPresentationStyleAssignmentBuilder();
        FACTORY_ARRAY[16921] = new IfcStructuralLinearActionVaryingBuilder();
        FACTORY_ARRAY[16961] = new IfcMechanicalSteelMaterialPropertiesBuilder();
        FACTORY_ARRAY[17095] = new IfcEnvironmentalImpactCategoryEnumBuilder();
        FACTORY_ARRAY[17595] = new IfcPreDefinedDimensionSymbolBuilder();
        FACTORY_ARRAY[17917] = new IfcClassificationNotationBuilder();
        FACTORY_ARRAY[18001] = new IfcTextStyleWithBoxCharacteristicsBuilder();
        FACTORY_ARRAY[19016] = new IfcIsothermalMoistureCapacityMeasureBuilder();
        FACTORY_ARRAY[19747] = new IfcLightSourceGoniometricBuilder();
        FACTORY_ARRAY[20574] = new IfcStairFlightTypeEnumBuilder();
        FACTORY_ARRAY[20851] = new IfcFireSuppressionTerminalTypeBuilder();
        FACTORY_ARRAY[21495] = new IfcGlobalOrLocalEnumBuilder();
        FACTORY_ARRAY[21525] = new IfcHeatExchangerTypeEnumBuilder();
        FACTORY_ARRAY[21670] = new IfcStackTerminalTypeEnumBuilder();
        FACTORY_ARRAY[21936] = new IfcAnnotationSurfaceOccurrenceBuilder();
        FACTORY_ARRAY[22124] = new IfcFireSuppressionTerminalTypeEnumBuilder();
        FACTORY_ARRAY[22660] = new IfcElectricTimeControlTypeBuilder();
        FACTORY_ARRAY[22848] = new IfcPreDefinedPointMarkerSymbolBuilder();
        FACTORY_ARRAY[24022] = new IfcGeometricRepresentationSubContextBuilder();
        FACTORY_ARRAY[24232] = new IfcCartesianTransformationOperator3DBuilder();
        FACTORY_ARRAY[24249] = new IfcCartesianTransformationOperator2DBuilder();
        FACTORY_ARRAY[24629] = new IfcElectricCurrentEnumBuilder();
        FACTORY_ARRAY[24842] = new IfcWaterPropertiesBuilder();
        FACTORY_ARRAY[25180] = new IfcLoadGroupTypeEnumBuilder();
        FACTORY_ARRAY[25552] = new IfcObjectiveEnumBuilder();
        FACTORY_ARRAY[25577] = new IfcAheadOrBehindBuilder();
        FACTORY_ARRAY[25588] = new IfcEvaporativeCoolerTypeEnumBuilder();
        FACTORY_ARRAY[25596] = new IfcHeatExchangerTypeBuilder();
        FACTORY_ARRAY[25641] = new IfcRelAssociatesAppliedValueBuilder();
        FACTORY_ARRAY[25723] = new IfcElectricMotorTypeEnumBuilder();
        FACTORY_ARRAY[25765] = new IfcRelConnectsStructuralActivityBuilder();
        FACTORY_ARRAY[25807] = new IfcCondenserTypeBuilder();
        FACTORY_ARRAY[25848] = new IfcExtrudedAreaSolidBuilder();
        FACTORY_ARRAY[25887] = new IfcEllipseProfileDefBuilder();
        FACTORY_ARRAY[25888] = new IfcAnnotationSurfaceBuilder();
        FACTORY_ARRAY[25938] = new IfcFlowMeterTypeEnumBuilder();
        FACTORY_ARRAY[25997] = new IfcStairTypeEnumBuilder();
        FACTORY_ARRAY[26244] = new IfcExternallyDefinedSymbolBuilder();
        FACTORY_ARRAY[26627] = new IfcRevolvedAreaSolidBuilder();
        FACTORY_ARRAY[26638] = new IfcSubContractResourceBuilder();
        FACTORY_ARRAY[26725] = new IfcStairFlightTypeBuilder();
        FACTORY_ARRAY[26824] = new IfcElementAssemblyTypeEnumBuilder();
        FACTORY_ARRAY[26954] = new IfcGeometricProjectionEnumBuilder();
        FACTORY_ARRAY[27103] = new IfcElectricResistanceMeasureBuilder();
        FACTORY_ARRAY[27227] = new IfcMassFlowRateMeasureBuilder();
        FACTORY_ARRAY[27466] = new IfcVirtualGridIntersectionBuilder();
        FACTORY_ARRAY[27587] = new IfcAssemblyPlaceEnumBuilder();
        FACTORY_ARRAY[27816] = new IfcCondenserTypeEnumBuilder();
        FACTORY_ARRAY[27856] = new IfcStackTerminalTypeBuilder();
        FACTORY_ARRAY[27901] = new IfcRotationalMassMeasureBuilder();
        FACTORY_ARRAY[28044] = new IfcRibPlateDirectionEnumBuilder();
        FACTORY_ARRAY[28095] = new IfcDoorPanelPositionEnumBuilder();
        FACTORY_ARRAY[28641] = new IfcSubedgeBuilder();
        FACTORY_ARRAY[28652] = new IfcFacetedBrepBuilder();
        FACTORY_ARRAY[28727] = new IfcRelAssociatesConstraintBuilder();
        FACTORY_ARRAY[28779] = new IfcLogicalBuilder();
        FACTORY_ARRAY[28793] = new IfcCompositeCurveSegmentBuilder();
        FACTORY_ARRAY[28828] = new IfcFaceSurfaceBuilder();
        FACTORY_ARRAY[28903] = new IfcFlowSegmentBuilder();
        FACTORY_ARRAY[28937] = new IfcRelConnectsPathElementsBuilder();
        FACTORY_ARRAY[28959] = new IfcAreaMeasureBuilder();
        FACTORY_ARRAY[29064] = new IfcFontVariantBuilder();
        FACTORY_ARRAY[29072] = new IfcFanTypeEnumBuilder();
        FACTORY_ARRAY[29084] = new IfcChillerTypeBuilder();
        FACTORY_ARRAY[29105] = new IfcReflectanceMethodEnumBuilder();
        FACTORY_ARRAY[29117] = new IfcTextStyleForDefinedFontBuilder();
        FACTORY_ARRAY[29199] = new IfcLightDistributionDataBuilder();
        FACTORY_ARRAY[29235] = new IfcCartesianTransformationOperator3DnonUniformBuilder();
        FACTORY_ARRAY[29289] = new IfcExternallyDefinedTextFontBuilder();
        FACTORY_ARRAY[29347] = new IfcCartesianTransformationOperator2DnonUniformBuilder();
        FACTORY_ARRAY[29463] = new IfcConnectionPointGeometryBuilder();
        FACTORY_ARRAY[29686] = new IfcEvaporativeCoolerTypeBuilder();
        FACTORY_ARRAY[29687] = new IfcObjectiveBuilder();
        FACTORY_ARRAY[29719] = new IfcRelAssociatesApprovalBuilder();
        FACTORY_ARRAY[29721] = new IfcFaceBoundBuilder();
        FACTORY_ARRAY[29844] = new IfcRelAssociatesMaterialBuilder();
        FACTORY_ARRAY[29872] = new IfcVibrationIsolatorTypeBuilder();
        FACTORY_ARRAY[29880] = new IfcRelReferencedInSpatialStructureBuilder();
        FACTORY_ARRAY[29918] = new IfcFluidFlowPropertiesBuilder();
        FACTORY_ARRAY[29948] = new IfcDateAndTimeBuilder();
        FACTORY_ARRAY[30009] = new IfcTransformerTypeEnumBuilder();
        FACTORY_ARRAY[30014] = new STRINGBuilder();
        FACTORY_ARRAY[30057] = new IfcEdgeCurveBuilder();
        FACTORY_ARRAY[30093] = new IfcStairBuilder();
        FACTORY_ARRAY[30102] = new IfcBoundaryNodeConditionBuilder();
        FACTORY_ARRAY[30114] = new IfcAssetBuilder();
        FACTORY_ARRAY[30125] = new IfcActorRoleBuilder();
        FACTORY_ARRAY[30137] = new IfcBlockBuilder();
        FACTORY_ARRAY[30141] = new IfcCableCarrierFittingTypeBuilder();
        FACTORY_ARRAY[30326] = new IfcTimeMeasureBuilder();
        FACTORY_ARRAY[30418] = new IfcPositivePlaneAngleMeasureBuilder();
        FACTORY_ARRAY[30588] = new IfcExternallyDefinedHatchStyleBuilder();
        FACTORY_ARRAY[30668] = new IfcGasTerminalTypeBuilder();
        FACTORY_ARRAY[30785] = new IfcTorqueMeasureBuilder();
        FACTORY_ARRAY[30786] = new IfcStairFlightBuilder();
        FACTORY_ARRAY[30862] = new IfcLengthMeasureBuilder();
        FACTORY_ARRAY[30902] = new IfcConnectionPointEccentricityBuilder();
        FACTORY_ARRAY[30904] = new IfcElementQuantityBuilder();
        FACTORY_ARRAY[30908] = new IfcConstructionProductResourceBuilder();
        FACTORY_ARRAY[30915] = new IfcElementAssemblyBuilder();
        FACTORY_ARRAY[31046] = new IfcRelConnectsStructuralMemberBuilder();
        FACTORY_ARRAY[31079] = new IfcSymbolStyleBuilder();
        FACTORY_ARRAY[31157] = new IfcChillerTypeEnumBuilder();
        FACTORY_ARRAY[31187] = new IfcMassMeasureBuilder();
        FACTORY_ARRAY[31237] = new IfcDimensionPairBuilder();
        FACTORY_ARRAY[31339] = new IfcActionRequestBuilder();
        FACTORY_ARRAY[31343] = new IfcDimensionCurveDirectedCalloutBuilder();
        FACTORY_ARRAY[31346] = new IfcDuctSegmentTypeBuilder();
        FACTORY_ARRAY[31539] = new IfcElectricalElementBuilder();
        FACTORY_ARRAY[31617] = new IfcDiscreteAccessoryBuilder();
        FACTORY_ARRAY[31753] = new IfcRectangularTrimmedSurfaceBuilder();
        FACTORY_ARRAY[31810] = new IfcKinematicViscosityMeasureBuilder();
        FACTORY_ARRAY[31873] = new IfcElectricMotorTypeBuilder();
        FACTORY_ARRAY[31913] = new IfcVibrationIsolatorTypeEnumBuilder();
        FACTORY_ARRAY[31942] = new IfcDefinedSymbolBuilder();
        FACTORY_ARRAY[31959] = new IfcCableCarrierFittingTypeEnumBuilder();
        FACTORY_ARRAY[31962] = new SchemaNameBuilder();
        FACTORY_ARRAY[32013] = new IfcConditionBuilder();
        FACTORY_ARRAY[32024] = new IfcBenchmarkEnumBuilder();
        FACTORY_ARRAY[32052] = new IfcExternallyDefinedSurfaceStyleBuilder();
        FACTORY_ARRAY[32089] = new IfcFlowMeterTypeBuilder();
        FACTORY_ARRAY[32166] = new IfcIntegerCountRateMeasureBuilder();
        FACTORY_ARRAY[32239] = new IfcProjectionCurveBuilder();
        FACTORY_ARRAY[32253] = new IfcGeneralMaterialPropertiesBuilder();
        FACTORY_ARRAY[32317] = new IfcLocalTimeBuilder();
        FACTORY_ARRAY[32333] = new IfcDistributionElementBuilder();
        FACTORY_ARRAY[32366] = new IfcBlobTextureBuilder();
        FACTORY_ARRAY[32435] = new IfcOrderActionBuilder();
        FACTORY_ARRAY[32442] = new IfcFillAreaStyleBuilder();
        FACTORY_ARRAY[32542] = new IfcMaterialLayerBuilder();
        FACTORY_ARRAY[32552] = new IfcConnectionSurfaceGeometryBuilder();
        FACTORY_ARRAY[32618] = new IfcAddressTypeEnumBuilder();
        FACTORY_ARRAY[32677] = new IfcGasTerminalTypeEnumBuilder();
        FACTORY_ARRAY[32699] = new IfcAbsorbedDoseMeasureBuilder();
        FACTORY_ARRAY[32758] = new IfcStructuralLinearActionBuilder();
        FACTORY_ARRAY[32809] = new IfcThermalResistanceMeasureBuilder();
        FACTORY_ARRAY[32812] = new IfcUnitaryEquipmentTypeEnumBuilder();
        FACTORY_ARRAY[32925] = new IfcRelAssignsToProjectOrderBuilder();
        FACTORY_ARRAY[32934] = new IfcAppliedValueRelationshipBuilder();
        FACTORY_ARRAY[33080] = new IfcTransportElementTypeEnumBuilder();
        FACTORY_ARRAY[33089] = new IfcReinforcementDefinitionPropertiesBuilder();
        FACTORY_ARRAY[33116] = new IfcRelConnectsWithRealizingElementsBuilder();
        FACTORY_ARRAY[33180] = new IfcWindowStyleOperationEnumBuilder();
        FACTORY_ARRAY[33271] = new IfcElectricalCircuitBuilder();
        FACTORY_ARRAY[33440] = new IfcGeometricCurveSetBuilder();
        FACTORY_ARRAY[33465] = new IfcProjectionElementBuilder();
        FACTORY_ARRAY[33467] = new IfcTimeSeriesValueBuilder();
        FACTORY_ARRAY[33474] = new IfcDoorPanelPropertiesBuilder();
        FACTORY_ARRAY[33643] = new IfcDuctSegmentTypeEnumBuilder();
        FACTORY_ARRAY[33697] = new IfcElectricApplianceTypeBuilder();
        FACTORY_ARRAY[33704] = new IfcDiscreteAccessoryTypeBuilder();
        FACTORY_ARRAY[33711] = new IfcLightSourceSpotBuilder();
        FACTORY_ARRAY[33786] = new IfcPropertySourceEnumBuilder();
        FACTORY_ARRAY[33894] = new IfcModulusOfElasticityMeasureBuilder();
        FACTORY_ARRAY[33942] = new IfcAnalysisTheoryTypeEnumBuilder();
        FACTORY_ARRAY[33994] = new IfcInternalOrExternalEnumBuilder();
        FACTORY_ARRAY[34047] = new IfcSystemFurnitureElementTypeBuilder();
        FACTORY_ARRAY[34064] = new IfcModulusOfSubgradeReactionMeasureBuilder();
        FACTORY_ARRAY[34069] = new IfcIrregularTimeSeriesValueBuilder();
        FACTORY_ARRAY[34090] = new IfcNormalisedRatioMeasureBuilder();
        FACTORY_ARRAY[34103] = new IfcFlowInstrumentTypeEnumBuilder();
        FACTORY_ARRAY[34124] = new IfcDoorStyleOperationEnumBuilder();
        FACTORY_ARRAY[34161] = new IfcPropertyReferenceValueBuilder();
        FACTORY_ARRAY[34201] = new IfcAirTerminalBoxTypeEnumBuilder();
        FACTORY_ARRAY[34242] = new IfcWindowLiningPropertiesBuilder();
        FACTORY_ARRAY[34275] = new IfcBuildingElementPartBuilder();
        FACTORY_ARRAY[34655] = new IfcDocumentElectronicFormatBuilder();
        FACTORY_ARRAY[34682] = new IfcLogicalOperatorEnumBuilder();
        FACTORY_ARRAY[34699] = new IfcShellBasedSurfaceModelBuilder();
        FACTORY_ARRAY[34721] = new IfcDistributionFlowElementBuilder();
        FACTORY_ARRAY[35047] = new IfcApprovalPropertyRelationshipBuilder();
        FACTORY_ARRAY[35071] = new IfcClassificationReferenceBuilder();
        FACTORY_ARRAY[35086] = new IfcDraughtingPreDefinedTextFontBuilder();
        FACTORY_ARRAY[35100] = new IfcSpecificHeatCapacityMeasureBuilder();
        FACTORY_ARRAY[35234] = new IfcStructuralSurfaceMemberVaryingBuilder();
        FACTORY_ARRAY[35420] = new IfcRelInteractionRequirementsBuilder();
        FACTORY_ARRAY[35474] = new IfcRelContainedInSpatialStructureBuilder();
        FACTORY_ARRAY[35554] = new IfcElectricGeneratorTypeBuilder();
        FACTORY_ARRAY[35582] = new IfcMaterialLayerSetUsageBuilder();
        FACTORY_ARRAY[35614] = new IfcRibPlateProfilePropertiesBuilder();
        FACTORY_ARRAY[35655] = new IfcPositiveLengthMeasureBuilder();
        FACTORY_ARRAY[35707] = new IfcElectricChargeMeasureBuilder();
        FACTORY_ARRAY[35713] = new IfcTextureCoordinateGeneratorBuilder();
        FACTORY_ARRAY[35739] = new IfcElectricApplianceTypeEnumBuilder();
        FACTORY_ARRAY[35786] = new File_DescriptionBuilder();
        FACTORY_ARRAY[35791] = new IfcSurfaceCurveSweptAreaSolidBuilder();
        FACTORY_ARRAY[36468] = new IfcDistributionElementTypeBuilder();
        FACTORY_ARRAY[36549] = new IfcFillAreaStyleHatchingBuilder();
        FACTORY_ARRAY[36583] = new IfcPersonAndOrganizationBuilder();
        FACTORY_ARRAY[36629] = new IfcLightSourcePositionalBuilder();
        FACTORY_ARRAY[36812] = new IfcEnergyPropertiesBuilder();
        FACTORY_ARRAY[36818] = new IfcRelSpaceBoundaryBuilder();
        FACTORY_ARRAY[36826] = new IfcEquipmentElementBuilder();
        FACTORY_ARRAY[36839] = new IfcSpecularExponentBuilder();
        FACTORY_ARRAY[36875] = new IfcLuminousIntensityDistributionMeasureBuilder();
        FACTORY_ARRAY[36908] = new IfcHeatFluxDensityMeasureBuilder();
        FACTORY_ARRAY[36919] = new IfcCoveringTypeEnumBuilder();
        FACTORY_ARRAY[36938] = new IfcRoundedRectangleProfileDefBuilder();
        FACTORY_ARRAY[37027] = new IfcSanitaryTerminalTypeBuilder();
        FACTORY_ARRAY[37098] = new IfcCurvatureMeasureBuilder();
        FACTORY_ARRAY[37108] = new IfcTransportElementBuilder();
        FACTORY_ARRAY[37117] = new IfcOccupantTypeEnumBuilder();
        FACTORY_ARRAY[37126] = new IfcUShapeProfileDefBuilder();
        FACTORY_ARRAY[37136] = new IfcZShapeProfileDefBuilder();
        FACTORY_ARRAY[37181] = new IfcTShapeProfileDefBuilder();
        FACTORY_ARRAY[37226] = new IfcBSplineCurveFormBuilder();
        FACTORY_ARRAY[37257] = new IfcLShapeProfileDefBuilder();
        FACTORY_ARRAY[37344] = new IfcElectricGeneratorTypeEnumBuilder();
        FACTORY_ARRAY[37416] = new IfcProductRepresentationBuilder();
        FACTORY_ARRAY[37432] = new IfcThermalExpansionCoefficientMeasureBuilder();
        FACTORY_ARRAY[37544] = new IfcElectricDistributionPointBuilder();
        FACTORY_ARRAY[37556] = new IfcAnnotationCurveOccurrenceBuilder();
        FACTORY_ARRAY[37618] = new IfcResourceConsumptionEnumBuilder();
        FACTORY_ARRAY[37688] = new IfcPhysicalComplexQuantityBuilder();
        FACTORY_ARRAY[37785] = new IfcMechanicalFastenerBuilder();
        FACTORY_ARRAY[37846] = new IfcConnectedFaceSetBuilder();
        FACTORY_ARRAY[37855] = new IfcUnitAssignmentBuilder();
        FACTORY_ARRAY[37928] = new IfcEvaporatorTypeEnumBuilder();
        FACTORY_ARRAY[37942] = new IfcAxis1PlacementBuilder();
        FACTORY_ARRAY[37959] = new IfcFuelPropertiesBuilder();
        FACTORY_ARRAY[37978] = new IfcLightEmissionSourceEnumBuilder();
        FACTORY_ARRAY[37991] = new IfcThermalAdmittanceMeasureBuilder();
        FACTORY_ARRAY[38017] = new IfcFlowControllerBuilder();
        FACTORY_ARRAY[38027] = new IfcSensorTypeEnumBuilder();
        FACTORY_ARRAY[38030] = new IfcMemberTypeEnumBuilder();
        FACTORY_ARRAY[38032] = new IfcConstraintEnumBuilder();
        FACTORY_ARRAY[38050] = new IfcTransitionCodeBuilder();
        FACTORY_ARRAY[38053] = new IfcRampFlightTypeBuilder();
        FACTORY_ARRAY[38059] = new IfcWallStandardCaseBuilder();
        FACTORY_ARRAY[38087] = new IfcNumericMeasureBuilder();
        FACTORY_ARRAY[38090] = new IfcSoundScaleEnumBuilder();
        FACTORY_ARRAY[38102] = new IfcConstraintClassificationRelationshipBuilder();
        FACTORY_ARRAY[38121] = new IfcColumnTypeEnumBuilder();
        FACTORY_ARRAY[38135] = new IfcBoilerTypeEnumBuilder();
        FACTORY_ARRAY[38158] = new IfcTendonTypeEnumBuilder();
        FACTORY_ARRAY[38163] = new IfcCompressorTypeEnumBuilder();
        FACTORY_ARRAY[38176] = new IfcQuantityWeightBuilder();
        FACTORY_ARRAY[38230] = new IfcQuantityVolumeBuilder();
        FACTORY_ARRAY[38237] = new IfcCenterLineProfileDefBuilder();
        FACTORY_ARRAY[38304] = new IfcPresentationLayerWithStyleBuilder();
        FACTORY_ARRAY[38323] = new IfcQuantityLengthBuilder();
        FACTORY_ARRAY[38332] = new IfcControllerTypeBuilder();
        FACTORY_ARRAY[38715] = new IfcCurveStyleFontBuilder();
        FACTORY_ARRAY[38722] = new IfcYearNumberBuilder();
        FACTORY_ARRAY[38798] = new IfcChamferEdgeFeatureBuilder();
        FACTORY_ARRAY[38834] = new IfcDynamicViscosityMeasureBuilder();
        FACTORY_ARRAY[38836] = new IfcRepresentationContextBuilder();
        FACTORY_ARRAY[38920] = new IfcPileConstructionEnumBuilder();
        FACTORY_ARRAY[38925] = new IfcEnvironmentalImpactValueBuilder();
        FACTORY_ARRAY[38958] = new IfcUnitaryEquipmentTypeBuilder();
        FACTORY_ARRAY[38992] = new IfcPropertyBoundedValueBuilder();
        FACTORY_ARRAY[38999] = new IfcThermalConductivityMeasureBuilder();
        FACTORY_ARRAY[39051] = new IfcTextStyleTextModelBuilder();
        FACTORY_ARRAY[39068] = new IfcSanitaryTerminalTypeEnumBuilder();
        FACTORY_ARRAY[39070] = new IfcApprovalRelationshipBuilder();
        FACTORY_ARRAY[39199] = new IfcTransportElementTypeBuilder();
        FACTORY_ARRAY[39213] = new IfcRelServicesBuildingsBuilder();
        FACTORY_ARRAY[39231] = new IfcCurrencyRelationshipBuilder();
        FACTORY_ARRAY[39251] = new IfcLibraryReferenceBuilder();
        FACTORY_ARRAY[39332] = new IfcRelAssignsToResourceBuilder();
        FACTORY_ARRAY[39350] = new IfcArithmeticOperatorEnumBuilder();
        FACTORY_ARRAY[39589] = new IfcTopologyRepresentationBuilder();
        FACTORY_ARRAY[39612] = new IfcAngularVelocityMeasureBuilder();
        FACTORY_ARRAY[39733] = new IfcStructuralPlanarActionBuilder();
        FACTORY_ARRAY[39872] = new IfcMechanicalFastenerTypeBuilder();
        FACTORY_ARRAY[39924] = new IfcPlanarForceMeasureBuilder();
        FACTORY_ARRAY[40047] = new IfcDocumentStatusEnumBuilder();
        FACTORY_ARRAY[40072] = new IfcLinearStiffnessMeasureBuilder();
        FACTORY_ARRAY[40127] = new IfcRampFlightTypeEnumBuilder();
        FACTORY_ARRAY[40180] = new IfcSurfaceTextureEnumBuilder();
        FACTORY_ARRAY[40203] = new IfcDirectionSenseEnumBuilder();
        FACTORY_ARRAY[40222] = new IfcFlowInstrumentTypeBuilder();
        FACTORY_ARRAY[40291] = new IfcEnergySequenceEnumBuilder();
        FACTORY_ARRAY[40352] = new IfcAirTerminalBoxTypeBuilder();
        FACTORY_ARRAY[40370] = new IfcControllerTypeEnumBuilder();
        FACTORY_ARRAY[40607] = new IfcLayerSetDirectionEnumBuilder();
        FACTORY_ARRAY[40735] = new IfcContextDependentUnitBuilder();
        FACTORY_ARRAY[40951] = new IfcCoveringBuilder();
        FACTORY_ARRAY[40967] = new IfcVaporPermeabilityMeasureBuilder();
        FACTORY_ARRAY[41003] = new IfcUnitEnumBuilder();
        FACTORY_ARRAY[41022] = new IfcSIPrefixBuilder();
        FACTORY_ARRAY[41056] = new IfcPlanarExtentBuilder();
        FACTORY_ARRAY[41078] = new IfcGridAxisBuilder();
        FACTORY_ARRAY[41091] = new IfcRelNestsBuilder();
        FACTORY_ARRAY[41111] = new IfcApprovalBuilder();
        FACTORY_ARRAY[41131] = new IfcCsgSolidBuilder();
        FACTORY_ARRAY[41133] = new IfcSurfaceStyleLightingBuilder();
        FACTORY_ARRAY[41134] = new IfcWorkPlanBuilder();
        FACTORY_ARRAY[41145] = new IfcCostItemBuilder();
        FACTORY_ARRAY[41149] = new IfcOccupantBuilder();
        FACTORY_ARRAY[41177] = new IfcSlabTypeBuilder();
        FACTORY_ARRAY[41212] = new IfcPolyLoopBuilder();
        FACTORY_ARRAY[41244] = new IfcWallTypeBuilder();
        FACTORY_ARRAY[41247] = new IfcCoilTypeBuilder();
        FACTORY_ARRAY[41283] = new IfcPolylineBuilder();
        FACTORY_ARRAY[41287] = new IfcPumpTypeBuilder();
        FACTORY_ARRAY[41364] = new IfcPropertyDependencyRelationshipBuilder();
        FACTORY_ARRAY[41374] = new IfcTextPathBuilder();
        FACTORY_ARRAY[41386] = new IfcRoleEnumBuilder();
        FACTORY_ARRAY[41414] = new IfcSurfaceOfLinearExtrusionBuilder();
        FACTORY_ARRAY[41490] = new IfcWindowPanelOperationEnumBuilder();
        FACTORY_ARRAY[41595] = new IfcPermeableCoveringPropertiesBuilder();
        FACTORY_ARRAY[41743] = new IfcLuminousIntensityMeasureBuilder();
        FACTORY_ARRAY[41752] = new IfcAirToAirHeatRecoveryTypeBuilder();
        FACTORY_ARRAY[41862] = new IfcDraughtingPreDefinedColourBuilder();
        FACTORY_ARRAY[41879] = new IfcTypeObjectBuilder();
        FACTORY_ARRAY[42066] = new IfcVertexBuilder();
        FACTORY_ARRAY[42080] = new IfcOutletTypeBuilder();
        FACTORY_ARRAY[42084] = new IfcVectorBuilder();
        FACTORY_ARRAY[42098] = new IfcSurfaceStyleRefractionBuilder();
        FACTORY_ARRAY[42129] = new IfcMemberBuilder();
        FACTORY_ARRAY[42212] = new IfcColumnBuilder();
        FACTORY_ARRAY[42257] = new IfcTendonBuilder();
        FACTORY_ARRAY[42283] = new IfcFilterTypeBuilder();
        FACTORY_ARRAY[42293] = new IfcSystemBuilder();
        FACTORY_ARRAY[42334] = new File_NameBuilder();
        FACTORY_ARRAY[42377] = new IfcWindowBuilder();
        FACTORY_ARRAY[42417] = new IfcMetricBuilder();
        FACTORY_ARRAY[42521] = new IfcCalendarDateBuilder();
        FACTORY_ARRAY[42565] = new IfcTankTypeBuilder();
        FACTORY_ARRAY[42648] = new IfcModulusOfRotationalSubgradeReactionMeasureBuilder();
        FACTORY_ARRAY[42698] = new IfcAmountOfSubstanceMeasureBuilder();
        FACTORY_ARRAY[42709] = new IfcQuantityAreaBuilder();
        FACTORY_ARRAY[42988] = new IfcRampTypeEnumBuilder();
        FACTORY_ARRAY[43038] = new IfcCoveringTypeBuilder();
        FACTORY_ARRAY[43048] = new IfcPowerMeasureBuilder();
        FACTORY_ARRAY[43053] = new IfcCurrencyEnumBuilder();
        FACTORY_ARRAY[43059] = new IfcTextFontNameBuilder();
        FACTORY_ARRAY[43129] = new IfcTextDecorationBuilder();
        FACTORY_ARRAY[43133] = new IfcOwnerHistoryBuilder();
        FACTORY_ARRAY[43148] = new IfcTendonAnchorBuilder();
        FACTORY_ARRAY[43149] = new IfcRatioMeasureBuilder();
        FACTORY_ARRAY[43154] = new IfcTemperatureGradientMeasureBuilder();
        FACTORY_ARRAY[43216] = new IfcMonetaryUnitBuilder();
        FACTORY_ARRAY[43219] = new IfcSlabTypeEnumBuilder();
        FACTORY_ARRAY[43226] = new IfcCountMeasureBuilder();
        FACTORY_ARRAY[43249] = new IfcSpaceProgramBuilder();
        FACTORY_ARRAY[43259] = new IfcRoofTypeEnumBuilder();
        FACTORY_ARRAY[43282] = new IfcWallTypeEnumBuilder();
        FACTORY_ARRAY[43301] = new IfcDerivedUnitElementBuilder();
        FACTORY_ARRAY[43320] = new IfcCoilTypeEnumBuilder();
        FACTORY_ARRAY[43329] = new IfcPumpTypeEnumBuilder();
        FACTORY_ARRAY[43337] = new IfcCrewResourceBuilder();
        FACTORY_ARRAY[43371] = new IfcBoxAlignmentBuilder();
        FACTORY_ARRAY[43446] = new IfcHalfSpaceSolidBuilder();
        FACTORY_ARRAY[43536] = new IfcMolecularWeightMeasureBuilder();
        FACTORY_ARRAY[43597] = new IfcSectionedSpineBuilder();
        FACTORY_ARRAY[43649] = new IfcLinearForceMeasureBuilder();
        FACTORY_ARRAY[43745] = new IfcCurveStyleFontAndScalingBuilder();
        FACTORY_ARRAY[43758] = new IfcAirToAirHeatRecoveryTypeEnumBuilder();
        FACTORY_ARRAY[43801] = new IfcTableRowBuilder();
        FACTORY_ARRAY[43803] = new IfcPointOnCurveBuilder();
        FACTORY_ARRAY[43823] = new IfcStyledItemBuilder();
        FACTORY_ARRAY[43864] = new IfcOpeningElementBuilder();
        FACTORY_ARRAY[43996] = new IfcReinforcementBarPropertiesBuilder();
        FACTORY_ARRAY[44002] = new IfcBoundedSurfaceBuilder();
        FACTORY_ARRAY[44080] = new IfcIdentifierBuilder();
        FACTORY_ARRAY[44089] = new IfcVertexLoopBuilder();
        FACTORY_ARRAY[44104] = new IfcTextureMapBuilder();
        FACTORY_ARRAY[44111] = new IfcEvaporatorTypeBuilder();
        FACTORY_ARRAY[44162] = new IfcRampFlightBuilder();
        FACTORY_ARRAY[44177] = new IfcSensorTypeBuilder();
        FACTORY_ARRAY[44188] = new IfcCurveStyleBuilder();
        FACTORY_ARRAY[44216] = new IfcMemberTypeBuilder();
        FACTORY_ARRAY[44222] = new IfcOrganizationRelationshipBuilder();
        FACTORY_ARRAY[44254] = new IfcBoilerTypeBuilder();
        FACTORY_ARRAY[44293] = new IfcFilterTypeEnumBuilder();
        FACTORY_ARRAY[44303] = new IfcColumnTypeBuilder();
        FACTORY_ARRAY[44314] = new IfcCompressorTypeBuilder();
        FACTORY_ARRAY[44354] = new IfcMappedItemBuilder();
        FACTORY_ARRAY[44377] = new IfcOutletTypeEnumBuilder();
        FACTORY_ARRAY[44480] = new IfcSoundValueBuilder();
        FACTORY_ARRAY[44485] = new IfcForceMeasureBuilder();
        FACTORY_ARRAY[44506] = new IfcStructuralCurveMemberVaryingBuilder();
        FACTORY_ARRAY[44526] = new IfcRelaxationBuilder();
        FACTORY_ARRAY[44550] = new IfcConstructionMaterialResourceBuilder();
        FACTORY_ARRAY[44551] = new IfcWorkScheduleBuilder();
        FACTORY_ARRAY[44676] = new IfcQuantityTimeBuilder();
        FACTORY_ARRAY[44691] = new IfcArbitraryProfileDefWithVoidsBuilder();
        FACTORY_ARRAY[44718] = new IfcOrientedEdgeBuilder();
        FACTORY_ARRAY[44881] = new IfcCShapeProfileDefBuilder();
        FACTORY_ARRAY[44895] = new IfcTankTypeEnumBuilder();
        FACTORY_ARRAY[44896] = new IfcSequenceEnumBuilder();
        FACTORY_ARRAY[45149] = new IfcWarpingConstantMeasureBuilder();
        FACTORY_ARRAY[45185] = new IfcImageTextureBuilder();
        FACTORY_ARRAY[45340] = new IfcRectangularPyramidBuilder();
        FACTORY_ARRAY[45502] = new IfcConstraintRelationshipBuilder();
        FACTORY_ARRAY[45508] = new IfcTrimmingPreferenceBuilder();
        FACTORY_ARRAY[45518] = new IfcPropertyTableValueBuilder();
        FACTORY_ARRAY[45520] = new IfcElectricDistributionPointFunctionEnumBuilder();
        FACTORY_ARRAY[45599] = new IfcPileTypeEnumBuilder();
        FACTORY_ARRAY[45608] = new IfcMinuteInHourBuilder();
        FACTORY_ARRAY[45610] = new IfcTrimmedCurveBuilder();
        FACTORY_ARRAY[45628] = new IfcReinforcingBarBuilder();
        FACTORY_ARRAY[45670] = new IfcMomentOfInertiaMeasureBuilder();
        FACTORY_ARRAY[45729] = new IfcTextTransformationBuilder();
        FACTORY_ARRAY[45822] = new IfcRelProjectsElementBuilder();
        FACTORY_ARRAY[45847] = new IfcPropertyConstraintRelationshipBuilder();
        FACTORY_ARRAY[45870] = new IfcSurfaceStyleBuilder();
        FACTORY_ARRAY[45928] = new IfcRelDefinesByTypeBuilder();
        FACTORY_ARRAY[45938] = new IfcTerminatorSymbolBuilder();
        FACTORY_ARRAY[46007] = new IfcOrganizationBuilder();
        FACTORY_ARRAY[46154] = new IfcSectionalAreaIntegralMeasureBuilder();
        FACTORY_ARRAY[46535] = new IfcFlowMovingDeviceBuilder();
        FACTORY_ARRAY[46561] = new IfcHumidifierTypeBuilder();
        FACTORY_ARRAY[46563] = new IfcMechanicalConcreteMaterialPropertiesBuilder();
        FACTORY_ARRAY[46575] = new IfcBeamBuilder();
        FACTORY_ARRAY[46613] = new IfcRelConnectsPortsBuilder();
        FACTORY_ARRAY[46728] = new IfcAxis2Placement3DBuilder();
        FACTORY_ARRAY[46746] = new IfcAxis2Placement2DBuilder();
        FACTORY_ARRAY[46853] = new IfcChangeActionEnumBuilder();
        FACTORY_ARRAY[46925] = new IfcAngularDimensionBuilder();
        FACTORY_ARRAY[46949] = new IfcCompositeCurveBuilder();
        FACTORY_ARRAY[46952] = new IfcFaceBuilder();
        FACTORY_ARRAY[46975] = new IfcEdgeBuilder();
        FACTORY_ARRAY[47097] = new IfcSoundPressureMeasureBuilder();
        FACTORY_ARRAY[47104] = new IfcIShapeProfileDefBuilder();
        FACTORY_ARRAY[47116] = new IfcWarpingMomentMeasureBuilder();
        FACTORY_ARRAY[47202] = new BOOLEANBuilder();
        FACTORY_ARRAY[47225] = new LOGICALBuilder();
        FACTORY_ARRAY[47240] = new IfcRelAssociatesLibraryBuilder();
        FACTORY_ARRAY[47303] = new IfcRampBuilder();
        FACTORY_ARRAY[47308] = new IfcMoveBuilder();
        FACTORY_ARRAY[47318] = new IfcSlabBuilder();
        FACTORY_ARRAY[47326] = new IfcRoofBuilder();
        FACTORY_ARRAY[47330] = new IfcPileBuilder();
        FACTORY_ARRAY[47343] = new IfcTextBuilder();
        FACTORY_ARRAY[47345] = new IfcZoneBuilder();
        FACTORY_ARRAY[47372] = new IfcGridBuilder();
        FACTORY_ARRAY[47381] = new IfcWallBuilder();
        FACTORY_ARRAY[47417] = new IfcDoorBuilder();
        FACTORY_ARRAY[47428] = new IfcTaskBuilder();
        FACTORY_ARRAY[47450] = new IfcLoopBuilder();
        FACTORY_ARRAY[47513] = new IfcRealBuilder();
        FACTORY_ARRAY[47521] = new IfcLineBuilder();
        FACTORY_ARRAY[47546] = new IfcRadioActivityMeasureBuilder();
        FACTORY_ARRAY[47756] = new IfcConnectionTypeEnumBuilder();
        FACTORY_ARRAY[47825] = new INTEGERBuilder();
        FACTORY_ARRAY[47826] = new IfcRoundedEdgeFeatureBuilder();
        FACTORY_ARRAY[48024] = new IfcTextStyleFontModelBuilder();
        FACTORY_ARRAY[48165] = new IfcSecondInMinuteBuilder();
        FACTORY_ARRAY[48347] = new IfcHumidifierTypeEnumBuilder();
        FACTORY_ARRAY[48467] = new IfcPointOnSurfaceBuilder();
        FACTORY_ARRAY[48587] = new IfcRelDefinesByPropertiesBuilder();
        FACTORY_ARRAY[48608] = new File_SchemaBuilder();
        FACTORY_ARRAY[48639] = new IfcFastenerBuilder();
        FACTORY_ARRAY[48650] = new IfcSphereBuilder();
        FACTORY_ARRAY[48662] = new IfcBeamTypeBuilder();
        FACTORY_ARRAY[48683] = new IfcModulusOfLinearSubgradeReactionMeasureBuilder();
        FACTORY_ARRAY[48898] = new IfcBuildingBuilder();
        FACTORY_ARRAY[48953] = new IfcStyledRepresentationBuilder();
        FACTORY_ARRAY[48956] = new IfcLibraryInformationBuilder();
        FACTORY_ARRAY[49000] = new IfcEdgeLoopBuilder();
        FACTORY_ARRAY[49002] = new IfcProtectiveDeviceTypeBuilder();
        FACTORY_ARRAY[49334] = new IfcFailureConnectionConditionBuilder();
        FACTORY_ARRAY[49343] = new IfcGeneralProfilePropertiesBuilder();
        FACTORY_ARRAY[49619] = new IfcLampTypeBuilder();
        FACTORY_ARRAY[49636] = new IfcAnnotationBuilder();
        FACTORY_ARRAY[49685] = new IfcSiteBuilder();
        FACTORY_ARRAY[49691] = new IfcPathBuilder();
        FACTORY_ARRAY[49696] = new IfcFontWeightBuilder();
        FACTORY_ARRAY[49703] = new IfcEnergyConversionDeviceBuilder();
        FACTORY_ARRAY[49707] = new IfcMagneticFluxDensityMeasureBuilder();
        FACTORY_ARRAY[49778] = new IfcCircleBuilder();
        FACTORY_ARRAY[49780] = new IfcTwoDirectionRepeatFactorBuilder();
        FACTORY_ARRAY[49820] = new IfcStructuredDimensionCalloutBuilder();
        FACTORY_ARRAY[49911] = new IfcRelFlowControlElementsBuilder();
        FACTORY_ARRAY[49990] = new IfcDamperTypeBuilder();
        FACTORY_ARRAY[50042] = new IfcReinforcingBarRoleEnumBuilder();
        FACTORY_ARRAY[50449] = new IfcDimensionCalloutRelationshipBuilder();
        FACTORY_ARRAY[50522] = new IfcRelOverridesPropertiesBuilder();
        FACTORY_ARRAY[50646] = new IfcPersonBuilder();
        FACTORY_ARRAY[50671] = new IfcBeamTypeEnumBuilder();
        FACTORY_ARRAY[50687] = new IfcActuatorTypeBuilder();
        FACTORY_ARRAY[50712] = new IfcActuatorTypeEnumBuilder();
        FACTORY_ARRAY[50726] = new IfcFastenerTypeBuilder();
        FACTORY_ARRAY[50737] = new IfcFlowTerminalBuilder();
        FACTORY_ARRAY[50764] = new IfcCircleHollowProfileDefBuilder();
        FACTORY_ARRAY[50867] = new IfcPermitBuilder();
        FACTORY_ARRAY[50921] = new IfcMechanicalMaterialPropertiesBuilder();
        FACTORY_ARRAY[50977] = new IfcPerformanceHistoryBuilder();
        FACTORY_ARRAY[51043] = new IfcProtectiveDeviceTypeEnumBuilder();
        FACTORY_ARRAY[51046] = new IfcRelConnectsPortToElementBuilder();
        FACTORY_ARRAY[51128] = new IfcGeometricSetBuilder();
        FACTORY_ARRAY[51265] = new IfcCooledBeamTypeBuilder();
        FACTORY_ARRAY[51295] = new IfcDamperTypeEnumBuilder();
        FACTORY_ARRAY[51642] = new IfcPixelTextureBuilder();
        FACTORY_ARRAY[51710] = new IfcDimensionCountBuilder();
        FACTORY_ARRAY[51767] = new IfcCartesianPointBuilder();
        FACTORY_ARRAY[51785] = new IfcBuildingStoreyBuilder();
        FACTORY_ARRAY[51889] = new IfcActionTypeEnumBuilder();
        FACTORY_ARRAY[51922] = new IfcDimensionCurveBuilder();
        FACTORY_ARRAY[51970] = new IfcSurfaceStyleWithTexturesBuilder();
        FACTORY_ARRAY[51988] = new IfcMaterialBuilder();
        FACTORY_ARRAY[52017] = new IfcBoxedHalfSpaceBuilder();
        FACTORY_ARRAY[52049] = new IfcSweptDiskSolidBuilder();
        FACTORY_ARRAY[52077] = new IfcMoistureDiffusivityMeasureBuilder();
        FACTORY_ARRAY[52086] = new IfcTelecomAddressBuilder();
        FACTORY_ARRAY[52150] = new IfcParameterValueBuilder();
        FACTORY_ARRAY[52156] = new IfcObjectTypeEnumBuilder();
        FACTORY_ARRAY[52200] = new Ifc2DCompositeCurveBuilder();
        FACTORY_ARRAY[52344] = new IfcRelConnectsStructuralElementBuilder();
        FACTORY_ARRAY[52495] = new IfcConnectionPortGeometryBuilder();
        FACTORY_ARRAY[52594] = new IfcProjectOrderBuilder();
        FACTORY_ARRAY[52629] = new IfcSIUnitBuilder();
        FACTORY_ARRAY[52751] = new IfcCableSegmentTypeBuilder();
        FACTORY_ARRAY[52761] = new IfcDistributionPortBuilder();
        FACTORY_ARRAY[52824] = new IfcCostScheduleBuilder();
        FACTORY_ARRAY[53163] = new IfcVirtualElementBuilder();
        FACTORY_ARRAY[53346] = new IfcDuctSilencerTypeBuilder();
        FACTORY_ARRAY[53709] = new IfcLampTypeEnumBuilder();
        FACTORY_ARRAY[53746] = new IfcDataOriginEnumBuilder();
        FACTORY_ARRAY[53819] = new IfcBoundaryNodeConditionWarpingBuilder();
        FACTORY_ARRAY[53905] = new IfcRelAssociatesProfilePropertiesBuilder();
        FACTORY_ARRAY[54024] = new IfcMaterialListBuilder();
        FACTORY_ARRAY[54067] = new IfcFrequencyMeasureBuilder();
        FACTORY_ARRAY[54115] = new IfcDaylightSavingHourBuilder();
        FACTORY_ARRAY[54139] = new IfcTubeBundleTypeBuilder();
        FACTORY_ARRAY[54209] = new IfcDescriptiveMeasureBuilder();
        FACTORY_ARRAY[54761] = new IfcCableSegmentTypeEnumBuilder();
        FACTORY_ARRAY[54768] = new IfcActionSourceTypeEnumBuilder();
        FACTORY_ARRAY[54940] = new IfcDimensionExtentUsageBuilder();
        FACTORY_ARRAY[54950] = new IfcCoolingTowerTypeBuilder();
        FACTORY_ARRAY[55024] = new IfcFacetedBrepWithVoidsBuilder();
        FACTORY_ARRAY[55152] = new IfcCircleProfileDefBuilder();
        FACTORY_ARRAY[55318] = new IfcMaterialDefinitionRepresentationBuilder();
        FACTORY_ARRAY[55558] = new IfcDistributionControlElementBuilder();
        FACTORY_ARRAY[55643] = new IfcDuctSilencerTypeEnumBuilder();
        FACTORY_ARRAY[55725] = new IfcAsymmetricIShapeProfileDefBuilder();
        FACTORY_ARRAY[56002] = new IfcDoorPanelOperationEnumBuilder();
        FACTORY_ARRAY[56072] = new IfcConditionCriterionBuilder();
        FACTORY_ARRAY[56152] = new IfcElectricVoltageMeasureBuilder();
        FACTORY_ARRAY[56179] = new IfcElectricCurrentMeasureBuilder();
        FACTORY_ARRAY[56185] = new IfcLocalPlacementBuilder();
        FACTORY_ARRAY[56213] = new IfcTubeBundleTypeEnumBuilder();
        FACTORY_ARRAY[56307] = new IfcMaterialClassificationRelationshipBuilder();
        FACTORY_ARRAY[56815] = new IfcAnnotationTextOccurrenceBuilder();
        FACTORY_ARRAY[56858] = new IfcMassDensityMeasureBuilder();
        FACTORY_ARRAY[56911] = new IfcElectricalBasePropertiesBuilder();
        FACTORY_ARRAY[56996] = new IfcCoolingTowerTypeEnumBuilder();
        FACTORY_ARRAY[57139] = new IfcDayInMonthNumberBuilder();
        FACTORY_ARRAY[57225] = new IfcDimensionCurveTerminatorBuilder();
        FACTORY_ARRAY[57266] = new IfcDoorLiningPropertiesBuilder();
        FACTORY_ARRAY[57345] = new IfcExtendedMaterialPropertiesBuilder();
        FACTORY_ARRAY[57392] = new IfcStructuralLoadSingleDisplacementDistortionBuilder();
        FACTORY_ARRAY[58024] = new IfcAnnotationSymbolOccurrenceBuilder();
        FACTORY_ARRAY[58067] = new IfcRotationalFrequencyMeasureBuilder();
        FACTORY_ARRAY[58219] = new IfcRotationalStiffnessMeasureBuilder();
        FACTORY_ARRAY[59005] = new IfcCostScheduleTypeEnumBuilder();
        FACTORY_ARRAY[59044] = new IfcOneDirectionRepeatFactorBuilder();
        FACTORY_ARRAY[59920] = new IfcLightDistributionCurveEnumBuilder();
        FACTORY_ARRAY[59952] = new IfcLightIntensityDistributionBuilder();
        FACTORY_ARRAY[60068] = new IfcGeometricRepresentationContextBuilder();
        FACTORY_ARRAY[60107] = new IfcPreDefinedTerminatorSymbolBuilder();
        FACTORY_ARRAY[61501] = new IfcStructuralSteelProfilePropertiesBuilder();
        FACTORY_ARRAY[61663] = new IfcElectricFlowStorageDeviceTypeBuilder();
        FACTORY_ARRAY[61872] = new IfcCoordinatedUniversalTimeOffsetBuilder();
        FACTORY_ARRAY[61886] = new IfcStructuralLoadSingleForceWarpingBuilder();
        FACTORY_ARRAY[62493] = new IfcStructuralLoadSingleDisplacementBuilder();
        FACTORY_ARRAY[62630] = new IfcSectionReinforcementPropertiesBuilder();
        FACTORY_ARRAY[62800] = new IfcRepresentationMapBuilder();
        FACTORY_ARRAY[62864] = new IfcSpaceThermalLoadPropertiesBuilder();
        FACTORY_ARRAY[62991] = new IfcProductsOfCombustionPropertiesBuilder();
        FACTORY_ARRAY[63737] = new IfcElectricFlowStorageDeviceTypeEnumBuilder();
        FACTORY_ARRAY[63947] = new IfcClassificationNotationFacetBuilder();
        FACTORY_ARRAY[64759] = new IfcPhysicalOrVirtualEnumBuilder();
//
//        if (1 == 1) return;
//
